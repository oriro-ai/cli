...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.oriro", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Oriro/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__oriro__/a2ui/").absoluteString + "?platform=macos"
    }
