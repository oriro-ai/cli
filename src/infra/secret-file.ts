...
import { readSecretFileSync as readSecretFileSyncImpl } from "@oriro/fs-safe/secret";
...
} from "@oriro/fs-safe/secret";
export { writeSecretFileAtomic as writePrivateSecretFileAtomic } from "@oriro/fs-safe/secret";
