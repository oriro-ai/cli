...
import { resolveDefaultAgentId, resolveSessionAgentId } from "oriro/plugin-sdk/memory-host-core";
import { getActiveMemorySearchManager } from "oriro/plugin-sdk/memory-host-search";
import {
  extractTranscriptIdentityFromSessionsMemoryHit,
  loadCombinedSessionStoreForGateway,
  resolveTranscriptStemToSessionKeys,
} from "oriro/plugin-sdk/session-transcript-hit";
import {
  createAgentToAgentPolicy,
  createSessionVisibilityGuard,
  resolveEffectiveSessionToolsVisibility,
} from "oriro/plugin-sdk/session-visibility";
import {
...
const RELATED_BLOCK_PATTERN =
  /<!-- oriro:wiki:related:start -->[\s\S]*?<!-- oriro:wiki:related:end -->/g;
