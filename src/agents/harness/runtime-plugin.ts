...
import { isDefaultAgentRuntimeId, ORIRO_AGENT_RUNTIME_ID } from "../agent-runtime-id.js";
 ...
 *
 * Only cold-loadable runtimes live here; always-loaded core/oriro runtimes should not trigger
...
function restrictiveAllowlistOmitsPlugin(config: OriroConfig | undefined, pluginId: string) {
...
export async function ensureSelectedAgentHarnessPlugin(params: {
  ...
  if (
    ...
    runtime === ORIRO_AGENT_RUNTIME_ID ||
