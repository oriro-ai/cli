...
function makeContext(sourceConfig: OriroConfig): ResolverContext {
...
function collectAcpxConfigAssignments(config: OriroConfig): ResolverContext {
...
function expectInactiveAcpxConfig(config: OriroConfig): void {
