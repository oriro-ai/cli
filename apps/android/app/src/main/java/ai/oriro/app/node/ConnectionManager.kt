...
import ai.oriro.app.gateway.GatewayClientInfo
import ai.oriro.app.gateway.GatewayConnectOptions
import ai.oriro.app.gateway.GatewayEndpoint
import ai.oriro.app.gateway.GatewayTlsParams
...
class ConnectionManager(
  ...
  fun buildUserAgent(): String {
    ...
    return "OriroAndroid/$version (Android $releaseLabel; SDK ${Build.VERSION.SDK_INT})"
  }
  ...
  fun buildNodeConnectOptions(): GatewayConnectOptions =
    GatewayConnectOptions(
      ...
      client = buildClientInfo(clientId = "oriro-android", clientMode = "node"),
  ...
  fun buildOperatorConnectOptions(): GatewayConnectOptions =
    GatewayConnectOptions(
      ...
      commands = emptyList(),
      permissions = emptyMap(),
      client = buildClientInfo(clientId = "oriro-android", clientMode = "ui"),
      userAgent = buildUserAgent(),
    )
