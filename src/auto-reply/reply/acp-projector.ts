// Projects ACP runtime events into Oriro-visible session update records.
import type { AcpRuntimeEvent, AcpSessionUpdateTag } from "@oriro/acp-core/runtime/types";
import {
