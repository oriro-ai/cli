...
function getChannelConfig(cfg: OriroConfig): SynologyChatChannelConfig {
  return (cfg.channels?.[channel] as SynologyChatChannelConfig | undefined) ?? {};
}

function getRawAccountConfig(cfg: OriroConfig, accountId: string): SynologyChatAccountRaw {
...
function isSynologyChatConfigured(cfg: OriroConfig, accountId: string): boolean {
...
function resolveExistingAllowedUserIds(cfg: OriroConfig, accountId: string): string[] {
