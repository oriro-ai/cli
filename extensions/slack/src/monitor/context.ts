...
import { resolveDefaultAgentId } from "oriro/plugin-sdk/agent-runtime";
import { formatAllowlistMatchMeta } from "oriro/plugin-sdk/allow-from";
import type {
  OriroConfig,
  SlackReactionNotificationMode,
} from "oriro/plugin-sdk/config-contracts";
import type { SessionScope } from "oriro/plugin-sdk/config-contracts";
import type { DmPolicy, GroupPolicy } from "oriro/plugin-sdk/config-contracts";
import { resolveRuntimeConversationBindingRoute } from "oriro/plugin-sdk/conversation-runtime";
import { createDedupeCache } from "oriro/plugin-sdk/dedupe-runtime";
import type { HistoryEntry } from "oriro/plugin-sdk/reply-history";
...
export type SlackMonitorContext = {
  ...
  slashCommand: Required<import("oriro/plugin-sdk/config-contracts").SlackSlashCommandConfig>;
  textLimit: number;
