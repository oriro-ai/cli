...
import { isVoiceCompatibleAudio } from "oriro/plugin-sdk/media-runtime";
...
import type {
  ...
  SpeechVoiceOption,
} from "oriro/plugin-sdk/speech";
import { asBoolean, asFiniteNumber, asObject, trimToUndefined } from "oriro/plugin-sdk/speech";
import {
  fetchWithSsrFGuard,
