...
import { resolveAccountEntry } from "oriro/plugin-sdk/routing";
import { normalizeOptionalString } from "oriro/plugin-sdk/string-coerce-runtime";
import type { DiscordAccountConfig, DiscordActionConfig, OriroConfig } from "./runtime-api.js";
...
export function listEnabledDiscordAccounts(cfg: OriroConfig): ResolvedDiscordAccount[] {
