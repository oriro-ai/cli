...
public enum OriroCanvasA2UICommand: String, Codable, Sendable {
...
public struct OriroCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct OriroCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
