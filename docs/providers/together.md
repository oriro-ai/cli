...
title: "Together AI"
read_when:
  - You want to use Together AI with Oriro
...
<Steps>
  ...
  <Step title="Run onboarding">
    ```bash
    oriro onboard --auth-choice together-api-key
    ```
  </Step>
...
Oriro ships this bundled Together catalog:
...
<AccordionGroup>
  <Accordion title="Environment note">
    ...
    gateway processes. Use `~/.oriro/.env` or `env.shellEnv` config for
  ...
  <Accordion title="Troubleshooting">
    - Verify your key works: `oriro models list --provider together`
