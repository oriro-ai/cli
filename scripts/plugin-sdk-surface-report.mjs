...
try {
  budgets = {
    publicEntrypoints: readBudgetEnv("ORIRO_PLUGIN_SDK_MAX_PUBLIC_ENTRYPOINTS", 321),
    publicExports: readBudgetEnv("ORIRO_PLUGIN_SDK_MAX_PUBLIC_EXPORTS", 10327),
    publicFunctionExports: readBudgetEnv("ORIRO_PLUGIN_SDK_MAX_PUBLIC_FUNCTION_EXPORTS", 5184),
    publicDeprecatedExports: readBudgetEnv(
      "ORIRO_PLUGIN_SDK_MAX_PUBLIC_DEPRECATED_EXPORTS",
      3247,
    ),
    publicWildcardReexports: readBudgetEnv(
      "ORIRO_PLUGIN_SDK_MAX_PUBLIC_WILDCARD_REEXPORTS",
      215,
    ),
  };
  publicDeprecatedExportsByEntrypointBudget = readEntrypointBudgetEnv(
    "ORIRO_PLUGIN_SDK_MAX_PUBLIC_DEPRECATED_EXPORTS_BY_ENTRYPOINT",
