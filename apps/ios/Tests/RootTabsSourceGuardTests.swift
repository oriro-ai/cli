...
struct RootTabsSourceGuardTests {
    @Test func `hidden sidebar reveal uses destination header without reserved rail`() throws {
        ...
        #expect(componentSource.contains("OriroSidebarHeaderLeadingSlot"))
    ...
    @Test func `sidebar keeps navigation model destination only`() throws {
        ...
        #expect(source.contains("OriroProMark(size: 30"))
        #expect(source.contains("Text(\"Oriro\")"))
    ...
    @Test func `sidebar routes use destination headers instead of repeated product branding`() throws {
        ...
        #expect(!sidebarDetail.contains("headerTitle: \"Oriro\""))
        #expect(agentOverviewSource.contains("OriroAdaptiveHeaderRow("))
        #expect(agentOverviewSource.contains("title: self.headerTitle"))
        #expect(!agentOverviewSource.contains("Text(\"Oriro\")"))
        #expect(docsSource.contains("OriroAdaptiveHeaderRow("))
        #expect(docsSource.contains("title: \"Docs\""))
        #expect(!docsSource.contains("Text(\"Oriro Docs\")"))
    }
    ...
    @Test func `agents direct route keeps single sidebar control`() throws {
        ...
        #expect(nodesSource.contains("OriroSidebarHeaderLeadingSlot(action: headerLeadingAction)"))
        #expect(dreamingSource.contains("OriroSidebarHeaderLeadingSlot(action: headerLeadingAction)"))
    }
    ...
    @Test func `routed headers use shared adaptive layout`() throws {
        ...
        #expect(componentsSource.contains("struct OriroAdaptiveHeaderRow<Leading: View, Accessory: View>: View"))
        ...
        #expect(featureChromeSource.contains("OriroAdaptiveHeaderRow("))
        #expect(docsSource.contains("OriroAdaptiveHeaderRow("))
        #expect(overviewSource.contains("OriroAdaptiveHeaderRow("))
        #expect(chatSource.contains("OriroAdaptiveHeaderRow("))
        #expect(agentOverviewSource.contains("OriroAdaptiveHeaderRow("))
        #expect(settingsSource.contains("OriroAdaptiveHeaderRow("))
    }
    ...
    @Test func `phone hub keeps docs as destination only`() throws {
        ...
        #expect(source.contains("OriroDocsScreen("))
        ...
        #expect(!source.contains("https://docs.oriro.ai"))
    }
    ...
    @Test func `phone hub header stays task first`() throws {
        ...
        #expect(source.contains("private var phoneDetailBackAction: OriroSidebarHeaderAction"))
        #expect(source.contains("accessibilityLabel: \"Back to Control\""))
        #expect(source.contains("accessibilityIdentifier: \"OriroPhoneDetailBackButton\""))
    ...
    @Test func `activity screen stays split from task feature screens`() throws {
        ...
        #expect(!taskSource.contains("import OriroChatUI"))
    ...
    @Test func `routed feature chrome stays split from task feature screens`() throws {
        ...
        #expect(chromeSource.contains("OriroSidebarHeaderLeadingSlot(action: headerLeadingAction)"))
        #expect(chromeSource.contains("OriroGatewayCompactPill()"))
    ...
    @Test func `routed gateway pills open gateway settings`() throws {
        ...
        #expect(agentOverviewSource.contains("OriroGatewayCompactPill()"))
    ...
    @Test func `gateway settings keeps pairing trust diagnostics and tailscale actions`() throws {
        ...
        #expect(actionsSource.contains("Run /pair approve in your Oriro chat"))
    ...
    @Test func `gateway settings preview matrix covers primary states`() throws {
        ...
        #expect(supportSource.contains("Run /pair approve in your Oriro chat"))
    ...
    private static func proComponentsSourceURL() -> URL {
        URL(fileURLWithPath: #filePath)
            .deletingLastPathComponent()
            .deletingLastPathComponent()
            .appendingPathComponent("Sources/Design/OriroProComponents.swift")
    }
    ...
    private static func docsSourceURL() -> URL {
        URL(fileURLWithPath: #filePath)
            .deletingLastPathComponent()
            .deletingLastPathComponent()
            .appendingPathComponent("Sources/Design/OriroDocsScreen.swift")
    }
    ...
    private static func sharedChatPreviewSourceURL() -> URL {
        URL(fileURLWithPath: #filePath)
            ...
            .deletingLastPathComponent()
            .deletingLastPathComponent()
            .appendingPathComponent("shared/OriroKit/Sources/OriroChatUI/ChatView+Previews.swift")
    }
    ...
    private static func xcodeProjectSourceURL() -> URL {
        URL(fileURLWithPath: #filePath)
            .deletingLastPathComponent()
            .deletingLastPathComponent()
            .appendingPathComponent("Oriro.xcodeproj/project.pbxproj")
    }
