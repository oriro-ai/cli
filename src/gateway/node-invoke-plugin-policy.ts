...
import type {
  ...
  OriroPluginNodeInvokeTransportResult,
...
function createApprovalRuntime(params: {
  ...
  pluginId: string;
}): OriroPluginNodeInvokePolicyContext["approvals"] | undefined {
...
export async function applyPluginNodeInvokePolicy(params: {
  ...
  const invokeNode: OriroPluginNodeInvokePolicyContext["invokeNode"] = async (
    override = {},
