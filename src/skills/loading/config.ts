...
export function resolveSkillsInstallPreferences(config?: OriroConfig): SkillsInstallPreferences {
...
export function isConfigPathTruthy(config: OriroConfig | undefined, pathStr: string): boolean {
...
const BUNDLED_SOURCES = new Set(["oriro-bundled"]);

function isBundledSkill(entry: SkillEntry): boolean {
  return BUNDLED_SOURCES.has(resolveSkillSource(entry.skill));
}

export function resolveBundledAllowlist(config?: OriroConfig): ReadonlySet<string> | undefined {
