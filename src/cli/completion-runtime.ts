...
export const COMPLETION_SKIP_PLUGIN_COMMANDS_ENV = "ORIRO_COMPLETION_SKIP_PLUGIN_COMMANDS";
...
/** Resolves the shell startup profile path that should contain the Oriro completion block. */
...
/** Returns whether a shell profile already contains an Oriro completion block or source line. */
 ...
 * Returns true if profile has `source <(oriro completion ...)` instead of cached file.
 */
...
export async function installCompletion(shell: string, yes: boolean, binName = "oriro") {
