...
} from "oriro/plugin-sdk/approval-handler-runtime";
import { createChannelApprovalNativeRuntimeAdapter } from "oriro/plugin-sdk/approval-handler-runtime";
import { buildChannelApprovalNativeTargetKey } from "oriro/plugin-sdk/approval-native-runtime";
import {
  buildExecApprovalPendingReplyPayload,
  buildPluginApprovalPendingReplyPayload,
  type ExecApprovalReplyDecision,
} from "oriro/plugin-sdk/approval-reply-runtime";
import { buildPluginApprovalResolvedReplyPayload } from "oriro/plugin-sdk/approval-runtime";
import type {
  ExecApprovalRequest,
  PluginApprovalRequest,
} from "oriro/plugin-sdk/approval-runtime";
import {
  listMessageReceiptPlatformIds,
  resolveMessageReceiptPrimaryId,
} from "oriro/plugin-sdk/channel-outbound";
import { normalizeUniqueStringEntries } from "oriro/plugin-sdk/string-coerce-runtime";
import {
...
// Oriro Matrix custom event content for capable clients; body and reactions remain fallback.
const MATRIX_APPROVAL_METADATA_KEY = "com.oriro.approval" as const;
