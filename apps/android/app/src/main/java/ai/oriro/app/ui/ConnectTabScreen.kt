      ...
      Surface(
        ...
        Column(
          ...
          Button(
            ...
            Spacer(modifier = Modifier.width(8.dp))
            Text("Copy Report for Oriro", style = mobileCallout.copy(fontWeight = FontWeight.Bold))
          }
        }
      }
    }
    ...
    AnimatedVisibility(visible = advancedOpen) {
      Surface(
        ...
        Column(
          ...
          CommandBlock("oriro qr --setup-code-only")
          CommandBlock("oriro qr --json")
          Text(
...
private fun gatewayPairingInstruction(problem: GatewayConnectionProblem?): String =
  if (problem?.canAutoRetry == true) {
    "Approve this phone on the gateway. Oriro will reconnect automatically."
  } else {
