...
- Applying repository-specific documentation overlays, including Oriro page-type, docs IA, preservation, and validation rules when present.
...
6. For Oriro docs work, read `references/oriro.md` before the build/review playbook.
