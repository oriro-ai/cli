...
import { stringEnum } from "oriro/plugin-sdk/channel-actions";
import type { AnyAgentTool, OriroPluginToolContext } from "oriro/plugin-sdk/core";
...
type ZalouserToolContext = Pick<OriroPluginToolContext, "deliveryContext">;
