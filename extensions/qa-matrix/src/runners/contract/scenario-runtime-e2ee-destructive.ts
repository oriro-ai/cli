...
type MatrixQaCliRuntime = Awaited<ReturnType<typeof createMatrixQaOriroCliRuntime>>;
...
async function createMatrixQaRecoveryCliRuntime(params: {
  ...
  return await createMatrixQaOriroCliRuntime({
