...
import type { AnyAgentTool, OriroPluginApi } from "./types.js";
...
describe("captured plugin registration", () => {
  ...
  it("returns synthetic scheduled-turn ids independent of human-readable names", async () => {
    let scheduleSessionTurn: OriroPluginApi["scheduleSessionTurn"] | undefined;
    let registerSessionSchedulerJob: OriroPluginApi["registerSessionSchedulerJob"] | undefined;
    const captured = capturePluginRegistration({
