...
export function resolveGatewayServiceDescription(params: {
  ...
  return (
    ...
    formatGatewayServiceDescription({
      profile: params.env.ORIRO_PROFILE,
      version: params.environment?.ORIRO_SERVICE_VERSION ?? params.env.ORIRO_SERVICE_VERSION,
    })
  );
}
