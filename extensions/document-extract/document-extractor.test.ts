...
describe("PDF document extractor", () => {
  ...
  it("extracts text first and renders fallback images through oriropdf", async () => {
  ...
  it("normalizes oriropdf password errors", async () => {
  ...
  it("filters selected pages before passing them to oriropdf", async () => {
    pdfDocument.extract
