...
import { toAcpRuntimeErrorText } from "@oriro/acp-core/runtime/error-text";
...
export function resolveAcpHelpText(): string {
  return [
    ...
    "",
    "Notes:",
    "- /acp spawn harness-id is an ACP runtime harness alias (for example codex), not an Oriro agents.list id.",
