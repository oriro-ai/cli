...
import { safeParseJsonWithSchema, safeParseWithSchema } from "oriro/plugin-sdk/extension-shared";
import { mergePairLoopGuardConfig } from "oriro/plugin-sdk/pair-loop-guard-runtime";
import { isSecretRef } from "oriro/plugin-sdk/secret-input";
...
export function listEnabledGoogleChatAccounts(cfg: OriroConfig): ResolvedGoogleChatAccount[] {
