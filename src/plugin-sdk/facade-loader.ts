...
let cachedOriroPackageRoot: string | undefined;

function getOriroPackageRoot() {
  if (cachedOriroPackageRoot) {
    return cachedOriroPackageRoot;
  }
  cachedOriroPackageRoot =
...
function resolveFacadeModuleLocation(params: {
  ...
  return resolveBundledFacadeModuleLocation({
    ...
    packageRoot: getOriroPackageRoot(),
    bundledPluginsDir,
  });
}
...
export function resetFacadeLoaderStateForTest(): void {
  ...
  cachedOriroPackageRoot = undefined;
}
