...
function resolveTranscriptsSourceProviderEntries(cfg?: OriroConfig): TranscriptSourceProvider[] {
...
function buildProviderMaps(cfg?: OriroConfig): {
...
export function listTranscriptSourceProviders(cfg?: OriroConfig): TranscriptSourceProvider[] {
