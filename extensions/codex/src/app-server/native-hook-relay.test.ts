...
import type { NativeHookRelayRegistrationHandle } from "oriro/plugin-sdk/agent-harness-runtime";
          ...
          hooks: [
            {
              type: "command",
              command:
                "oriro hooks relay --provider codex --relay-id relay-1 --generation generation-1 --event pre_tool_use --timeout 6000",
              timeout: 7,
              async: false,
          ...
          hooks: [
            {
              type: "command",
              command:
                "oriro hooks relay --provider codex --relay-id relay-1 --generation generation-1 --event post_tool_use --timeout 6000",
              timeout: 7,
              async: false,
              statusMessage: "Oriro native hook relay",
            },
          ...
          hooks: [
            {
              type: "command",
              command:
                "oriro hooks relay --provider codex --relay-id relay-1 --generation generation-1 --event permission_request --timeout 6000",
              timeout: 7,
              async: false,
              statusMessage: "Oriro native hook relay",
            },
          ...
          hooks: [
            {
              type: "command",
              command:
                "oriro hooks relay --provider codex --relay-id relay-1 --generation generation-1 --event before_agent_finalize --timeout 6000",
              timeout: 7,
              async: false,
              statusMessage: "Oriro native hook relay",
            },
          ...
          hooks: [
            {
              type: "command",
              command:
                "oriro hooks relay --provider codex --relay-id relay-1 --generation generation-1 --event permission_request --timeout 4000",
              timeout: 5,
              async: false,
              statusMessage: "Oriro native hook relay",
            },
          ...
          hooks: [
            {
              type: "command",
              command:
                "oriro hooks relay --provider codex --relay-id relay-1 --generation generation-1 --event pre_tool_use --timeout 4000",
              timeout: 5,
              async: false,
              statusMessage: "Oriro native hook relay",
            },
          ...
          hooks: [
            {
              type: "command",
              command:
                "oriro hooks relay --provider codex --relay-id relay-1 --generation generation-1 --event pre_tool_use --pre-tool-use-unavailable noop --timeout 4000",
              timeout: 5,
              async: false,
              statusMessage: "Oriro native hook relay",
            },
...
function createRelay(options?: {
  ...
  return {
    ...
    commandForEvent: (event, commandOptions) =>
      `oriro hooks relay --provider codex --relay-id relay-1 --generation generation-1 --event ${event}${
