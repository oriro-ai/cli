...
} from "oriro/plugin-sdk/agent-harness";
import { createTokenjuiceOriroEmbeddedExtension } from "./runtime-api.js";

type TokenjuiceToolResultHandler = (
  event: {
    toolName: string;
    input: Record<string, unknown>;
    content: OriroAgentToolResult["content"];
    details: unknown;
    isError?: boolean;
  },
  ctx: { cwd: string },
) => Promise<Partial<OriroAgentToolResult> | void> | Partial<OriroAgentToolResult> | void;
...
function readTextContent(content: OriroAgentToolResult["content"]): string {
