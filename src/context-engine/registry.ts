...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("oriro.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("oriro.contextEngineRegistryState");
