...
const ENV: NodeJS.ProcessEnv = { HOME: "/tmp/oriro-test-home" };
let loadCase = 0;

const RECORDS: Record<string, PluginInstallRecord> = {
  weixin: {
    source: "npm",
    spec: "@tencent-weixin/oriro-weixin@2.3.7",
    installPath:
      "/tmp/oriro-test-home/.oriro/npm/node_modules/@tencent-weixin/oriro-weixin",
...
async function loadWithMocks(params: {
  ...
  vi.doMock("./discovery.js", () => ({ discoverOriroPlugins: discoverSpy }));
...
function createChannelCandidate(params: {
  ...
  return {
    ...
    source: "/tmp/oriro-test-plugin/index.js",
    rootDir: "/tmp/oriro-test-plugin",
    origin: params.origin ?? "global",
    packageName: "@vendor/oriro-test-plugin",
    packageManifest: {
