// File Transfer plugin entrypoint registers its Oriro integration.
import {
  definePluginEntry,
  type AnyAgentTool,
  type OriroPluginNodeHostCommand,
...
const fileTransferNodeHostCommands: OriroPluginNodeHostCommand[] = [
  {
    command: "file.fetch",
    cap: "file",
    dangerous: true,
