...
type GatewayInstallAuthMode = NonNullable<NonNullable<OriroConfig["gateway"]>["auth"]>["mode"];
...
function hasConfiguredGatewayPasswordForInstall(cfg: OriroConfig): boolean {
