...
function repairNullAgentWorkspaces(cfg: OriroConfig, changes: string[]): OriroConfig {
...
function pruneBindingsForMissingAgents(cfg: OriroConfig, changes: string[]): OriroConfig {
  const agents = cfg.agents?.list;
...
export function normalizeCompatibilityConfigValues(cfg: OriroConfig): {
  config: OriroConfig;
  changes: string[];
} {
