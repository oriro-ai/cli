...
type CapabilityProviderCandidate = {
  ...
  isConfigured?: (ctx: { cfg?: OriroConfig; agentDir?: string }) => boolean;
};
...
function resolveCurrentDefaultProviderId(cfg?: OriroConfig): string {
...
function resolveAutoCapabilityFallbackRefs(params: {
  cfg: OriroConfig;
  agentDir?: string;
  listProviders: (cfg?: OriroConfig) => CapabilityProviderCandidate[];
}): string[] {
