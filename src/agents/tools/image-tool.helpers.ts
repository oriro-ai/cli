...
export function coerceImageModelConfig(cfg?: OriroConfig): ImageModelConfig {
...
function findConfiguredImageModelMatches(params: { cfg?: OriroConfig; ref: string }): string[] {
