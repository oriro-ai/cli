// Oriro Cross Os Release Workflow tests cover oriro cross os release workflow script behavior.
import { readFileSync } from "node:fs";
import { describe, expect, it } from "vitest";

const WORKFLOW_PATH = ".github/workflows/oriro-cross-os-release-checks-reusable.yml";
const WRAPPER_PATH = "scripts/github/run-oriro-cross-os-release-checks.sh";
const HARNESS = "bash workflow/scripts/github/run-oriro-cross-os-release-checks.sh";
