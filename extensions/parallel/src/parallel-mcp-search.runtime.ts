...
import { withTrustedWebSearchEndpoint } from "oriro/plugin-sdk/provider-web-search";
...
// without this, undici sends a generic `node` UA and Oriro usage is only
  ...
  const init = await postMcp({
    ...
    body: {
      ...
      params: {
        ...
        capabilities: {},
        clientInfo: { name: "oriro-parallel", version: PLUGIN_VERSION },
      },
    },
  });
  if (!init.ok) {
