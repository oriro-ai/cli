...
import type { MemorySource } from "oriro/plugin-sdk/memory-core-host-engine-storage";
...
class SessionSyncYieldHarness extends MemoryManagerSyncOps {
  protected readonly cfg = {} as OriroConfig;
  protected readonly agentId = "main";
  protected readonly workspaceDir = "/tmp/oriro-test-workspace";
...
describe("session sync responsiveness", () => {
  beforeEach(() => {
    vi.stubEnv("ORIRO_STATE_DIR", path.join(os.tmpdir(), "oriro-session-sync-yield"));
