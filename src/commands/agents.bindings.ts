...
import { normalizeSortedUniqueStringEntries } from "@oriro/normalization-core/string-normalization";
...
function resolveDefaultAccountId(cfg: OriroConfig, provider: ChannelId): string {
...
function listManifestChannelIds(config: OriroConfig): Set<string> {
  return new Set(
