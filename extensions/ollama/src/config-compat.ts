...
export const legacyConfigRules: LegacyConfigRule[] = [
  {
    ...
    message:
      'models.providers.ollama-cloud.baseUrl="https://ai.ollama.com" is retired; use "https://ollama.com". Run "oriro doctor --fix".',
    match: (value) => findRetiredOllamaCloudBaseUrl(value) !== null,
  },
];

export function migrateOllamaCloudRetiredBaseUrl(config: OriroConfig): {
  config: OriroConfig;
  changes: string[];
} | null {
  ...
  nextConfig.models = nextModels as OriroConfig["models"];
