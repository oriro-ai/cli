...
import { hasFinalInboundReplyDispatch } from "oriro/plugin-sdk/channel-inbound";
import type { ChannelBotLoopProtectionFacts } from "oriro/plugin-sdk/channel-inbound";
import {
...
import { isDangerousNameMatchingEnabled } from "oriro/plugin-sdk/dangerous-name-runtime";
import {
  isFutureDateTimestampMs,
  resolveExpiresAtMsFromDurationMs,
} from "oriro/plugin-sdk/number-runtime";
import { mergePairLoopGuardConfig } from "oriro/plugin-sdk/pair-loop-guard-runtime";
import { buildInboundHistoryFromEntries } from "oriro/plugin-sdk/reply-history";
import {
  buildTtsSupplementMediaPayload,
  getReplyPayloadTtsSupplement,
} from "oriro/plugin-sdk/reply-payload";
import type { GetReplyOptions } from "oriro/plugin-sdk/reply-runtime";
...
import { MATRIX_ORIRO_FINALIZED_PREVIEW_KEY } from "../send/types.js";
...
let acpBindingRuntimePromise:
  | Promise<typeof import("oriro/plugin-sdk/acp-binding-runtime")>
  | undefined;
let sessionBindingRuntimePromise:
  | Promise<typeof import("oriro/plugin-sdk/session-binding-runtime")>
  | undefined;
...
function loadAcpBindingRuntime(): Promise<
  typeof import("oriro/plugin-sdk/acp-binding-runtime")
> {
  acpBindingRuntimePromise ??= import("oriro/plugin-sdk/acp-binding-runtime");
  return acpBindingRuntimePromise;
}

function loadSessionBindingRuntime(): Promise<
  typeof import("oriro/plugin-sdk/session-binding-runtime")
> {
  sessionBindingRuntimePromise ??= import("oriro/plugin-sdk/session-binding-runtime");
...
function buildMatrixFinalizedPreviewContent(): Record<string, unknown> {
  return { [MATRIX_ORIRO_FINALIZED_PREVIEW_KEY]: true };
}
