...
<Steps>
  ...
  <Step title="Configure Oriro">
    Point Oriro at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Oriro
...
<CardGroup cols={2}>
  <Card title="Anthropic provider" href="/providers/anthropic" icon="bolt">
    Native Oriro integration with Claude CLI or API keys.
  </Card>
