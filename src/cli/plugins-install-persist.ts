...
function addInstalledPluginToAllowlist(cfg: OriroConfig, pluginId: string): OriroConfig {
...
function removeInstalledPluginFromDenylist(cfg: OriroConfig, pluginId: string): OriroConfig {
  ...
  params.runtime.log(
    theme.warn(
      [
        ...
        "Run `oriro plugins doctor` for repair options.",
      ].join("\n"),
    ),
  );
}
