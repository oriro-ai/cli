...
function collectToolAllowlistSources(cfg: OriroConfig): ToolAllowlistSource[] {
...
function collectConfiguredMcpServerNames(cfg: OriroConfig): string[] {
...
function collectSandboxMcpAllowlistWarnings(cfg: OriroConfig): string[] {
