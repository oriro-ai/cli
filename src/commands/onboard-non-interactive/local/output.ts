...
function recoveryHintForGatewayHealthFailure(
  ...
  switch (classification) {
    case "auth-mismatch":
      return "Fix: run `oriro doctor --fix`.";
    case "module-missing":
      return "Fix: run `oriro doctor --fix`.";
    case "service-missing":
      return "Fix: run `oriro gateway install --force`.";
    case "service-stopped":
      return "Fix: run `oriro gateway restart`.";
    case "startup-blocked":
      return "Fix: run `oriro gateway status --deep`.";
    case "not-listening":
      return "Fix: start `oriro gateway run`, or run `oriro gateway restart` for a managed gateway.";
    default:
      return undefined;
  }
}
