...
import type { ProviderAuthContext, ProviderAuthMethod } from "oriro/plugin-sdk/plugin-entry";
import {
  buildApiKeyCredential,
  generatePkceVerifierChallenge,
  type ProviderAuthResult,
} from "oriro/plugin-sdk/provider-auth";
import { generateOAuthState } from "oriro/plugin-sdk/provider-auth-runtime";
      ...
      try {
        ...
        res.end(
          "<!doctype html><html><head><meta charset='utf-8'/></head>" +
            ...
            "<p>You can close this window and return to Oriro.</p></body></html>",
        );
