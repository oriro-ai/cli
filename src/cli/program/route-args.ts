...
/** Parse `oriro health` flags for the route-first status family. */
...
/** Parse `oriro status` flags without registering the full command tree. */
...
/** Parse `oriro gateway status` RPC-only flags accepted by the fast route. */
...
/** Parse `oriro sessions` filters for JSON/list route execution. */
...
/** Parse `oriro agents list` display switches for route-first execution. */
...
/** Parse `oriro config get <path>` while preserving root option handling. */
...
/** Parse `oriro config unset <path>` and its mutation guard flags. */
...
/** Parse `oriro models list` filters for the lightweight model catalog route. */
...
/** Parse `oriro models status` probe controls for the route-first status path. */
...
/** Parse `oriro channels list` display flags for the route-first list path. */
...
/** Parse `oriro channels status` probe flags without full CLI registration. */
...
/** Parse JSON-only `oriro plugins list` flags for plugin inventory output. */
...
/** Parse both `oriro tasks --json` and `oriro tasks list --json` aliases. */
...
/** Parse JSON-only `oriro tasks audit` filters for the route-first audit path. */
