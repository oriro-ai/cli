  ...
  return {
    ...
    ...(qaState
      ? {
          ...
          ORIRO_HOME: qaState.home,
          ORIRO_STATE_DIR: qaState.stateDir,
          ORIRO_CONFIG_PATH: qaState.configPath,
        }
      : {}),
    ORIRO_BUILD_PRIVATE_QA: "1",
    ORIRO_ENABLE_PRIVATE_QA_CLI: "1",
    ORIRO_RUN_NODE_SKIP_DTS_BUILD: env.ORIRO_RUN_NODE_SKIP_DTS_BUILD ?? "1",
    ORIRO_TEST_DISABLE_UPDATE_CHECK: env.ORIRO_TEST_DISABLE_UPDATE_CHECK ?? "1",
  };
}
