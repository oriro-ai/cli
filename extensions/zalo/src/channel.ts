...
import { describeWebhookAccountSnapshot } from "oriro/plugin-sdk/account-helpers";
...
import { buildTokenChannelStatusSummary } from "oriro/plugin-sdk/channel-status";
import type { OriroConfig } from "oriro/plugin-sdk/config-contracts";
import { createStaticReplyToModeResolver } from "oriro/plugin-sdk/conversation-runtime";
import { createChannelDirectoryAdapter } from "oriro/plugin-sdk/directory-runtime";
import { listResolvedDirectoryUserEntriesFromAllowFrom } from "oriro/plugin-sdk/directory-runtime";
...
import { chunkTextForOutbound } from "oriro/plugin-sdk/text-chunking";
import {
  listZaloAccountIds,
