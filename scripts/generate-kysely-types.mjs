...
const SCHEMAS = [
  {
    name: "oriro-state",
    schema: "src/state/oriro-state-schema.sql",
    outFile: "src/state/oriro-state-db.generated.d.ts",
    schemaOutFile: "src/state/oriro-state-schema.generated.ts",
    schemaExport: "ORIRO_STATE_SCHEMA_SQL",
  },
  {
    name: "oriro-agent",
    schema: "src/state/oriro-agent-schema.sql",
    outFile: "src/state/oriro-agent-db.generated.d.ts",
    schemaOutFile: "src/state/oriro-agent-schema.generated.ts",
    schemaExport: "ORIRO_AGENT_SCHEMA_SQL",
  },
];
