...
import type { OriroPluginConfigSchema } from "./types.js";
...
type BuildPluginConfigSchemaOptions = {
  ...
  safeParse?: OriroPluginConfigSchema["safeParse"];
};
...
export function emptyPluginConfigSchema(): OriroPluginConfigSchema {
  return {
