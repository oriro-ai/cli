...
Use this skill when processing alerts from `https://github.com/oriro/oriro/security/secret-scanning`.
...
[
  {
    ...
    "location_url": "https://github.com/oriro/oriro/issues/63101#issuecomment-xxx",
