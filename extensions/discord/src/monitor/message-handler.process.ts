...
import { resolveAckReaction, resolveHumanDelayConfig } from "oriro/plugin-sdk/agent-runtime";
import {
...
import { getAgentScopedMediaLocalRoots } from "oriro/plugin-sdk/media-runtime";
import { resolveChunkMode } from "oriro/plugin-sdk/reply-chunking";
...
import type { ReplyDispatchKind, ReplyPayload } from "oriro/plugin-sdk/reply-runtime";
...
let replyRuntimePromise: Promise<typeof import("oriro/plugin-sdk/reply-runtime")> | undefined;

async function loadReplyRuntime() {
  replyRuntimePromise ??= import("oriro/plugin-sdk/reply-runtime");
