...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/oriro/oriro") {
            ...
            Text("© 2026 Oriro Foundation — MIT License.")
                .font(.footnote)
                .foregroundStyle(.secondary)
                .padding(.top, 4)
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "OriroBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "OriroBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "OriroGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "OriroGitCommit") as? String) ??
            "unknown"
    }
