...
import { runSetupWizardFinalize } from "oriro/plugin-sdk/plugin-test-runtime";
...
describe("createOptionalChannelSetupSurface", () => {
  it("returns a matched adapter and wizard for optional plugins", async () => {
    ...
    expect(
      ...
      "Example setup requires @oriro/example to be installed. Docs: https://docs.oriro.ai/channels/example",
    );
