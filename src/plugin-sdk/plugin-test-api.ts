...
import {
  ...
  type OriroPluginApiWithoutFacades,
} from "../plugins/api-facades.js";
import type { OriroPluginApi } from "./plugin-runtime.js";

/** Partial plugin API overrides accepted by the SDK test helper. */
export type TestPluginApiInput = Partial<OriroPluginApi>;

/** Create a minimal plugin API object for plugin-sdk contract and unit tests. */
export function createTestPluginApi(api: TestPluginApiInput = {}): OriroPluginApi {
  ...
  const mergedApi = {
    ...
    on() {},
    ...flatApi,
  } as OriroPluginApiWithoutFacades;
