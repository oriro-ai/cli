    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["oriro migrate list", "Show available migration providers."],
          ["oriro migrate hermes", "Preview Hermes migration, then prompt before applying."],
          ["oriro migrate hermes --dry-run", "Preview Hermes migration only."],
          [
            "oriro migrate apply hermes --yes",
            "Apply Hermes migration non-interactively after writing a verified backup.",
          ],
          [
            "oriro migrate hermes --no-auth-credentials",
