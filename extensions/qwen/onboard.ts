...
const qwenPresetAppliers = createModelCatalogPresetAppliers<[string]>({
  ...
  resolveParams: (_cfg: OriroConfig, baseUrl: string) => {
...
export function applyQwenConfig(cfg: OriroConfig): OriroConfig {
  return qwenPresetAppliers.applyConfig(cfg, QWEN_GLOBAL_BASE_URL);
}

export function applyQwenConfigCn(cfg: OriroConfig): OriroConfig {
  return qwenPresetAppliers.applyConfig(cfg, QWEN_CN_BASE_URL);
}

export function applyQwenStandardConfig(cfg: OriroConfig): OriroConfig {
  return qwenPresetAppliers.applyConfig(cfg, QWEN_STANDARD_GLOBAL_BASE_URL);
}

export function applyQwenStandardConfigCn(cfg: OriroConfig): OriroConfig {
  return qwenPresetAppliers.applyConfig(cfg, QWEN_STANDARD_CN_BASE_URL);
}

export function applyQwenOAuthConfig(cfg: OriroConfig): OriroConfig {
