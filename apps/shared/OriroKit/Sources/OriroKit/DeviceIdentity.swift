...
enum DeviceIdentityPaths {
    private static let stateDirEnv = ["ORIRO_STATE_DIR"]
        ...
        temporaryDirectory: URL) -> URL
    {
        ...
        return temporaryDirectory.appendingPathComponent("oriro", isDirectory: true)
    }
    ...
    private static func legacyStateDirURL() -> URL? {
        if let appSupport = FileManager.default.urls(for: .applicationSupportDirectory, in: .userDomainMask).first {
            return appSupport.appendingPathComponent("Oriro", isDirectory: true)
        }
        return nil
    }
    ...
    private static func appGroupStateDirURL() -> URL? {
        guard
            let containerURL = FileManager.default
                .containerURL(forSecurityApplicationGroupIdentifier: OriroAppGroup.identifier)
        else {
            return nil
        }
        return containerURL.appendingPathComponent("Oriro", isDirectory: true)
    }
}
