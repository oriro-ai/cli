...
import { estimateBase64DecodedBytes } from "@oriro/media-core/base64";
import { MAX_IMAGE_BYTES } from "@oriro/media-core/constants";
import { extensionForMime, mimeTypeFromFilePath } from "@oriro/media-core/mime";
...
export function resolveChatAttachmentMaxBytes(cfg: OriroConfig): number {
