...
import { normalizeModelCatalogProviderRows } from "@oriro/model-catalog-core/model-catalog-normalize";
...
import type { OriroProviderIndex } from "./provider-index/index.js";

// Provider-index planner converts OriroHub-style preview catalog entries into
