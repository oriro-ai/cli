---
summary: "CLI reference for `oriro system` (system events, heartbeat, presence)"
read_when:
...
oriro system event --text "Check for urgent follow-ups" --url ws://127.0.0.1:18789 --token "$ORIRO_GATEWAY_TOKEN"
oriro system heartbeat enable
oriro system heartbeat last
oriro system presence
```
