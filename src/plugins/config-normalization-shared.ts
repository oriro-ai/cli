...
import { normalizeArrayBackedTrimmedStringList } from "@oriro/normalization-core/string-normalization";
...
export function hasExplicitPluginConfig(plugins?: OriroConfig["plugins"]): boolean {
  if (!plugins) {
    return false;
  }
