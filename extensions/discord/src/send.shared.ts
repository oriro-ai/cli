...
import { buildOutboundMediaLoadOptions } from "oriro/plugin-sdk/media-runtime";
import { extensionForMime } from "oriro/plugin-sdk/media-runtime";
import {
...
import type { ChunkMode } from "oriro/plugin-sdk/reply-chunking";
import { resolveTextChunksWithFallback } from "oriro/plugin-sdk/reply-payload";
import type { RetryRunner } from "oriro/plugin-sdk/retry-runtime";
...
async function resolveDiscordTargetChannelId(
  raw: string,
  opts: DiscordClientOpts & { cfg: OriroConfig },
): Promise<{ channelId: string; dm?: boolean }> {
