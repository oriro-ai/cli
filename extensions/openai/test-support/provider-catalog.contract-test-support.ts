...
import type { ProviderPlugin } from "oriro/plugin-sdk/provider-test-contracts";
...
vi.mock("oriro/plugin-sdk/provider-catalog-runtime", async () => {
  const actual = await vi.importActual<
    typeof import("oriro/plugin-sdk/provider-catalog-runtime")
  >("oriro/plugin-sdk/provider-catalog-runtime");
