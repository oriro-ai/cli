...
import { CURRENT_MESSAGE_MARKER } from "oriro/plugin-sdk/channel-mention-gating";
import {
...
import type { BlockReplyContext } from "oriro/plugin-sdk/reply-runtime";
...
async function resolveStickerVisionSupport(cfg: OriroConfig, agentId: string) {
  try {
