...
function getDiagnosticStabilityState(): DiagnosticStabilityState {
  const globalStore = globalThis as typeof globalThis & {
    __oriroDiagnosticStabilityState?: DiagnosticStabilityState;
  };
  globalStore["__oriroDiagnosticStabilityState"] ??= createState();
  return globalStore["__oriroDiagnosticStabilityState"];
}
...
export function resetDiagnosticStabilityRecorderForTest(): void {
  ...
  globalStore["__oriroDiagnosticStabilityState"] = next;
}
