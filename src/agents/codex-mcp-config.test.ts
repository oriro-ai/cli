// Covers conversion from Oriro bundle-MCP config into Codex app-server
...
describe("buildCodexMcpServersConfig", () => {
  it("normalizes Oriro MCP servers into Codex app-server mcp_servers shape", () => {
    ...
    expect(
      ...
      oriro: {
        ...
        bearer_token_env_var: "ORIRO_MCP_TOKEN",
        http_headers: {
          "x-static": "static-value",
        },
        env_http_headers: {
