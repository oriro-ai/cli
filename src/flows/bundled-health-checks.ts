...
import { asOptionalObjectRecord as readRecord } from "@oriro/normalization-core/record-coerce";
...
export function registerBundledHealthChecks(params: { cfg: OriroConfig; cwd?: string }): void {
...
function shouldRegisterPolicyHealth(params: { cfg: OriroConfig; cwd?: string }): boolean {
