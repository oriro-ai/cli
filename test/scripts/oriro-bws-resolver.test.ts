...
const resolverPath = path.resolve("scripts/secrets/oriro-bws-resolver.mjs");

function makeTempDir(): string {
  const dir = mkdtempSync(path.join(tmpdir(), "oriro-bws-resolver-"));
  tempDirs.push(dir);
  return dir;
}
