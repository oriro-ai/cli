...
import type {
  ...
  AcpRuntimeHandle,
  AcpRuntimeStatus,
} from "@oriro/acp-core/runtime/types";
...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: OriroConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: OriroConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: OriroConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(cfg: OriroConfig): Promise<void> {
