...
vi.mock("oriro/plugin-sdk/media-understanding", async () => {
  const actual = await vi.importActual<typeof import("oriro/plugin-sdk/media-understanding")>(
    "oriro/plugin-sdk/media-understanding",
  );
  return {
    ...actual,
...
afterAll(() => {
  vi.doUnmock("oriro/plugin-sdk/media-understanding");
  vi.resetModules();
});
