      ...
      rows: [
        {
          ...
          state: "warn",
          detail:
            "plugin not installed - run oriro plugins install @oriro/feishu or oriro doctor --fix",
        },
      ],
      details: [],
    });
      ...
      rows: [
        {
          ...
          enabled: true,
          state: "warn",
          detail: "plugin load failed: dependency tree corrupted; run oriro doctor --fix",
        },
      ],
      details: [],
    });
