...
function primeConfiguredContextWindowsFromConfig(cfg: OriroConfig): OriroConfig {
...
function primeConfiguredContextWindows(): OriroConfig | undefined {
...
export async function refreshContextWindowCache(cfg: OriroConfig): Promise<void> {
  beginContextWindowCacheRefresh();
