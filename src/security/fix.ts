...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof OriroConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: OriroConfig; env: NodeJS.ProcessEnv }): {
  cfg: OriroConfig;
  changes: string[];
} {
