...
import type { PluginDoctorStateMigration } from "oriro/plugin-sdk/runtime-doctor";
...
function readConfiguredPluginConfig(config: OriroConfig): MemoryWikiPluginConfig | undefined {
