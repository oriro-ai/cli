...
let runtimeConfigSnapshot: OriroConfig | null = null;
let runtimeConfigSourceSnapshot: OriroConfig | null = null;
...
function configSnapshotsMatch(left: OriroConfig, right: OriroConfig): boolean {
  if (left === right) {
    return true;
  }
  try {
...
export function hashRuntimeConfigValue(value: OriroConfig): string {
...
export function getRuntimeConfigSnapshot(): OriroConfig | null {
  return runtimeConfigSnapshot;
}

export function getRuntimeConfigSourceSnapshot(): OriroConfig | null {
...
export function resolveRuntimeConfigCacheKey(config: OriroConfig): string {
...
export function selectApplicableRuntimeConfig(params: {
  inputConfig?: OriroConfig;
  runtimeConfig?: OriroConfig | null;
  runtimeSourceConfig?: OriroConfig | null;
}): OriroConfig | undefined {
...
export function loadPinnedRuntimeConfig(loadFresh: () => OriroConfig): OriroConfig {
