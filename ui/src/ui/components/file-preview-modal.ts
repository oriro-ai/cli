...
export class OriroFilePreviewModal extends LitElement {
...
if (!customElements.get("oriro-file-preview-modal")) {
  customElements.define("oriro-file-preview-modal", OriroFilePreviewModal);
}
...
declare global {
  interface HTMLElementTagNameMap {
    "oriro-file-preview-modal": OriroFilePreviewModal;
  }
}
