...
import { peekSystemEvents, resetSystemEventsForTest } from "oriro/plugin-sdk/test-fixtures";
...
describe("agent components", () => {
  ...
  const createCfg = (): OriroConfig => ({}) as OriroConfig;
  ...
  it("sends pairing reply when DM sender is not allowlisted", async () => {
    ...
    expect(pairingText).toContain(`oriro pairing approve discord ${code}`);
