/**
 * Projects Oriro context-engine assemblies into Codex prompt text while
...
import { redactSensitiveFieldValue, redactToolPayloadText } from "oriro/plugin-sdk/logging-core";
...
const CONTEXT_HEADER = "ORIRO assembled context for this turn:";
...
/** Projects assembled Oriro context-engine messages into Codex prompt inputs. */
