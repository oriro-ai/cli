...
import type { OriroPluginService, OriroPluginServiceContext } from "./types.js";
...
function expectServiceLogger(ctx: OriroPluginServiceContext) {
...
function expectServiceContexts(
  contexts: OriroPluginServiceContext[],
  config: Parameters<typeof startPluginServices>[0]["config"],
) {
...
describe("startPluginServices", () => {
  ...
  it("starts services and stops them in reverse order", async () => {
    const starts: string[] = [];
    const stops: string[] = [];
    const contexts: OriroPluginServiceContext[] = [];
  ...
  it("grants internal diagnostics only to trusted diagnostics exporter services", async () => {
    ...
    const prometheusContexts: OriroPluginServiceContext[] = [];
    ...
    const officialDiagnosticsOtelContexts: OriroPluginServiceContext[] = [];
    ...
    const officialInstallContexts: OriroPluginServiceContext[] = [];
    ...
    const untrustedContexts: OriroPluginServiceContext[] = [];
    ...
    const spoofedContexts: OriroPluginServiceContext[] = [];
