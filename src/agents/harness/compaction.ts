 ...
 *
 * CLI runtimes and Oriro-native compaction stay on the embedded runner path; plugin harnesses
  ...
  try {
    ...
    if (agentHarnessRuntimeOverride) {
      ...
      if (message.includes("does not support")) {
        ...
        // to native compaction preserves existing Oriro behavior instead of failing rotation.
        return undefined;
      }
    }
    throw err;
