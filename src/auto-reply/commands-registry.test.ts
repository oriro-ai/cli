...
describe("commands registry", () => {
  ...
  it("preserves multiline payloads for skill slash commands", () => {
    ...
    expect(
      normalizeCommandBody("/skill@oriro: demo_skill first line\nsecond line", {
        botUsername: "oriro",
      }),
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@oriro", { botUsername: "oriro" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@oriro args", {
        botUsername: "oriro",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "oriro" })).toBe(
      "/help@otherbot",
    );
  });
