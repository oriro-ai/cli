...
import { resolveDangerousNameMatchingEnabled } from "oriro/plugin-sdk/dangerous-name-runtime";
...
/** Extract the channel config from the full Oriro config object. */
function getChannelConfig(cfg: OriroConfig): SynologyChatChannelConfig | undefined {
 ...
 */
export function listAccountIds(cfg: OriroConfig): string[] {
