...
import { formatSetExplicitDefaultInstruction } from "oriro/plugin-sdk/routing";
import { createSubsystemLogger, isTruthyEnvValue } from "oriro/plugin-sdk/runtime-env";
...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.ORIRO_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listEnabledTelegramAccounts(cfg: OriroConfig): ResolvedTelegramAccount[] {
