...
import type { OriroConfig, TtsConfig } from "oriro/plugin-sdk/config-contracts";
import { parseTtsDirectives } from "oriro/plugin-sdk/speech";
...
function resolveVoiceTtsConfig(params: { cfg: OriroConfig; override?: TtsConfig }): {
  cfg: OriroConfig;
