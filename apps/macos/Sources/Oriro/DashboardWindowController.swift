...
final class DashboardWindowController: NSWindowController, WKNavigationDelegate, WKUIDelegate, NSWindowDelegate {
    ...
    private static func installNativeChromeScript(into userContentController: WKUserContentController) {
        let css = """
        html.oriro-native-macos {
          --oriro-native-titlebar-height: 50px;
        }
        @media (min-width: 700px) {
          html.oriro-native-macos .sidebar-shell {
            padding-top: max(14px, var(--oriro-native-titlebar-height)) !important;
          }
          html.oriro-native-macos .sidebar-shell__header {
        ...
        (() => {
          try {
            if (document.getElementById("oriro-native-macos-chrome")) return;
            const style = document.createElement("style");
            style.id = "oriro-native-macos-chrome";
            style.textContent = \(Self.jsStringLiteral(css));
            document.documentElement.classList.add("oriro-native-macos");
        ...
        auth: DashboardWindowAuth)
    {
        ...
        (() => {
          try {
            ...
            Object.defineProperty(window, "__ORIRO_NATIVE_CONTROL_AUTH__", {
              value: \(json),
              configurable: true,
            });
          } catch {}
