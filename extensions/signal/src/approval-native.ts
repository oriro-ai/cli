...
import { createChannelApprovalCapability } from "oriro/plugin-sdk/approval-delivery-runtime";
import { createLazyChannelApprovalNativeRuntimeAdapter } from "oriro/plugin-sdk/approval-handler-adapter-runtime";
import type { ChannelApprovalNativeRuntimeAdapter } from "oriro/plugin-sdk/approval-handler-runtime";
import {
...
import { buildApprovalReactionPendingContentForRequest } from "oriro/plugin-sdk/approval-reaction-runtime";
import type {
  ExecApprovalRequest,
...
import { parseAgentSessionKey } from "oriro/plugin-sdk/routing";
import {
...
type ApprovalForwardingConfig = NonNullable<NonNullable<OriroConfig["approvals"]>["exec"]>;
