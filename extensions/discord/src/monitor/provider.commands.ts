...
import { danger, warn, type RuntimeEnv } from "oriro/plugin-sdk/runtime-env";
import {
...
export type GetPluginCommandSpecs =
  typeof import("oriro/plugin-sdk/plugin-runtime").getPluginCommandSpecs;

let pluginRuntimePromise: Promise<typeof import("oriro/plugin-sdk/plugin-runtime")> | undefined;

async function loadPluginRuntime() {
  const promise = pluginRuntimePromise ?? import("oriro/plugin-sdk/plugin-runtime");
