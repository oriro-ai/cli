...
export class CodexAppServerClient {
  ...
  /** Registers a handler for app-server requests sent back to Oriro. */
...
export function readCodexVersionFromUserAgent(userAgent: string | undefined): string | undefined {
  ...
  // Oriro, Codex Desktop, or an env override, so only the slash-delimited
...
/** Returns true for app-server approval request methods Oriro can answer. */
