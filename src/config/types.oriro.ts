// Defines the top-level Oriro configuration type.
...
/** Top-level Oriro config as read from user/project config files. */
export type OriroConfig = {
  /** JSON schema URL used by editors and generated config files. */
  $schema?: string;
  meta?: {
    /** Last Oriro version that wrote this config. */
  ...
  wizard?: {
    ...
    lastRunAt?: string;
    /** Oriro version used by the last completed wizard run. */
  ...
  ui?: {
    /** Accent color for Oriro UI chrome (hex). */
    seamColor?: string;
    assistant?: {
...
export type OriroConfigInput = Omit<OriroConfig, "models"> & {
