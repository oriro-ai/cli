...
import type { Context, Model } from "oriro/plugin-sdk/llm";
import { registerSingleProviderPlugin } from "oriro/plugin-sdk/plugin-test-runtime";
import { buildOpenAICompletionsParams } from "oriro/plugin-sdk/provider-transport-runtime";
...
function readManifest() {
  return JSON.parse(readFileSync(new URL("./oriro.plugin.json", import.meta.url), "utf8")) as {
