...
import type { ConfiguredBindingRouteResult } from "oriro/plugin-sdk/conversation-binding-runtime";
...
vi.mock("oriro/plugin-sdk/conversation-binding-runtime", () => ({
...
vi.mock("oriro/plugin-sdk/routing", async (importOriginal) => {
  const actual = await importOriginal<typeof import("oriro/plugin-sdk/routing")>();
  return {
    ...actual,
