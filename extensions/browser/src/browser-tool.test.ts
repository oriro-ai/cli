...
const toolCommonMocks = vi.hoisted(() => ({
  ...
  saveMediaBuffer: vi.fn(async () => ({ path: "/tmp/oriro-media/resized.jpg" })),
}));
...
vi.mock("./browser-tool.runtime.js", () => {
  ...
  return {
    ...
    DEFAULT_UPLOAD_DIR: "/tmp/oriro-browser-uploads",
    BrowserToolSchema: {},
    ...browserActionsMocks,
    ...browserClientMocks,
    ...browserConfigMocks,
...
function resetBrowserToolMocks() {
  ...
  toolCommonMocks.saveMediaBuffer.mockResolvedValue({ path: "/tmp/oriro-media/resized.jpg" });
...
describe("browser tool upload inbound media fallback (#83544)", () => {
  ...
  it("resolves upload paths before arming the file chooser", async () => {
    const inboundPath = "/home/user/.oriro/media/inbound/report.pdf";
