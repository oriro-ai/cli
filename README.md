# ORIRO Oriro — Personal AI Assistant

<p align="center">
    <picture>
        <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/oriro-ai/cli/main/docs/assets/oriro-logo-text-dark.svg">
        <img src="https://raw.githubusercontent.com/oriro-ai/cli/main/docs/assets/oriro-logo-text.svg" alt="Oriro" width="500">
    </picture>
</p>

<p align="center">
  <strong>ORIRO! ORIRO!</strong>
</p>

<p align="center">
  <a href="https://github.com/oriro-ai/cli/actions/workflows/ci.yml?branch=main"><img src="https://img.shields.io/github/actions/workflow/status/oriro-ai/cli/ci.yml?branch=main&style=for-the-badge" alt="CI status"></a>
  <a href="https://github.com/oriro-ai/cli/releases"><img src="https://img.shields.io/github/v/release/oriro-ai/cli?include_prereleases&style=for-the-badge" alt="GitHub release"></a>
  <a href="https://discord.gg/orirod"><img src="https://img.shields.io/discord/1456350064065904867?label=Discord&logo=discord&logoColor=white&color=5865F2&style=for-the-badge" alt="Discord"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg?style=for-the-badge" alt="MIT License"></a>
</p>

**Oriro** is a _personal AI assistant_ you run on your own devices.
...
[Website](https://oriro.ai) · [Docs](https://docs.oriro.ai) · [Vision](VISION.md) · [Third-party notices](THIRD_PARTY_NOTICES.md) · [DeepWiki](https://deepwiki.com/oriro-ai/cli) · [Getting Started](https://docs.oriro.ai/start/getting-started) · [Updating](https://docs.oriro.ai/install/updating) · [Showcase](https://docs.oriro.ai/start/showcase) · [FAQ](https://docs.oriro.ai/help/faq) · [Onboarding](https://docs.oriro.ai/start/wizard) · [Nix](https://github.com/oriro/nix-oriro) · [Docker](https://docs.oriro.ai/install/docker) · [Discord](https://discord.gg/orirod)

New install? Start here: [Getting started](https://docs.oriro.ai/start/getting-started)

Preferred setup: run `oriro onboard` in your terminal.
Oriro Onboard guides you step by step through setting up the gateway, workspace, channels, and skills. It is the recommended CLI setup path and works on **macOS, Linux, and Windows**.
Windows desktop users can start with the native [Windows Hub](https://docs.oriro.ai/platforms/windows) companion app for setup, tray status, chat, node mode, and local MCP mode.
  ...
  <tr>
    <td align="center" width="16.66%">
      <a href="https://openai.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/oriro-ai/cli/main/docs/assets/sponsors/openai-light.svg">
          <img src="https://raw.githubusercontent.com/oriro-ai/cli/main/docs/assets/sponsors/openai.svg" alt="OpenAI" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://github.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/oriro-ai/cli/main/docs/assets/sponsors/github-light.svg">
          <img src="https://raw.githubusercontent.com/oriro-ai/cli/main/docs/assets/sponsors/github.svg" alt="GitHub" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://www.nvidia.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/oriro-ai/cli/main/docs/assets/sponsors/nvidia.svg">
          <img src="https://raw.githubusercontent.com/oriro-ai/cli/main/docs/assets/sponsors/nvidia-dark.svg" alt="NVIDIA" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://vercel.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/oriro-ai/cli/main/docs/assets/sponsors/vercel-light.svg">
          <img src="https://raw.githubusercontent.com/oriro-ai/cli/main/docs/assets/sponsors/vercel.svg" alt="Vercel" height="24">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://blacksmith.sh/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/oriro-ai/cli/main/docs/assets/sponsors/blacksmith-light.svg">
          <img src="https://raw.githubusercontent.com/oriro-ai/cli/main/docs/assets/sponsors/blacksmith.svg" alt="Blacksmith" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://www.convex.dev/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/oriro-ai/cli/main/docs/assets/sponsors/convex-light.svg">
          <img src="https://raw.githubusercontent.com/oriro-ai/cli/main/docs/assets/sponsors/convex.svg" alt="Convex" height="24">
        </picture>
      </a>
    </td>
  </tr>
...
Model note: while many providers and models are supported, prefer a current flagship model from the provider you trust and already use. See [Onboarding](https://docs.oriro.ai/start/wizard).
...
```bash
npm install -g oriro@latest
# or: pnpm add -g oriro@latest

oriro onboard --install-daemon
```

Oriro Onboard installs the Gateway daemon (launchd/systemd user service) so it stays running.

## Quick start (TL;DR)

Runtime: **Node 24 (recommended) or Node 22.19+**.

Full beginner guide (auth, pairing, channels): [Getting started](https://docs.oriro.ai/start/getting-started)
...
```bash
# Send a message
oriro message send --target +1234567890 --message "Hello from Oriro"
...
oriro agent --message "Ship checklist" --thinking high
```

Upgrading? [Updating guide](https://docs.oriro.ai/install/updating) (and run `oriro doctor`).

Models config + CLI: [Models](https://docs.oriro.ai/concepts/models). Auth profile rotation + fallbacks: [Model failover](https://docs.oriro.ai/concepts/model-failover).

## Security defaults (DM access)

Oriro connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs.oriro.ai/gateway/security).
Before remote exposure, use the [Gateway exposure runbook](https://docs.oriro.ai/gateway/security/exposure-runbook).

Default behavior on Telegram/WhatsApp/Signal/iMessage/Microsoft Teams/Discord/Google Chat/Slack:

- **DM pairing** (`dmPolicy="pairing"` / `channels.discord.dmPolicy="pairing"` / `channels.slack.dmPolicy="pairing"`; legacy: `channels.discord.dm.policy`, `channels.slack.dm.policy`): unknown senders receive a short pairing code and the bot does not process their message.
- Approve with: `oriro pairing approve <channel> <code>` (then the sender is added to a local allowlist store).
- Public inbound DMs require an explicit opt-in: set `dmPolicy="open"` and include `"*"` in the channel allowlist (`allowFrom` / `channels.discord.allowFrom` / `channels.slack.allowFrom`; legacy: `channels.discord.dm.allowFrom`, `channels.slack.dm.allowFrom`).

Run `oriro doctor` to surface risky/misconfigured DM policies.

## Highlights

- **[Local-first Gateway](https://docs.oriro.ai/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.oriro.ai/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, IRC, Microsoft Teams, Matrix, Feishu, LINE, Mattermost, Nextcloud Talk, Nostr, Synology Chat, Tlon, Twitch, Zalo, Zalo Personal, WeChat, QQ, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.oriro.ai/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.oriro.ai/nodes/voicewake) + [Talk Mode](https://docs.oriro.ai/nodes/talk)** — wake words on macOS/iOS and continuous voice on Android (ElevenLabs + system TTS fallback).
- **[Live Canvas](https://docs.oriro.ai/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.oriro.ai/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.oriro.ai/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.oriro.ai/platforms)** — Windows Hub, macOS menu bar app, and iOS/Android [nodes](https://docs.oriro.ai/nodes).
- **[Onboarding](https://docs.oriro.ai/start/wizard) + [skills](https://docs.oriro.ai/tools/skills)** — onboarding-driven setup with bundled/managed/workspace skills.
...
- Before exposing anything remotely, read [Security](https://docs.oriro.ai/gateway/security), [Gateway exposure runbook](https://docs.oriro.ai/gateway/security/exposure-runbook), [Sandboxing](https://docs.oriro.ai/gateway/sandboxing), and [Configuration](https://docs.oriro.ai/gateway/configuration).
...
- Skills registry: [OriroHub](https://orirohub.ai)
- Architecture overview: [Architecture](https://docs.oriro.ai/concepts/architecture)

## Docs by goal

- New here: [Getting started](https://docs.oriro.ai/start/getting-started), [Onboarding](https://docs.oriro.ai/start/wizard), [Updating](https://docs.oriro.ai/install/updating)
- Channel setup: [Channels index](https://docs.oriro.ai/channels), [WhatsApp](https://docs.oriro.ai/channels/whatsapp), [Telegram](https://docs.oriro.ai/channels/telegram), [Discord](https://docs.oriro.ai/channels/discord), [Slack](https://docs.oriro.ai/channels/slack)
- Apps + nodes: [Windows Hub](https://docs.oriro.ai/platforms/windows), [macOS](https://docs.oriro.ai/platforms/macos), [iOS](https://docs.oriro.ai/platforms/ios), [Android](https://docs.oriro.ai/platforms/android), [Nodes](https://docs.oriro.ai/nodes)
- Config + security: [Configuration](https://docs.oriro.ai/gateway/configuration), [Security](https://docs.oriro.ai/gateway/security), [Exposure runbook](https://docs.oriro.ai/gateway/security/exposure-runbook), [Sandboxing](https://docs.oriro.ai/gateway/sandboxing)
- Remote + web: [Gateway](https://docs.oriro.ai/gateway), [Remote access](https://docs.oriro.ai/gateway/remote), [Tailscale](https://docs.oriro.ai/gateway/tailscale), [Web surfaces](https://docs.oriro.ai/web)
- Tools + automation: [Tools](https://docs.oriro.ai/tools), [Skills](https://docs.oriro.ai/tools/skills), [Cron jobs](https://docs.oriro.ai/automation/cron-jobs), [Webhooks](https://docs.oriro.ai/automation/webhook), [Gmail Pub/Sub](https://docs.oriro.ai/automation/gmail-pubsub)
- Internals: [Architecture](https://docs.oriro.ai/concepts/architecture), [Agent](https://docs.oriro.ai/concepts/agent), [Session model](https://docs.oriro.ai/concepts/session), [Gateway protocol](https://docs.oriro.ai/reference/rpc)
- Troubleshooting: [Channel troubleshooting](https://docs.oriro.ai/channels/troubleshooting), [Logging](https://docs.oriro.ai/logging), [Docs home](https://docs.oriro.ai)
...
Note: signed builds required for macOS permissions to stick across rebuilds (see [macOS Permissions](https://docs.oriro.ai/platforms/mac/permissions)).

### iOS node (optional)

- Pairs as a node over the Gateway WebSocket (device pairing).
- Voice trigger forwarding + Canvas surface.
- Controlled via `oriro nodes …`.

Runbook: [iOS connect](https://docs.oriro.ai/platforms/ios).

### Android node (optional)

- Pairs as a WS node via device pairing (`oriro devices ...`).
- Exposes Connect/Chat/Voice tabs plus Canvas, Camera, Screen capture, and Android device command families.
- Runbook: [Android connect](https://docs.oriro.ai/platforms/android).
...
```bash
git clone https://github.com/oriro-ai/cli.git
cd oriro

pnpm install

# First run only (or after resetting local Oriro config/workspace)
pnpm oriro setup
...
`pnpm oriro setup` writes the local config/workspace needed for `pnpm gateway:watch`. It is safe to re-run, but you normally only need it on first setup or after resetting local state. `pnpm gateway:watch` does not rebuild `dist/control-ui`, so rerun `pnpm ui:build` after `ui/` changes or use `pnpm ui:dev` when iterating on the Control UI. If you want this checkout to run onboarding directly, use `pnpm oriro onboard --install-daemon`.

Note: `pnpm oriro ...` runs TypeScript directly (via `tsx`). `pnpm build` produces `dist/` for running via Node / the packaged `oriro` binary, while `pnpm gateway:watch` rebuilds the runtime on demand during the dev loop.
...
Switch channels (git + npm): `oriro update --channel stable|beta|dev`.
Details: [Development channels](https://docs.oriro.ai/install/development-channels).

## Agent workspace + skills

- Workspace root: `~/.oriro/workspace` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/.oriro/workspace/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/.oriro-ai/cli.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.oriro.ai/gateway/configuration)

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=oriro-ai/cli&type=date&legend=top-left)](https://www.star-history.com/#oriro-ai/cli&type=date&legend=top-left)

## Oriro

Oriro was built for **Oriro**, a space oriro AI assistant. ORIRO
by Peter Steinberger and the community.

- [oriro.ai](https://oriro.ai)
- [soul.md](https://soul.md)
- [steipete.me](https://steipete.me)
- [@oriro](https://x.com/oriro)
...
Special thanks to Adam Doppelt for the oriro.bot domain.

Thanks to all orirotributors:

<!-- orirotributors:start -->
...
[![Mathias Nagler](https://avatars.githubusercontent.com/u/9951231?v=4&s=48)](https://github.com/mathiasnagler) [![Sean McLellan](https://avatars.githubusercontent.com/u/760674?v=4&s=48)](https://github.com/Oceanswave) [![gumoriro](https://avatars.githubusercontent.com/u/265388744?v=4&s=48)](https://github.com/gumoriro) [![RichardCao](https://avatars.githubusercontent.com/u/4612401?v=4&s=48)](https://github.com/RichardCao) [![MKV21](https://avatars.githubusercontent.com/u/4974411?v=4&s=48)](https://github.com/MKV21) [![petter-b](https://avatars.githubusercontent.com/u/62076402?v=4&s=48)](https://github.com/petter-b) [![CodeForgeNet](https://avatars.githubusercontent.com/u/166907114?v=4&s=48)](https://github.com/CodeForgeNet) [![Johnson Shi](https://avatars.githubusercontent.com/u/13926417?v=4&s=48)](https://github.com/johnsonshi) [![durenzidu](https://avatars.githubusercontent.com/u/38130340?v=4&s=48)](https://github.com/durenzidu) [![dougvk](https://avatars.githubusercontent.com/u/401660?v=4&s=48)](https://github.com/dougvk)
