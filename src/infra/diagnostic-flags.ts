...
import { normalizeUniqueStringEntriesLower } from "@oriro/normalization-core/string-normalization";
import type { OriroConfig } from "../config/types.oriro.js";

const DIAGNOSTICS_ENV = "ORIRO_DIAGNOSTICS";
...
/** Resolves enabled diagnostic flags from config plus `ORIRO_DIAGNOSTICS` overrides. */
