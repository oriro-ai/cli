...
import { listRegisteredMemoryEmbeddingProviderAdapters } from "oriro/plugin-sdk/memory-core-host-embedding-registry";
import {
...
import { extractKeywords } from "oriro/plugin-sdk/memory-core-host-engine-qmd";
import {
  readMemoryFile,
...
import { uniqueValues } from "oriro/plugin-sdk/string-coerce-runtime";
import {
...
const MEMORY_INDEX_MANAGER_CACHE_KEY = Symbol.for("oriro.memoryIndexManagerCache");
...
export class MemoryIndexManager extends MemoryManagerEmbeddingOps implements MemorySearchManager {
  ...
  protected readonly cfg: OriroConfig;
