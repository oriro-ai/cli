// Android Version script supports Oriro repository automation.
...
export function renderAndroidVersionProperties(version: ResolvedAndroidVersion): string {
  return `# Shared Android version defaults.\n# Source of truth: apps/android/version.json\n# Generated by scripts/android-sync-versioning.ts.\n\nORIRO_ANDROID_VERSION_NAME=${version.canonicalVersion}\nORIRO_ANDROID_VERSION_CODE=${version.versionCode}\n`;
}
