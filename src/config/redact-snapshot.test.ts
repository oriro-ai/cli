...
describe("redactConfigSnapshot", () => {
          ...
          plugins: [
            {
              ...
              manifestPath: "/private/plugin/root/oriro.plugin.json",
            },
          ],
          diagnostics: [],
        },
  ...
  it("does not redact passwordFile path fields", () => {
    const snapshot = makeSnapshot({
      channels: {
        irc: {
          passwordFile: "/etc/oriro/irc-password.txt",
          nickserv: {
            passwordFile: "/etc/oriro/nickserv-password.txt",
    ...
    expect(irc.passwordFile).toBe("/etc/oriro/irc-password.txt");
    expect(nickserv.passwordFile).toBe("/etc/oriro/nickserv-password.txt");
