...
function createSandboxContext(overrides?: Partial<SandboxContext>): SandboxContext {
  ...
  const base = {
    ...
    workspaceDir: "/tmp/oriro-sandbox",
    agentWorkspaceDir: "/tmp/oriro-workspace",
    workspaceAccess: "none",
    runtimeId: "oriro-sbx-test",
    runtimeLabel: "oriro-sbx-test",
    containerName: "oriro-sbx-test",
    ...
    browser: {
      ...
      containerName: "oriro-sbx-browser-test",
    },
