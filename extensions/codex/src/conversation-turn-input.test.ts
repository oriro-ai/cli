...
describe("codex conversation turn input", () => {
    ...
    expect(
      buildCodexConversationTurnInput({
        ...
        event: {
          ...
          isGroup: false,
          metadata: {
            mediaPath: "file:///tmp/Oriro%20QA/photo.png",
            mediaType: "image/png",
          },
        },
      }),
      ...
      { type: "text", text: "look", text_elements: [] },
      { type: "localImage", path: "/tmp/Oriro QA/photo.png" },
    ]);
  });
    ...
    expect(
      buildCodexConversationTurnInput({
        ...
        event: {
          ...
          isGroup: false,
          metadata: {
            mediaUrls: ["/tmp/staged-photo.png", "file:///tmp/Oriro%20QA/second.jpg"],
      ...
      { type: "localImage", path: "/tmp/Oriro QA/second.jpg" },
    ]);
  });
  ...
  it("treats Windows media paths as Codex local image input", () => {
    expect(
      ...
      { type: "text", text: "look", text_elements: [] },
      { type: "localImage", path: "C:\\Oriro QA\\photo.png" },
    ]);
  });
});
