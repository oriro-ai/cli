...
import ai.oriro.app.ui.mobileAccentBorderStrong
...
import ai.oriro.app.ui.mobileHeadline
import ai.oriro.app.ui.mobileSurface
import ai.oriro.app.ui.mobileText
import ai.oriro.app.ui.mobileTextSecondary
import ai.oriro.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.oriro.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.oriro.app.ui.mobileFontFamily,
