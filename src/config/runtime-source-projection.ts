...
export function projectConfigOntoRuntimeSourceSnapshot(config: OriroConfig): OriroConfig {
  ...
  return applyMergePatch(projectedSource, runtimePatch) as OriroConfig;
}
