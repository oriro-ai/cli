...
// Keep the schema local to avoid a circular import through acp-spawn/oriro-tools.
...
function resolveAcpUnavailableMessage(opts?: { sandboxed?: boolean; config?: OriroConfig }) {
