...
import { normalizeProviderIdForAuth } from "@oriro/model-catalog-core/provider-id";
import { normalizeOptionalString as normalizeOptionalPathInput } from "@oriro/normalization-core/string-coerce";
