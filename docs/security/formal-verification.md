---
summary: Machine-checked security models for Oriro's highest-risk paths.
...
This page tracks Oriro's **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that Oriro enforces its
...
**What this is not (yet):** a proof that "Oriro is secure in all respects" or that the full TypeScript implementation is correct.

## Where the models live

Models are maintained in a separate repo: [vignesh07/oriro-formal-models](https://github.com/vignesh07/oriro-formal-models).
...
```bash
git clone https://github.com/vignesh07/oriro-formal-models
cd oriro-formal-models
