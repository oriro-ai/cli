...
const LIVE_MEDIA_RUNNER_IMAGE = "ghcr.io/oriro/oriro-live-media-runner:ubuntu-24.04";
...
describe("package artifact reuse", () => {
  ...
  it("documents the full-release Telegram package path in operator summaries", () => {
    ...
    expectTextToIncludeAll(workflow, [
      ...
      "Package Telegram E2E: Oriro Release Checks Package Acceptance",
  ...
  it("gates stable GitHub publication on the Windows Hub release asset contract", () => {
    ...
    expect(windowsWorkflow).toContain(
      "--repo oriro/oriro-windows-node --json tagName,isDraft,isPrerelease,assets,url",
    );
    expect(windowsWorkflow).toContain(
  ...
  it("keeps beta release verification and OriroHub publish repair hooks wired", () => {
    ...
    expect(oriroHubWorkflow).toContain(
      "uses: oriro/orirohub/.github/workflows/package-publish.yml@9d49df109d4ad3dc8a6ecf05d26b39f46d294721",
    );
    ...
    expect(oriroHubNewWorkflow).not.toContain(
      "uses: oriro/orirohub/.github/workflows/package-publish.yml",
    );
    ...
    expect(oriroHubNewWorkflow).toContain('trustedPublisher?.repository !== "oriro/oriro"');
