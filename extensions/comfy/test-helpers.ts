...
export function buildComfyConfig(config: Record<string, unknown>): OriroConfig {
  return {
    plugins: {
      entries: {
        comfy: { config },
...
export function buildLegacyComfyConfig(config: Record<string, unknown>): OriroConfig {
  return {
    models: {
      providers: {
        comfy: config,
