...
/** Returns true when a command name is owned by built-in Oriro command handling. */
...
export function listPluginInvocationKeys(command: OriroPluginCommandDefinition): string[] {
