...
function toCandidate(
  ...
  defaults: NonNullable<OriroConfig["secrets"]>["defaults"] | undefined,
 ...
 */
export function migrateLegacySecretRefEnvMarkers(config: OriroConfig): {
  config: OriroConfig;
  changes: string[];
} {
  ...
  const next = structuredClone(config) as OriroConfig & Record<string, unknown>;
