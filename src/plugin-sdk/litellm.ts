...
import type { ModelDefinitionConfig, OriroConfig } from "../config/types.js";
import { loadBundledPluginPublicSurfaceModuleSync } from "./facade-loader.js";

type FacadeModule = {
  applyLitellmConfig: (cfg: OriroConfig) => OriroConfig;
  applyLitellmProviderConfig: (cfg: OriroConfig) => OriroConfig;
...
/** Apply LiteLLM defaults to the full Oriro config. */
