...
} from "oriro/plugin-sdk/channel-route";
...
type ApprovalForwardingConfig = NonNullable<NonNullable<OriroConfig["approvals"]>["plugin"]>;
...
function resolvePluginApprovalForwardingConfig(cfg: OriroConfig) {
