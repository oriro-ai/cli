 ...
 * streamable-HTTP SDK transports with Oriro auth, redirect, and logging rules.
 */
import {
  SSEClientTransport,
...
function attachStderrLogging(serverName: string, transport: OriroStdioClientTransport) {
