...
import { requireRegisteredProvider } from "oriro/plugin-sdk/plugin-test-runtime";
import * as providerAuth from "oriro/plugin-sdk/provider-auth-runtime";
import * as providerHttp from "oriro/plugin-sdk/provider-http";
