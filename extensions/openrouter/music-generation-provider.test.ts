...
import { expectExplicitMusicGenerationCapabilities } from "oriro/plugin-sdk/provider-test-contracts";
...
vi.mock("oriro/plugin-sdk/provider-http", async (importOriginal) => {
  const original = await importOriginal<typeof import("oriro/plugin-sdk/provider-http")>();
  return {
    ...original,
