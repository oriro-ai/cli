...
import { resolveNormalizedAccountEntry } from "oriro/plugin-sdk/account-core";
...
import { createChannelPluginBase, type ChannelPlugin } from "oriro/plugin-sdk/channel-core";
import { getChatChannelMeta } from "oriro/plugin-sdk/channel-plugin-common";
import type { OriroConfig, TelegramAccountConfig } from "oriro/plugin-sdk/config-contracts";
import { DEFAULT_ACCOUNT_ID } from "oriro/plugin-sdk/routing";
 ...
 *
 * See: https://github.com/oriro-ai/cli/issues/53876
 */
function isBlockedByMultiBotGuard(cfg: OriroConfig, accountId: string): boolean {
