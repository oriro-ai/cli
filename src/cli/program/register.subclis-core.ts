...
const entrySpecs: readonly CommandGroupDescriptorSpec<SubCliRegistrar>[] = [
  ...
  ...defineImportedProgramCommandGroupSpecs([
    ...
    {
      commandNames: ["orirobot"],
      loadModule: () => import("../orirobot-cli.js"),
      exportName: "registerOrirobotCli",
    },
  ]),
  {
  ...
  ...defineImportedProgramCommandGroupSpecs([
    ...
    {
      commandNames: ["routers"],
      loadModule: () => import("../routers-cli.js"),
      exportName: "registerRoutersCli",
    },
    {
      commandNames: ["scribe"],
      loadModule: () => import("../scribe-cli.js"),
      exportName: "registerScribeCli",
    },
    {
      commandNames: ["skills"],
