...
import { root as fsRoot } from "oriro/plugin-sdk/file-access-runtime";
import type {
  SandboxFsBridge,
  SandboxFsStat,
  SandboxResolvedPath,
} from "oriro/plugin-sdk/sandbox";
import { createWritableRenameTargetResolver } from "oriro/plugin-sdk/sandbox";
...
const MATERIALIZED_SKILLS_CONTAINER_PARTS = [".oriro", "sandbox-skills", "skills"] as const;
