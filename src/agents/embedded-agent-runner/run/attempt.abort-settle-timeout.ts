...
type AbortSettleTimeoutEnv = Partial<
  Pick<NodeJS.ProcessEnv, "ORIRO_EMBEDDED_ABORT_SETTLE_TIMEOUT_MS" | "ORIRO_TEST_FAST">
>;
...
export function resolveEmbeddedAbortSettleTimeoutMs(
  ...
  const override = parseStrictPositiveInteger(env.ORIRO_EMBEDDED_ABORT_SETTLE_TIMEOUT_MS);
  if (override !== undefined) {
    return override;
  }
  return env.ORIRO_TEST_FAST === "1" ? 250 : 2_000;
}
