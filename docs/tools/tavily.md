...
[Tavily](https://tavily.com) is a search API designed for AI applications. Oriro exposes it in two ways:
...
<Tip>
Choosing Tavily in onboarding or `oriro configure --section web` enables the bundled Tavily plugin automatically.
</Tip>
