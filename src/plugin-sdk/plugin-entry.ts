...
export type OriroPluginApi = import("../plugins/types.js").OriroPluginApi;
export type OriroPluginCommandDefinition =
  import("../plugins/types.js").OriroPluginCommandDefinition;
export type OriroPluginConfigSchema = import("../plugins/types.js").OriroPluginConfigSchema;
export type OriroPluginDefinition = import("../plugins/types.js").OriroPluginDefinition;
export type OriroPluginHttpRouteHandler =
  import("../plugins/types.js").OriroPluginHttpRouteHandler;
export type OriroPluginNodeHostCommand =
  import("../plugins/types.js").OriroPluginNodeHostCommand;
export type OriroPluginNodeInvokePolicy =
  import("../plugins/types.js").OriroPluginNodeInvokePolicy;
export type OriroPluginNodeInvokePolicyContext =
  import("../plugins/types.js").OriroPluginNodeInvokePolicyContext;
export type OriroPluginNodeInvokePolicyResult =
  import("../plugins/types.js").OriroPluginNodeInvokePolicyResult;
export type OriroPluginReloadRegistration =
  import("../plugins/types.js").OriroPluginReloadRegistration;
export type OriroPluginSecurityAuditCollector =
  import("../plugins/types.js").OriroPluginSecurityAuditCollector;
export type OriroPluginSecurityAuditContext =
  import("../plugins/types.js").OriroPluginSecurityAuditContext;
export type OriroPluginService = import("../plugins/types.js").OriroPluginService;
export type OriroPluginServiceContext =
  import("../plugins/types.js").OriroPluginServiceContext;
export type OriroPluginToolContext = import("../plugins/types.js").OriroPluginToolContext;
export type OriroPluginToolFactory = import("../plugins/types.js").OriroPluginToolFactory;
...
export type OriroGatewayDiscoveryAdvertiseContext =
  import("../plugins/types.js").OriroGatewayDiscoveryAdvertiseContext;
export type OriroGatewayDiscoveryService =
  import("../plugins/types.js").OriroGatewayDiscoveryService;
...
type DefinePluginEntryOptions = {
   ...
   */
  kind?: OriroPluginDefinition["kind"];
  configSchema?: OriroPluginConfigSchema | (() => OriroPluginConfigSchema);
  reload?: OriroPluginDefinition["reload"];
  nodeHostCommands?: OriroPluginDefinition["nodeHostCommands"];
  securityAuditCollectors?: OriroPluginDefinition["securityAuditCollectors"];
  register: (api: OriroPluginApi) => void;
};

/** Normalized object shape that Oriro loads from a plugin entry module. */
type DefinedPluginEntry = {
  id: string;
  name: string;
  description: string;
  configSchema: OriroPluginConfigSchema;
  register: NonNullable<OriroPluginDefinition["register"]>;
} & Pick<
  OriroPluginDefinition,
 ...
 * `oriro/plugin-sdk/core` so they inherit the channel capability wiring.
 */
