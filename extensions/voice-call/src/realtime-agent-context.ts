...
import { buildRealtimeVoiceAgentConsultPolicyInstructions } from "oriro/plugin-sdk/realtime-voice";
import { root } from "oriro/plugin-sdk/security-runtime";
import { normalizeOptionalString as normalizeString } from "oriro/plugin-sdk/string-coerce-runtime";
...
export async function buildRealtimeVoiceInstructions(params: {
  ...
  if (contextConfig.includeIdentity) {
    const identity = params.agentRuntime.resolveAgentIdentity(
      params.coreConfig as OriroConfig,
      agentId,
