...
import type { ChannelRuntimeSurface } from "oriro/plugin-sdk/channel-contract";
...
import type { SignalReactionNotificationMode } from "oriro/plugin-sdk/config-contracts";
import {
  detectMime,
