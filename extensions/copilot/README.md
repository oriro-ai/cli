# GitHub Copilot agent runtime (Oriro plugin)

External Oriro plugin that registers a `copilot` agent harness backed by `@github/copilot-sdk` and the GitHub Copilot CLI.
