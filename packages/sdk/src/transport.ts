// Oriro SDK module implements transport behavior.
import { GatewayClient } from "@oriro/gateway-client";
...
/** Connectable SDK transport backed by @oriro/gateway-client. */
export class GatewayClientTransport implements ConnectableOriroTransport {
...
): transport is ConnectableOriroTransport {
