...
const workspaceSourceAliases = [
  ...
  {
    find: "oriro/plugin-sdk/test-fixtures",
    replacement: path.resolve(repoRoot, "src/plugin-sdk/test-fixtures.ts"),
  },
  {
    find: /^@oriro\/model-catalog-core\/(.+)$/u,
  ...
  {
    find: /^@oriro\/normalization-core\/(.+)$/u,
