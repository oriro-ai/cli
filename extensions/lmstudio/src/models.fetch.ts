...
import { SELF_HOSTED_DEFAULT_COST } from "oriro/plugin-sdk/provider-setup";
import { fetchWithSsrFGuard, type SsrFPolicy } from "oriro/plugin-sdk/ssrf-runtime";
...
/** Discovers LLM models from LM Studio and maps them to Oriro model definitions. */
