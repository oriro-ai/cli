...
function mergeSignalAccountConfig(cfg: OriroConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: OriroConfig): ResolvedSignalAccount[] {
