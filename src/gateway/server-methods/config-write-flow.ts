...
export function didSharedGatewayAuthChange(prev: OriroConfig, next: OriroConfig): boolean {
...
}): Promise<{ path: string; config: OriroConfig; queueFollowUp: () => void }> {
