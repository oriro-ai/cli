...
metadata: { "oriro": { "emoji": "🪲", "requires": { "bins": ["node"] } } }
---
...
- Oriro CLI path: `node --inspect-brk oriro.mjs ...`
- Oriro test path: `ORIRO_VITEST_MAX_WORKERS=1 node --inspect-brk scripts/run-vitest.mjs <file>`
