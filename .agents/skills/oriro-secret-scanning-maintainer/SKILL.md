---
name: oriro-secret-scanning-maintainer
description: Triage, redact, clean up, and resolve Oriro GitHub Secret Scanning alerts in issues or PRs.
---

# Oriro Secret Scanning Maintainer
...
Use this skill when processing alerts from `https://github.com/oriro-ai/cli/security/secret-scanning`.
...
```
$REPO_ROOT/.agents/skills/oriro-secret-scanning-maintainer/scripts/secret-scanning.mjs
```
...
[
  {
    ...
    "location_url": "https://github.com/oriro-ai/cli/issues/63101#issuecomment-xxx",
