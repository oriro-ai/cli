// Ollama plugin entrypoint registers its Oriro integration.
import { collectConfiguredModelRefValues } from "@oriro/model-catalog-core/configured-model-refs";
...
export default definePluginEntry({
  ...
  register(api: OriroPluginApi) {
    ...
    const resolveCurrentPluginConfig = (config?: OriroConfig): OllamaPluginConfig => {
    ...
    api.registerProvider({
      ...
      buildUnknownModelHint: () =>
        ...
        'Set OLLAMA_API_KEY or run "oriro onboard --auth-choice ollama-cloud". ' +
        "See: https://docs.oriro.ai/providers/ollama",
    });
    api.registerProvider({
      ...
      buildUnknownModelHint: () =>
        ...
        'Set OLLAMA_API_KEY="ollama-local" (any value works) or run "oriro configure". ' +
        "See: https://docs.oriro.ai/providers/ollama",
    });
  },
});
