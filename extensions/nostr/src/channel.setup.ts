...
function getNostrConfig(cfg: OriroConfig): NostrAccountConfig | undefined {
  return (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
}

function listSetupNostrAccountIds(cfg: OriroConfig): string[] {
...
function resolveDefaultSetupNostrAccountId(cfg: OriroConfig): string {
