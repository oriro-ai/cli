...
vi.mock("../discovery.js", () => ({
  discoverOriroPlugins: (
    ...args: Parameters<typeof registryJitiMocks.discoverOriroPlugins>
  ) => registryJitiMocks.discoverOriroPlugins(...args),
}));
