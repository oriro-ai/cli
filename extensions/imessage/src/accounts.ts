...
function mergeIMessageAccountConfig(cfg: OriroConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: OriroConfig): ResolvedIMessageAccount[] {
