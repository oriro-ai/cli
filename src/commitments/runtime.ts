...
type CommitmentExtractionRuntime = {
  ...
  resolveDefaultModel?: (params: { cfg: OriroConfig; agentId?: string }) => ModelRef;
...
let queue: Array<Omit<CommitmentExtractionItem, "existingPending"> & { cfg?: OriroConfig }> = [];
...
async function hydrateBatch(
  batch: Array<Omit<CommitmentExtractionItem, "existingPending"> & { cfg?: OriroConfig }>,
