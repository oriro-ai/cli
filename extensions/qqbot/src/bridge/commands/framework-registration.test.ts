...
function registerCommands(): OriroPluginCommandDefinition[] {
  ensurePlatformAdapter();
  const commands: OriroPluginCommandDefinition[] = [];
  const api = {
    logger: {},
    registerCommand: (command: OriroPluginCommandDefinition) => {
...
function findCommand(
  commands: OriroPluginCommandDefinition[],
  name: string,
): OriroPluginCommandDefinition {
