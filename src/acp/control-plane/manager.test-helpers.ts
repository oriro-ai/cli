...
import type { AcpRuntime, AcpRuntimeCapabilities } from "@oriro/acp-core/runtime/types";
...
export type { AcpRuntime, OriroConfig, SessionAcpMeta };
...
export function installAcpSessionManagerTestLifecycle(): void {
  ...
  afterEach(() => {
    if (ORIGINAL_STATE_DIR === undefined) {
      ...
      setTestEnvValue("ORIRO_STATE_DIR", ORIGINAL_STATE_DIR);
    }
