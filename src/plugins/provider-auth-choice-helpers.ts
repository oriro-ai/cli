...
function normalizeModelProviderConfigsForWrite(cfg: OriroConfig): OriroConfig {
...
function normalizeConfigModelRefsForWrite(cfg: OriroConfig): OriroConfig {
    ...
    agents: {
      ...
      defaults: {
        ...
        models: sanitizeConfigPatchValue(patchModels) as NonNullable<
          NonNullable<OriroConfig["agents"]>["defaults"]
        >["models"],
      },
    },
  });
