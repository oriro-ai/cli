...
import { buildMessagingTarget, type MessagingTarget } from "oriro/plugin-sdk/channel-targets";
import type { DirectoryConfigParams } from "oriro/plugin-sdk/directory-runtime";
