...
type ParseOriroHubPluginSpecFn = (typeof import("../infra/orirohub.js"))["parseOriroHubPluginSpec"];
...
export const loadConfig: Mock<LoadConfigFn> = vi.fn<LoadConfigFn>(() => ({}) as OriroConfig);
...
export const replaceConfigFile: AsyncUnknownMock = vi.fn(
  async (params: { nextConfig: OriroConfig }) => await writeConfigFile(params.nextConfig),
) as AsyncUnknownMock;
const resolveStateDir: Mock<() => string> = vi.fn(() => "/tmp/oriro-state");
...
export const installPluginFromOriroHub: AsyncUnknownMock = vi.fn();
export const parseOriroHubPluginSpec: Mock<ParseOriroHubPluginSpecFn> = vi.fn();
...
vi.mock("../config/config.js", () => ({
  ...
  writeConfigFile: ((config: OriroConfig) =>
    invokeMock<
      [OriroConfig],
...
vi.mock("../plugins/orirohub.js", () => ({
  ...
  installPluginFromOriroHub: ((
    ...args: Parameters<(typeof import("../plugins/orirohub.js"))["installPluginFromOriroHub"]>
  ) =>
    invokeMock<
      Parameters<(typeof import("../plugins/orirohub.js"))["installPluginFromOriroHub"]>,
      ReturnType<(typeof import("../plugins/orirohub.js"))["installPluginFromOriroHub"]>
    >(
      installPluginFromOriroHub,
      ...args,
    )) as (typeof import("../plugins/orirohub.js"))["installPluginFromOriroHub"],
}));

vi.mock("../infra/orirohub.js", () => ({
  parseOriroHubPluginSpec: ((
    ...args: Parameters<(typeof import("../infra/orirohub.js"))["parseOriroHubPluginSpec"]>
  ) =>
    invokeMock<
      Parameters<(typeof import("../infra/orirohub.js"))["parseOriroHubPluginSpec"]>,
      ReturnType<(typeof import("../infra/orirohub.js"))["parseOriroHubPluginSpec"]>
    >(
      parseOriroHubPluginSpec,
      ...args,
    )) as (typeof import("../infra/orirohub.js"))["parseOriroHubPluginSpec"],
}));
...
export function resetPluginsCliTestState() {
  ...
  installPluginFromOriroHub.mockReset();
  parseOriroHubPluginSpec.mockReset();
  ...
  applyExclusiveSlotSelection.mockImplementation((({ config }: { config: OriroConfig }) => ({
    config,
    warnings: [],
  })) as (...args: unknown[]) => unknown);
  ...
  installPluginFromOriroHub.mockResolvedValue({
    ok: false,
    error: "orirohub install disabled in test",
  });
  parseOriroHubPluginSpec.mockReturnValue(null);
