...
import { normalizeStringEntriesLower } from "@oriro/normalization-core/string-normalization";
...
function resolveSessionAgentId(cfg: OriroConfig, sessionKey: string): string {
