...
function resolveQianfanPreset(cfg: OriroConfig): {
  api: ModelApi;
  baseUrl: string;
...
export function applyQianfanProviderConfig(cfg: OriroConfig): OriroConfig {
  return qianfanPresetAppliers.applyProviderConfig(cfg);
}

export function applyQianfanConfig(cfg: OriroConfig): OriroConfig {
