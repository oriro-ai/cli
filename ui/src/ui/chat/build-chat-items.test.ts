...
const SENDER_METADATA_BLOCK =
  'Sender (untrusted metadata):\n```json\n{"label":"oriro-control-ui","id":"oriro-control-ui"}\n```';
...
describe("buildChatItems", () => {
  ...
  it("deduplicates relay-labeled assistant copies by Oriro transcript metadata id", () => {
    const groups = messageGroups({
      messages: [
        {
          __oriro: { id: "reply-3" },
  ...
  it("deduplicates relay-labeled assistant copies by Oriro metadata before surface ids", () => {
    const groups = messageGroups({
      messages: [
        {
      ...
      toolMessages: [
        {
          ...
          content: JSON.stringify({
            ...
            view: {
              backend: "canvas",
              id: "cv_nearest_turn",
              url: "/__oriro__/canvas/documents/cv_nearest_turn/index.html",
      ...
      toolMessages: [
        {
          ...
          content: JSON.stringify({
            ...
            view: {
              backend: "canvas",
              id: "cv_empty_anchor",
              url: "/__oriro__/canvas/documents/cv_empty_anchor/index.html",
          ...
          content: JSON.stringify({
            selected_item: {
              ...
              view: {
                ...
                url: "/__oriro__/canvas/documents/cv_generic_inline/index.html",
            ...
            },
            {
              ...
              text: JSON.stringify({
                ...
                view: {
                  ...
                  url: "/__oriro__/canvas/documents/cv_streamed_artifact/index.html",
                  title: "Streamed demo",
                  preferred_height: 320,
                },
                presentation: {
...
function createAssistantCanvasBlock(params: { suffix: string }) {
  ...
  return {
    ...
    preview: {
      ...
      viewId,
      title: "Inline demo",
      url: `/__oriro__/canvas/documents/${viewId}/index.html`,
      preferredHeight: 360,
    },
  };
}
