...
export const resolveAgentHarnessPolicyMock = vi.fn(() => ({ runtime: "oriro" }));
...
export const createOriroCodingToolsMock = vi.fn(() => []);
...
export async function loadCompactHooksHarness(): Promise<{
  ...
  vi.doMock("../models-config.js", () => ({
    ensureOriroModelsJson: vi.fn(async () => {}),
  }));
  ...
  vi.doMock("../../context-engine/registry.js", () => ({
    ...
    resolveContextEngineOwnerPluginId: vi.fn(() => "lossless-oriro"),
  }));
