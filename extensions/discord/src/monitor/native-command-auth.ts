...
import { resolveCommandAuthorizedFromAuthorizers } from "oriro/plugin-sdk/command-auth-native";
...
export function resolveDiscordCommandOwnerAllowFrom(cfg: OriroConfig): string[] | undefined {
