...
import { resolveStateDir } from "oriro/plugin-sdk/memory-core-host-runtime-core";
...
const DIARY_START_MARKER = "<!-- oriro:dreaming:diary:start -->";
const DIARY_END_MARKER = "<!-- oriro:dreaming:diary:end -->";
const BACKFILL_ENTRY_MARKER = "oriro:dreaming:backfill-entry";
