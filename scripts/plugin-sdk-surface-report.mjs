...
try {
  budgets = {
    ...
    publicExports: readBudgetEnv("ORIRO_PLUGIN_SDK_MAX_PUBLIC_EXPORTS", 10331),
    publicFunctionExports: readBudgetEnv("ORIRO_PLUGIN_SDK_MAX_PUBLIC_FUNCTION_EXPORTS", 5183),
