...
const resolveGatewayLogPathsMock = vi.fn(() => ({
  logDir: "C:\\tmp\\oriro-state\\logs",
  stdoutPath: "C:\\tmp\\oriro-state\\logs\\gateway.log",
  stderrPath: "C:\\tmp\\oriro-state\\logs\\gateway.err.log",
}));
const resolveGatewaySupervisorLogPathsMock = vi.fn(() => ({
  logDir: "C:\\Users\\test\\Library\\Logs\\oriro",
  stdoutPath: "C:\\Users\\test\\Library\\Logs\\oriro\\gateway.log",
  stderrPath: "C:\\Users\\test\\Library\\Logs\\oriro\\gateway.err.log",
}));
const resolveGatewayRestartLogPathMock = vi.fn(
  () => "C:\\tmp\\oriro-state\\logs\\gateway-restart.log",
);
