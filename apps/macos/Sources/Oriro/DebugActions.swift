...
enum DebugActions {
    private static let verboseDefaultsKey = "oriro.debug.verboseMain"
    private static let sessionMenuLimit = 12
    private static let onboardingSeenKey = "oriro.onboardingSeen"
    ...
    static func sendTestNotification() async {
        _ = await NotificationManager().send(title: "Oriro", body: "Test notification", sound: nil)
    }
    ...
    private static func resolveSessionStorePath() -> String {
        ...
        let configURL = OriroPaths.configURL
        guard
