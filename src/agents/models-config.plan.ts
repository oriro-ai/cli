...
export async function planOriroModelsJsonWithDeps(
  params: {
    cfg: OriroConfig;
...
export async function planOriroModelsJson(
  params: Parameters<typeof planOriroModelsJsonWithDeps>[0],
): Promise<ModelsJsonPlan> {
  return planOriroModelsJsonWithDeps(params);
}
