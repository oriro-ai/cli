/** Doctor contribution for low disk space around the Oriro state directory. */
 ...
 *
 * This catches a common operational failure mode where Oriro silently
...
export function noteDiskSpace(
  _cfg: OriroConfig, // reserved for API consistency with other Doctor contributions
  deps?: {
