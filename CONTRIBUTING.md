# Contributing to Oriro

Welcome to the oriro tank! ORIRO

## Quick Links

- **GitHub:** https://github.com/oriro-ai/cli
- **Vision:** [`VISION.md`](VISION.md)
- **Discord:** https://discord.gg/orirod
- **X/Twitter:** [@steipete](https://x.com/steipete) / [@oriro](https://x.com/oriro)
...
- **Shadow** - Discord subsystem, Discord admin, Orirohub, all community moderation
  - GitHub: [@thewilloftheshadow](https://github.com/thewilloftheshadow) · X: [@4shadowed](https://x.com/4shadowed)

- **Vignesh** - Memory (QMD), formal modeling, TUI, IRC, and Oriro
...
- **Maurice Niu** - OriroHub, Security, Stability, Data integrity
  - GitHub: [@momothemage](https://github.com/momothemage) · X: [@MomoPsicasso](https://x.com/MomoPsicasso)

## How to Contribute

1. **Bugs & small fixes** → Open a PR!
2. **New features / architecture** → Start a [GitHub Issue](https://github.com/oriro-ai/cli/issues/new/choose) or ask in Discord first. Most features are not accepted and should be third party plugins instead using our plugin SDK.
...
For coordinated change sets that genuinely need more than 20 PRs, join the **#orirotributors** channel in Discord and talk to maintainers first.

## Before You PR

- Test locally with your Oriro instance
...
- Do not edit `CHANGELOG.md` in contributor PRs. Maintainers or OriroSweeper add the changelog entry when landing user-facing changes.
...
- Do not submit test or CI-config fixes for failures already red on `main` CI. If a failure is already visible in the [main branch CI runs](https://github.com/oriro-ai/cli/actions), it's a known issue the Maintainer team is tracking, and a PR that only addresses those failures will be closed automatically. If you spot a _new_ regression not yet shown in main CI, report it as an issue first.
...
- **Skills**: For skill contributions, head to [OriroHub](https://orirohub.ai/) — the community hub for Oriro skills.
- **Performance**: Optimizing token usage and compaction logic.

Check the [GitHub Issues](https://github.com/oriro-ai/cli/issues) for
["good first issue"](https://github.com/oriro-ai/cli/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22)
...
If you're an experienced contributor who wants to help shape Oriro's direction — whether through code, docs, or community — we'd like to hear from you.

Being a maintainer is a responsibility, not an honorary title. We expect active, consistent involvement — triaging issues, reviewing PRs, and helping move the project forward.

Still interested? Email contributing@oriro.ai with:

- Links to your PRs on Oriro (if you don't have any, start there first)
...
For issues that don't fit a specific repo, or if you're unsure, email **security@oriro.ai** and we'll route it.
