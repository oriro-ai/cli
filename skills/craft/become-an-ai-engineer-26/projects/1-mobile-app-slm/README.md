...
**Proves:** Edge AI, resource constraints.

Offline-first mobile app using a small language model. Zero API costs, complete
privacy. See `SKILL.md` → _The 5 Portfolio Projects_.
