...
type AgentDefaultsModel = NonNullable<NonNullable<OriroConfig["agents"]>["defaults"]>["model"];
type AgentDefaultsModels = NonNullable<NonNullable<OriroConfig["agents"]>["defaults"]>["models"];
