// Oriro-owned tool runtime contract helpers mock agent tool runtimes in SDK tests.
...
export function installOriroOwnedToolHooks(params?: {
 ...
 * Pair with `installOriroOwnedToolHooks()` when a test asserts before/after hook behavior.
 */
...
export function resetOriroOwnedToolHooks(): void {
  resetGlobalHookRunner();
  resetPluginRuntimeStateForTest();
