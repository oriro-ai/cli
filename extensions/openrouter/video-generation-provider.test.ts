...
import { clearLiveCatalogCacheForTests } from "oriro/plugin-sdk/provider-catalog-shared";
import {
...
vi.mock("oriro/plugin-sdk/provider-http", async () => {
  const actual = await vi.importActual<typeof import("oriro/plugin-sdk/provider-http")>(
    "oriro/plugin-sdk/provider-http",
  );
  return {
    ...actual,
