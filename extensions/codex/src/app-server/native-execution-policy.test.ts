...
import type { getSessionEntry as getSessionEntryType } from "oriro/plugin-sdk/session-store-runtime";
...
vi.mock("oriro/plugin-sdk/session-store-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("oriro/plugin-sdk/session-store-runtime")>();
  return {
    ...actual,
