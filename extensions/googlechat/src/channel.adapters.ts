...
import { sanitizeForPlainText } from "oriro/plugin-sdk/channel-outbound";
import {
...
import type { OutboundMediaLoadOptions } from "oriro/plugin-sdk/outbound-media";
...
export const googlechatThreadingAdapter = {
  scopedAccountReplyToMode: {
    resolveAccount: (cfg: OriroConfig, accountId?: string | null) =>
