...
IMAGE_NAME="$(docker_e2e_resolve_image "oriro-commitments-safety-e2e" ORIRO_COMMITMENTS_SAFETY_E2E_IMAGE)"
CONTAINER_NAME="oriro-commitments-safety-e2e-$$"
RUN_LOG="$(mktemp -t oriro-commitments-safety-log.XXXXXX)"
