...
import type { MarkdownTableMode } from "oriro/plugin-sdk/config-contracts";
import { isDiagnosticFlagEnabled } from "oriro/plugin-sdk/diagnostic-runtime";
import { formatUncaughtError } from "oriro/plugin-sdk/error-runtime";
import { redactSensitiveText } from "oriro/plugin-sdk/logging-core";
import { parseStrictInteger } from "oriro/plugin-sdk/number-runtime";
import { resolveChunkMode, resolveTextChunkLimit } from "oriro/plugin-sdk/reply-chunking";
import { createTelegramRetryRunner, type RetryConfig } from "oriro/plugin-sdk/retry-runtime";
import { createSubsystemLogger, logVerbose } from "oriro/plugin-sdk/runtime-env";
...
function createTelegramHttpLogger(cfg: OriroConfig) {
