...
/**
 * @deprecated Compatibility facade for the `oriro/plugin-sdk/discord` subpath.
...
export type { OriroConfig } from "./config-types.js";
export type { OriroPluginApi, PluginRuntime } from "./channel-plugin-common.js";
...
/** Discord channel config shape for one account in Oriro config. */
export type DiscordAccountConfig = NonNullable<NonNullable<OriroConfig["channels"]>["discord"]>;
...
type DiscordApiFacadeModule = {
  ...
  inspectDiscordAccount: (params: { cfg: OriroConfig; accountId?: string | null }) => unknown;
  listDiscordAccountIds: (cfg: OriroConfig) => string[];
  ...
  resolveDefaultDiscordAccountId: (cfg: OriroConfig) => string;
...
function resolveCompatRuntimeConfig(params: { cfg?: OriroConfig }): OriroConfig {
...
/** List configured Discord account ids from Oriro config. */
export function listDiscordAccountIds(cfg: OriroConfig): string[] {
...
export function resolveDefaultDiscordAccountId(cfg: OriroConfig): string {
