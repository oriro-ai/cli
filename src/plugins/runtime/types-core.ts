...
type RuntimeConfigMutationContext = {
  snapshot: import("../../config/types.oriro.js").ConfigFileSnapshot;
...
type RuntimeMutateConfigFileParams<T = void> = {
  ...
  mutate: (
    draft: import("../../config/types.oriro.js").OriroConfig,
    context: RuntimeConfigMutationContext,
  ) => Promise<T | void> | T | void;
};
type RuntimeReplaceConfigFileParams = {
  nextConfig: import("../../config/types.oriro.js").OriroConfig;
  baseHash?: string;
  afterWrite: RuntimeConfigAfterWrite;
  writeOptions?: RuntimeWriteConfigOptions;
};
...
export type PluginRuntimeCore = {
  ...
  config: {
    ...
    current: () => DeepReadonly<import("../../config/types.oriro.js").OriroConfig>;
    /**
     ...
     */
    loadConfig: () => import("../../config/types.oriro.js").OriroConfig;
    /**
     ...
     */
    writeConfigFile: (
      cfg: import("../../config/types.oriro.js").OriroConfig,
  ...
  media: {
    ...
    detectMime: typeof import("@oriro/media-core/mime").detectMime;
    mediaKindFromMime: typeof import("@oriro/media-core/constants").mediaKindFromMime;
  ...
  modelAuth: {
    ...
    getApiKeyForModel: (params: {
      model: import("oriro/plugin-sdk/llm").Model<import("oriro/plugin-sdk/llm").Api>;
      cfg?: import("../../config/types.oriro.js").OriroConfig;
      workspaceDir?: string;
