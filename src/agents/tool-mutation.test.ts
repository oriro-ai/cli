...
describe("tool mutation helpers", () => {
  ...
  it.each([
    ...
    ["exec", "gh search prs --repo oriro-ai/cli tool-mutation --json number,title,state"],
    ["bash", "gh pr view 123 --repo oriro-ai/cli --json title,state"],
  ...
  it.each([
    ...
    ["exec", "gh api --method POST repos/oriro-ai/cli/issues"],
