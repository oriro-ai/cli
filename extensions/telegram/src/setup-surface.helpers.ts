...
export function shouldShowTelegramDmAccessWarning(cfg: OriroConfig, accountId: string): boolean {
...
export function buildTelegramDmAccessWarningLines(accountId: string): string[] {
  ...
  return [
    ...
    "  " + formatCliCommand(`oriro config set ${configBase}.dmPolicy "allowlist"`),
    "  " + formatCliCommand(`oriro config set ${configBase}.allowFrom '["YOUR_USER_ID"]'`),
