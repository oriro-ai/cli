...
export type OriroPluginActiveModelContext = {
  provider?: string;
  modelId?: string;
  modelRef?: string;
};
...
export type OriroPluginToolContext = {
  config?: OriroConfig;
   ...
   * the local operator, installed plugin code, or a modified Oriro runtime.
   */
  activeModel?: OriroPluginActiveModelContext;
  browser?: {
...
export type OriroPluginToolFactory = (
  ctx: OriroPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type OriroPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type OriroPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
