/**
 * Hook system for Oriro agent events
 *
 ...
 */
const INTERNAL_HOOK_HANDLERS_KEY = Symbol.for("oriro.internalHookHandlers");
...
const INTERNAL_HOOKS_ENABLED_KEY = Symbol.for("oriro.internalHooksEnabled");
