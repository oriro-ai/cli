...
const debugEmbeddings = isTruthyEnvValue(process.env.ORIRO_DEBUG_MEMORY_EMBEDDINGS);

/** Write embedding debug metadata when ORIRO_DEBUG_MEMORY_EMBEDDINGS is enabled. */
