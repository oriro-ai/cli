...
function usesClaudeCliModelSelection(cfg: OriroConfig): boolean {
...
function resolveClaudeCliCommand(cfg: OriroConfig): string {
...
function resolveClaudeCliAgentIds(cfg: OriroConfig): string[] {
