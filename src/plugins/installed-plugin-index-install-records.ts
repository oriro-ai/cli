...
function normalizeInstallRecord(
  ...
  setInstallStringField(normalized, "orirohubUrl", record.orirohubUrl);
  setInstallStringField(normalized, "orirohubPackage", record.orirohubPackage);
  setInstallStringField(normalized, "orirohubFamily", record.orirohubFamily);
  setInstallStringField(normalized, "orirohubChannel", record.orirohubChannel);
  ...
  setInstallStringField(normalized, "oriropackSha256", record.oriropackSha256);
  setInstallNumberField(normalized, "oriropackSpecVersion", record.oriropackSpecVersion);
  setInstallStringField(normalized, "oriropackManifestSha256", record.oriropackManifestSha256);
  setInstallNumberField(normalized, "oriropackSize", record.oriropackSize);
