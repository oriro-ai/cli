...
import { createSetupInputPresenceValidator } from "oriro/plugin-sdk/setup-runtime";
import {
...
export function resolveMattermostAccountWithSecrets(cfg: OriroConfig, accountId: string) {
