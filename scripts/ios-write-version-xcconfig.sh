...
- ORIRO_IOS_VERSION = exact canonical iOS version
- ORIRO_MARKETING_VERSION = short iOS/App Store version
- ORIRO_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
ORIRO_IOS_VERSION = ${IOS_VERSION}
ORIRO_MARKETING_VERSION = ${MARKETING_VERSION}
ORIRO_BUILD_VERSION = ${BUILD_NUMBER}
EOF
