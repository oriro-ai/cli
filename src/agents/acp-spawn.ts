...
} from "@oriro/acp-core/runtime/session-identifiers";
import type { AcpRuntimeSessionMode } from "@oriro/acp-core/runtime/types";
import {
...
function resolveHeartbeatConfigForAgent(params: {
  cfg: OriroConfig;
  agentId: string;
}): NonNullable<NonNullable<OriroConfig["agents"]>["defaults"]>["heartbeat"] {
...
function isExplicitlyAllowedAcpAgent(cfg: OriroConfig, agentId: string): boolean {
...
function resolveConfiguredAcpSubagentTargetIds(cfg: OriroConfig): string[] {
