...
import { resolvePreferredOriroTmpDir } from "oriro/plugin-sdk/security-runtime";
import { asRecord, readStringValue } from "oriro/plugin-sdk/string-coerce-runtime";
...
function resolveTempPathParts(opts: { ext: string; tmpDir?: string; id?: string }) {
  const tmpDir = opts.tmpDir ?? resolvePreferredOriroTmpDir();
  if (!opts.tmpDir) {
