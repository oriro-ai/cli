...
import { normalizeOriroVersionBase } from "../config/version.js";
...
import { loadOriroPlugins } from "./loader.js";
...
function resolveReportedPluginVersion(
  ...
  return (
    normalizeOriroVersionBase(resolveCompatibilityHostVersion(env)) ??
    normalizeOriroVersionBase(plugin.version) ??
    plugin.version
  );
}
