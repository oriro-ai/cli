...
describe("resolvePinnedClientMetadata", () => {
  ...
  it.each([
    ["oriro-ios", "iOS 26.5.0", "iOS 26.4.2", "iPhone"],
    ["oriro-ios", "iPadOS 26.5.0", "iPadOS 26.4.2", "iPad"],
    ["oriro-ios", "iPadOS 26.5.0", "iOS 26.4.2", "iPad"],
    ["oriro-android", "Android 16", "Android 15", "Android"],
  ])(
