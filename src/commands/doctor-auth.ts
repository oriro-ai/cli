...
function hasConfiguredCodexOAuthProfile(cfg: OriroConfig): boolean {
...
export function noteLegacyCodexProviderOverride(cfg: OriroConfig): void {
...
function listAuthProfileHealthTargets(cfg: OriroConfig): AuthProfileHealthTarget[] {
