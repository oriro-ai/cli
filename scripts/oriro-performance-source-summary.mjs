...
// Summarizes Oriro performance source fixtures for reports.
...
function printHelp() {
  console.log(`Usage: node scripts/oriro-performance-source-summary.mjs --source-dir <dir> [--baseline-source-dir <dir>] [--output <summary.md>]

Summarizes Oriro-native performance probe artifacts for CI reports.`);
}
