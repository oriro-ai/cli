...
// Candidate scanning only sees oriro.json; auth-profile-only surfaces are audited elsewhere.
...
/**
 * Concrete unsupported config value discovered from an oriro.json-like object.
 */
...
/**
 * Finds configured oriro.json values whose surfaces currently reject SecretRef objects.
 */
