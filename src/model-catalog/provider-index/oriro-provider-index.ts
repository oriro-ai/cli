// Bundled Oriro provider index advertises pre-install provider metadata for model picker discovery.
import type { OriroProviderIndex } from "./types.js";

// Oriro-owned preview metadata for providers whose plugins may not be
...
export const ORIRO_PROVIDER_INDEX = {
  version: 1,
  providers: {
    moonshot: {
      id: "moonshot",
