...
- Diagnostics and Repair: oriro doctor, oriro status, oriro logs, SecretRef, WSL/systemd unavailable hints, Operator repair guidance after WSL2 service
