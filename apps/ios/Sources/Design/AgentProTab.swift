...
struct AgentProTab: View {
    ...
    @State var oriroHubQuery: String = ""
    @State var oriroHubResults: [OriroHubSearchResultLite] = []
    @State var oriroHubLoading: Bool = false
    @State var oriroHubErrorText: String?
    @State var oriroHubInstallSlug: String?
