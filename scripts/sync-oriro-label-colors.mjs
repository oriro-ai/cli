...
const EXACT_COLORS = new Map(
  Object.entries({
    ...
    orirosweeper: COLORS.orirosweeperOrange,
    "orirosweeper:human-review": COLORS.saturatedRed,
    "orirosweeper:needs-security-review": COLORS.saturatedRed,
    "orirosweeper:needs-live-repro": COLORS.saturatedAmber,
    "orirosweeper:needs-maintainer-review": COLORS.saturatedAmber,
    "orirosweeper:needs-product-decision": COLORS.saturatedAmber,
    "orirosweeper:automerge": COLORS.saturatedGreen,
    "orirosweeper:queueable-fix": COLORS.saturatedGreen,
    "orirosweeper:fix-shape-clear": COLORS.mutedProofGreen,
    "orirosweeper:autofix": COLORS.paleBlue,
    "orirosweeper:commit-finding": COLORS.paleBlue,
    "orirosweeper:autogenerated": COLORS.mutedPurple,
    "orirosweeper:linked-pr-open": COLORS.mutedPurple,
    "orirosweeper:merge-ready": COLORS.mutedPurple,
    "orirosweeper:current-main-repro": COLORS.paleBlue,
    "orirosweeper:source-repro": COLORS.paleBlue,
    "orirosweeper:not-repro-on-main": COLORS.proofGreen,
    "orirosweeper:no-new-fix-pr": COLORS.neutralGray,
    "orirosweeper:needs-info": COLORS.appPurple,
...
function exactFamily(name) {
  ...
  if (name.startsWith("orirosweeper")) {
    return "orirosweeper";
  }
...
function fetchLabels() {
  ...
  for (;;) {
    const query = `query($cursor:String) {
      repository(owner:"oriro", name:"oriro") {
