---
summary: "Overview of Oriro onboarding options and flows"
read_when:
...
Oriro has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `oriro onboard`                     | Launch the app            |
...
CLI command docs: [`oriro onboard`](/cli/onboard)

## macOS app onboarding

Open the Oriro app. The first-run wizard walks you through the same steps
