...
export const toolPluginMetadataSymbol = Symbol.for("oriro.plugin-sdk.tool-plugin.metadata");

/** Runtime context supplied to a concrete tool plugin execution handler. */
export type ToolPluginExecutionContext = {
  /** Plugin runtime API for tool implementations that need Oriro services. */
  api: OriroPluginApi;
...
export type ToolPluginFactoryContext<TConfig> = {
  ...
  toolContext: OriroPluginToolContext;
};
