...
describe("resolveOutboundSessionRoute", () => {
  ...
  const perChannelPeerCfg = { session: { dmScope: "per-channel-peer" } } as OriroConfig;
  ...
  const perChannelPeerSessionCfg = { session: { dmScope: "per-channel-peer" } } as OriroConfig;
  ...
  it.each([
    ...
    },
    {
      ...
      expected: {
        sessionKey: "agent:main:oriro-weixin:direct:wxid_abc123@im.wechat",
        from: "oriro-weixin:wxid_abc123@im.wechat",
