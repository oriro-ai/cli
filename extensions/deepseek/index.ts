// Deepseek plugin entrypoint registers its Oriro integration.
import { readConfiguredProviderCatalogEntries } from "oriro/plugin-sdk/provider-catalog-shared";
...
import { fetchDeepSeekUsage } from "oriro/plugin-sdk/provider-usage";
