...
function findMutableAgentEntry(cfg: OriroConfig, agentId: string): AgentConfig | undefined {
...
export function resolveAgentModelPrimary(cfg: OriroConfig, agentId: string): string | undefined {
