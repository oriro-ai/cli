...
struct SettingsProTab: View {
    ...
    @AppStorage("location.enabledMode") var locationModeRaw: String = OriroLocationMode.off.rawValue
    ...
    @State var previousLocationModeRaw: String = OriroLocationMode.off.rawValue
    ...
    private func settingsModalPresentation(_ content: some View) -> some View {
        content
            ...
            .alert("Enable Oriro Hosted Push Relay?", isPresented: self.$showNotificationRelayDisclosure) {
                    Button("Continue") {
