...
public typealias OriroPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias OriroPlatformImage = UIImage
#endif

public struct OriroChatUsageCost: Codable, Hashable, Sendable {
...
public struct OriroChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: OriroChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(OriroChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct OriroChatMessageContent: Codable, Hashable, Sendable {
...
public struct OriroChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [OriroChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: OriroChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [OriroChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: OriroChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        let decodedUsage = try container.decodeIfPresent(OriroChatUsage.self, forKey: .usage)
        ...
        if let decoded = try? container.decode([OriroChatMessageContent].self, forKey: .content) {
...
public struct OriroChatHistoryPayload: Codable, Sendable {
...
public struct OriroSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct OriroSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [OriroSessionPreviewItem]
}

public struct OriroSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [OriroSessionPreviewEntry]

    public init(ts: Int, previews: [OriroSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct OriroChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct OriroChatCreateSessionResponse: Codable, Sendable {
    public let ok: Bool?
    public let key: String
    public let sessionId: String?
}

public struct OriroChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct OriroSessionMessageEventPayload: Codable, Sendable {
    public let sessionKey: String?
    public let agentId: String?
    public let message: OriroChatMessage?
...
public struct OriroAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct OriroChatPendingToolCall: Identifiable, Hashable, Sendable {
    public var id: String {
        self.toolCallId
    }
...
public struct OriroGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct OriroPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: OriroPlatformImage?
...
public struct OriroChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
