...
export function collectMissingDefaultAccountBindingWarnings(cfg: OriroConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: OriroConfig): string[] {
  const warnings: string[] = [];
