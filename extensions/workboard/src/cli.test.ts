...
vi.mock("oriro/plugin-sdk/gateway-runtime", async () => {
  const actual = await vi.importActual<typeof import("oriro/plugin-sdk/gateway-runtime")>(
    "oriro/plugin-sdk/gateway-runtime",
  );
  return {
    ...actual,
...
vi.mock("oriro/plugin-sdk/runtime-config-snapshot", () => ({
