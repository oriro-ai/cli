...
const SESSION_MCP_RUNTIME_MANAGER_KEY = Symbol.for("oriro.sessionMcpRuntimeManager");
...
function resolveSessionMcpRuntimeIdleTtlMs(cfg?: OriroConfig): number {
