// Github Copilot plugin entrypoint registers its Oriro integration.
...
import { getCachedLiveCatalogValue } from "oriro/plugin-sdk/provider-catalog-shared";
...
function applyCopilotDefaultModel(cfg: OriroConfig): OriroConfig {
...
export default definePluginEntry({
  ...
  register(api) {
    ...
    function resolveCurrentPluginConfig(config?: OriroConfig): GithubCopilotPluginConfig {
