...
import { resolveTimestampMsToIsoString } from "@oriro/normalization-core/number-coercion";
...
async function appendSessionTranscriptMessageLocked<TMessage>(
  ...
  const entry = {
    ...
    ...(leafInfo.appendMode === "side" && isTranscriptOnlyOriroAssistantMessage(finalMessage)
