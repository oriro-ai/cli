...
function listConfiguredChannelIds(cfg: OriroConfig): string[] {
...
function listConfiguredChannelAccountIds(cfg: OriroConfig, channelId: string): string[] {
  if (!hasRecord(cfg.channels)) {
    return [];
  }
...
export function collectChannelRouteTargets(cfg: OriroConfig): ChannelRouteTarget[] {
