...
>({
  ...
  resolveParams: (_cfg: OriroConfig, api) => ({
    providerId: "xai",
    api,
...
function pruneRetiredXaiBuiltinModels(cfg: OriroConfig): OriroConfig {
...
export function applyXaiProviderConfig(cfg: OriroConfig): OriroConfig {
...
export function applyXaiConfig(cfg: OriroConfig): OriroConfig {
