...
function resolveGoogleChatAccountImpl(params: { cfg: OriroConfig; accountId?: string | null }) {
...
vi.mock("./channel.deps.runtime.js", () => {
  return {
    ...
    listGoogleChatAccountIds: (cfg: OriroConfig) => {
...
function createGoogleChatCfg(): OriroConfig {
  return {
    channels: {
      googlechat: {
        enabled: true,
