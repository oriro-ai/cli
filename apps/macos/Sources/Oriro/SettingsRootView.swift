...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .oriroSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? OriroPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? OriroPaths.stateDirURL.path
...
private struct SettingsTabGroup: Identifiable {
    ...
    static func defaultGroups(showDebug: Bool) -> [SettingsTabGroup] {
        var groups = [
            ...
            SettingsTabGroup(title: "Oriro", tabs: [.about]),
        ]
...
extension Notification.Name {
    static let oriroSelectSettingsTab = Notification.Name("oriroSelectSettingsTab")
}
