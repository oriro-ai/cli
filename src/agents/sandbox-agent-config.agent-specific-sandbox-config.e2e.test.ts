...
async function resolveContext(config: OriroConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): OriroConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
