...
import { buildCopilotIdeHeaders, COPILOT_INTEGRATION_ID } from "oriro/plugin-sdk/provider-auth";
import { readProviderJsonArrayFieldResponse } from "oriro/plugin-sdk/provider-http";
...
export function resolveCopilotForwardCompatModel(
  ...
  // by simply adding them to agents.defaults.models in oriro.json — no
