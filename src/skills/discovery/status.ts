...
import {
  readOriroHubSkillsLockfileStatusSync,
  resolveOriroHubSkillStatusLinkSync,
  resolveLocalSkillCardStatusSync,
  type OriroHubSkillStatusLink,
  type OriroHubSkillsLockfileStatusRead,
  type LocalSkillCardStatus,
} from "../lifecycle/orirohub.js";
...
export type SkillStatusEntry = {
  ...
  orirohub?: OriroHubSkillStatusLink;
...
type BuildSkillStatusContext = {
  ...
  agentSkillFilter?: string[];
  workspaceDir: string;
  orirohubLockRead: OriroHubSkillsLockfileStatusRead;
};
  ...
  const orirohub =
    workspaceDir && !bundled
      ? resolveOriroHubSkillStatusLinkSync({
          ...
          skillKey,
          lockRead: context.orirohubLockRead,
        })
      : undefined;
...
export function buildWorkspaceSkillStatus(
  ...
  const orirohubLockRead = readOriroHubSkillsLockfileStatusSync(workspaceDir);
