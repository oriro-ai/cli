...
export const DEFAULT_SANDBOX_IMAGE = "oriro-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "oriro-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "oriro-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "oriro-sandbox-common:bookworm-slim";
...
export const DEFAULT_SANDBOX_BROWSER_PREFIX = "oriro-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "oriro-sandbox-browser";
