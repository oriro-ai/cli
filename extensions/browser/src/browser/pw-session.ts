...
// Oriro operations short-circuit instead of re-running the SSRF check on a
...
// Quarantine and close a tab that Oriro itself navigated to a blocked URL.
...
/** Quarantine and close a tab that Oriro navigated to a blocked URL. */
...
export async function createPageViaPlaywright(
  ...
  if (targetUrl !== "about:blank") {
    ...
    // Oriro owns this newly-created tab: if the post-navigation safety
