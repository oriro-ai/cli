/**
 * Runtime context resolver for Oriro plugin tools.
 *
...
/** Options provided by agent runtime callers when invoking Oriro plugin tools. */
...
export function resolveOriroPluginToolInputs(params: {
  options?: OriroPluginToolOptions;
