...
describe("buildInboundMetaSystemPrompt", () => {
  it("includes stable routing fields and omits chat ids", () => {
    ...
    expect(payload["schema"]).toBe("oriro.inbound_meta.v2");
...
describe("buildInboundUserContextPrefix", () => {
  ...
  it("does not treat group chats as direct based on sender id", () => {
    ...
    expect(conversationInfo["sender_id"]).toBe("oriro-control-ui");
  ...
  it("renders chat window structured context as compact transcript text", () => {
              ...
              messages: [
                {
                  ...
                  media_path: "/home/user/.oriro/media/inbound/sticker.webp",
    ...
    expect(text).not.toContain("/home/user/.oriro/media/inbound/sticker.webp");
  ...
  it("includes inbound history media metadata without leaking paths or URLs", () => {
      ...
      InboundHistory: [
        {
          ...
          media: [
            {
              path: "/tmp/oriro-secret-image.png",
    ...
    expect(text).not.toContain("/tmp/oriro-secret-image.png");
