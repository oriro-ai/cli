...
import { createDangerousNameMatchingMutableAllowlistWarningCollector } from "oriro/plugin-sdk/channel-policy";
...
function collectSlackNameKeyedChannelWarnings({ cfg }: { cfg: OriroConfig }): string[] {
