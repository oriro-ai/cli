...
function areWhatsAppAgentReactionsEnabled(params: { cfg: OriroConfig; accountId?: string }) {
...
function hasAnyWhatsAppAccountWithAgentReactionsEnabled(cfg: OriroConfig) {
