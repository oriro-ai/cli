...
const FACADE_LOADER_GLOBAL = "__oriroTestLoadBundledPluginPublicSurfaceModuleSync";
...
describe("plugin-sdk facade loader", () => {
  it("honors trusted bundled plugin dir overrides under the package root", () => {
    const pluginId = nextTrustedPluginId("oriro-facade-loader-override-");
    const overrideA = createBundledPluginFixture({
      pluginId,
      kind: "dist",
      prefix: "oriro-facade-loader-a-",
      marker: "override-a",
    });
    const overrideB = createBundledPluginFixture({
      pluginId,
      kind: "dist-runtime",
      prefix: "oriro-facade-loader-b-",
      marker: "override-b",
    });

    process.env.ORIRO_BUNDLED_PLUGINS_DIR = overrideA.bundledPluginsDir;
    ...
    process.env.ORIRO_BUNDLED_PLUGINS_DIR = overrideB.bundledPluginsDir;
  ...
  it("falls back to package source surfaces when an override dir lacks a bundled plugin", () => {
    const fixture = createPackageSourcePluginFixture({
      prefix: "oriro-facade-loader-source-fallback-",
      marker: "source-fallback",
    });
    process.env.ORIRO_BUNDLED_PLUGINS_DIR = createTempDirSync("oriro-facade-loader-empty-");
  ...
  it("shares loaded facade ids with facade-runtime", () => {
    const fixture = createBundledPluginFixture({
      prefix: "oriro-facade-loader-ids-",
      marker: "identity-check",
    });
    process.env.ORIRO_BUNDLED_PLUGINS_DIR = fixture.bundledPluginsDir;
  ...
  it("uses native require for Windows dist facade loads", () => {
    const fixture = createBundledPluginFixture({
      prefix: "oriro-facade-loader-windows-",
  ...
  it("breaks circular facade re-entry during module evaluation", () => {
    const fixture = createCircularPluginFixture("oriro-facade-loader-circular-");
    process.env.ORIRO_BUNDLED_PLUGINS_DIR = fixture.bundledPluginsDir;
  ...
  it("clears the cache on load failure so retries re-execute", () => {
    const fixture = createThrowingPluginFixture("oriro-facade-loader-throw-");
    process.env.ORIRO_BUNDLED_PLUGINS_DIR = fixture.bundledPluginsDir;
