// Agent config mutation and summary builders used by `oriro agents` commands.
import {
...
function resolveAgentModel(cfg: OriroConfig, agentId: string) {
...
export function buildAgentSummaries(cfg: OriroConfig): AgentSummary[] {
