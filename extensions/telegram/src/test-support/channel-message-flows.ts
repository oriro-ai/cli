...
import { formatChannelProgressDraftText } from "oriro/plugin-sdk/channel-outbound";
...
function createTelegramFlowApi(params: { accountId?: string; cfg: OriroConfig }): Bot["api"] {
  const api = {
    raw: {
