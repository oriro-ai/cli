---
name: oriro-score
description: Audit or refresh Oriro maturity scorecard docs from root taxonomy, maturity scores, and QA evidence artifacts without using maintainer discrawl data or committed inventory reports.
---

# oriro-score

Use this skill when working on the Oriro maturity scorecard in this repo.
This is the oriro-local version of the maintainer `oriro-score` workflow:
...
`qa-evidence.json` artifact shape generated by Oriro QA workflows.
...
2. Read the surface completeness rubric under
   `.agents/skills/oriro-score/references/completeness/`.
...
By default, Completeness measures how fully Oriro exposes the intended
...
tree to oriro. Evidence-enriched scorecard outputs belong in short-lived
