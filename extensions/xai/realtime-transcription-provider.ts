...
} from "oriro/plugin-sdk/realtime-transcription";
...
async function resolveXaiRealtimeApiKey(
  ...
  throw new Error(
    "xAI credentials missing for realtime STT. Sign in with `oriro onboard --auth-choice xai-oauth`, or run `oriro onboard --auth-choice xai-api-key`, or set XAI_API_KEY.",
  );
}
