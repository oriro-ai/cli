...
vi.mock("oriro/plugin-sdk/plugin-config-runtime", () => ({
...
vi.mock("oriro/plugin-sdk/channel-activity-runtime", () => ({
...
describe("LINE send helpers", () => {
  ...
  afterAll(() => {
    ...
    vi.doUnmock("oriro/plugin-sdk/plugin-config-runtime");
    vi.doUnmock("./accounts.js");
    vi.doUnmock("./channel-access-token.js");
    vi.doUnmock("oriro/plugin-sdk/channel-activity-runtime");
