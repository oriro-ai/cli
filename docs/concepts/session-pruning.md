...
Oriro also builds a separate idempotent replay view for sessions that
...
Oriro auto-enables pruning for Anthropic profiles:
...
If you set explicit values, Oriro does not override them.
