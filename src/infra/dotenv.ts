...
const BLOCKED_WORKSPACE_DOTENV_KEYS = new Set([
  ...
  "ORIRO_OAUTH_DIR",
  "ORIRO_PINNED_PYTHON",
  "ORIRO_PINNED_WRITE_PYTHON",
  "ORIRO_PLUGIN_INSTALL_OVERRIDES",
...
const BLOCKED_WORKSPACE_DOTENV_PREFIXES = [
  ...
  "ORIROHUB_",
  "OPENAI_API_KEY_",
  // Workspace .env is untrusted; reserve the full Oriro runtime namespace
  // for shell/global config so new ORIRO_* controls are fail-closed by default.
  "ORIRO_",
  "ORIRO_ORIROHUB_",
  "ORIRO_DISABLE_",
  "ORIRO_SKIP_",
...
export function loadDotEnv(opts?: { quiet?: boolean }) {
  ...
  // Then load global fallback: ~/.oriro/.env (or ORIRO_STATE_DIR/.env),
