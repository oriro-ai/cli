...
function hasConfiguredPluginEntries(config: OriroConfig): boolean {
...
function hasConfiguredChannelEntries(config: OriroConfig): boolean {
...
function hasConfiguredPluginIntegrationSecretProviders(config: OriroConfig): boolean {
...
function shouldLoadPluginMetadataForSecrets(config: OriroConfig): boolean {
  return (
