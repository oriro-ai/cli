...
export { mutateConfigFile, replaceConfigFile } from "oriro/plugin-sdk/config-mutation";
export {
  type BrowserConfig,
...
export { resolveGatewayPort } from "oriro/plugin-sdk/core";
export {
  CONFIG_DIR,
  escapeRegExp,
  resolveUserPath,
  shortenHomePath,
} from "oriro/plugin-sdk/text-utility-runtime";
