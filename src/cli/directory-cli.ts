    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["oriro directory self --channel slack", "Show the connected account identity."],
          [
            'oriro directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["oriro directory groups list --channel discord", "List available groups/channels."],
          [
            "oriro directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.oriro.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
