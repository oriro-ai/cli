// Codex tests cover oriro owned tool runtime contract plugin behavior.
import type { AnyAgentTool } from "oriro/plugin-sdk/agent-harness";
import { wrapToolWithBeforeToolCallHook } from "oriro/plugin-sdk/agent-harness-runtime";
import {
...
describe("Oriro-owned tool runtime contract — Codex app-server adapter", () => {
  afterEach(() => {
    resetOriroOwnedToolHooks();
  });
