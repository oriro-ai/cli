---
summary: "Testing utilities and patterns for Oriro plugins"
...
Reference for test utilities, patterns, and lint enforcement for Oriro
plugins.
...
These test-helper subpaths are repo-local source entrypoints for Oriro's own
...
**Plugin API mock import:** `oriro/plugin-sdk/plugin-test-api`

**Agent runtime contract import:** `oriro/plugin-sdk/agent-runtime-test-contracts`

**Channel contract import:** `oriro/plugin-sdk/channel-contract-testing`

**Channel test helper import:** `oriro/plugin-sdk/channel-test-helpers`

**Channel target test import:** `oriro/plugin-sdk/channel-target-testing`

**Plugin contract import:** `oriro/plugin-sdk/plugin-test-contracts`

**Plugin runtime test import:** `oriro/plugin-sdk/plugin-test-runtime`

**Provider contract import:** `oriro/plugin-sdk/provider-test-contracts`

**Provider HTTP mock import:** `oriro/plugin-sdk/provider-http-test-mocks`

**Environment/network test import:** `oriro/plugin-sdk/test-env`

**Generic fixture import:** `oriro/plugin-sdk/test-fixtures`

**Node builtin mock import:** `oriro/plugin-sdk/test-node-mocks`

Inside the Oriro repo, prefer the focused subpaths below for new bundled
plugin tests. The broad
`oriro/plugin-sdk/testing` barrel is legacy compatibility only.
...
} from "oriro/plugin-sdk/channel-feedback";
import { installCommonResolveTargetErrorCases } from "oriro/plugin-sdk/channel-target-testing";
import { AUTH_PROFILE_RUNTIME_CONTRACT } from "oriro/plugin-sdk/agent-runtime-test-contracts";
import { createTestPluginApi } from "oriro/plugin-sdk/plugin-test-api";
import { expectChannelInboundContextContract } from "oriro/plugin-sdk/channel-contract-testing";
import { createStartAccountContext } from "oriro/plugin-sdk/channel-test-helpers";
import { describePluginRegistrationContract } from "oriro/plugin-sdk/plugin-test-contracts";
import { registerSingleProviderPlugin } from "oriro/plugin-sdk/plugin-test-runtime";
import { describeOpenAIProviderRuntimeContract } from "oriro/plugin-sdk/provider-test-contracts";
import { getProviderHttpMocks } from "oriro/plugin-sdk/provider-http-test-mocks";
import { withEnv, withFetchPreconnect, withServer } from "oriro/plugin-sdk/test-env";
import {
  bundledPluginRoot,
  createCliRuntimeCapture,
  typedCases,
} from "oriro/plugin-sdk/test-fixtures";
import { mockNodeBuiltinModule } from "oriro/plugin-sdk/test-node-mocks";
```
...
suites that depend on bundled Oriro inventory stay under `src/plugins/contracts`.
...
import type { MockFn, PluginRuntime, RuntimeEnv } from "oriro/plugin-sdk/plugin-test-runtime";
```
...
Oriro's loader acceptance gates. Add at least one loader-backed smoke test
...
Prefer the shared plugin runtime mock from `oriro/plugin-sdk/channel-test-helpers`
...
1. **No monolithic root imports** -- `oriro/plugin-sdk` root barrel is rejected
...
Oriro uses Vitest with V8 coverage thresholds. For plugin tests:
