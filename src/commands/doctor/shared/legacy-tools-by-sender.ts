...
export function scanLegacyToolsBySenderKeys(cfg: OriroConfig): LegacyToolsBySenderKeyHit[] {
...
export function maybeRepairLegacyToolsBySenderKeys(cfg: OriroConfig): {
  config: OriroConfig;
  changes: string[];
} {
