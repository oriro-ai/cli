 ...
 * pairs directly into the provider payload, so Oriro must normalize here.
 */
 ...
 *
 * Oriro persists provider-specific reasoning metadata in `thinkingSignature`; if that metadata
