...
type ChannelConfigAccessorParams<Config extends OriroConfig = OriroConfig> = {
  cfg: Config;
  accountId?: string | null;
};
...
type MultiAccountChannelConfigAdapterParams<
  ...
  Config extends OriroConfig = OriroConfig,
> = {
  sectionKey: string;
...
export function adaptScopedAccountAccessor<Result, Config extends OriroConfig = OriroConfig>(
...
> {
  const base = {
    resolveAllowFrom({ cfg, accountId }: { cfg: OriroConfig; accountId?: string | null }) {
...
function setTopLevelChannelEnabledInConfigSection<Config extends OriroConfig>(params: {
  cfg: Config;
  sectionKey: string;
  enabled: boolean;
}): Config {
...
function removeTopLevelChannelConfigSection<Config extends OriroConfig>(params: {
  cfg: Config;
  sectionKey: string;
}): Config {
...
function clearTopLevelChannelConfigFields<Config extends OriroConfig>(params: {
  cfg: Config;
  sectionKey: string;
  clearBaseFields: string[];
}): Config {
