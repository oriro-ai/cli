...
export const en = {
  ...
  wizard: {
    ...
    gateway: {
      ...
      plaintextPasswordHint: "Stores the password directly in Oriro config",
    ...
    migration: {
      ...
      complete: "Migration complete. Run `oriro doctor` next.",
    ...
    plugins: {
      ...
      downloadFromOriroHub: "Download from OriroHub ({spec})",
    ...
    remote: {
      ...
      insecureRemoteUrl:
        "Use wss:// for remote hosts, or ws://127.0.0.1/localhost via SSH tunnel. Break-glass: ORIRO_ALLOW_INSECURE_PRIVATE_WS=1 for trusted private networks.",
      ...
      plaintextPasswordHint: "Stores the password directly in Oriro config",
      plaintextPasswordLabel: "Enter password now",
      plaintextTokenHint: "Stores the token directly in Oriro config",
    ...
    security: {
      ...
      beta: "Oriro is a hobby project and still in beta. Expect sharp edges.",
      confirm:
        "I understand this is personal-by-default and shared/multi-user use requires lock-down. Continue?",
      hardeningRequired:
        "If you're not comfortable with security hardening and access control, don't run Oriro.",
      learnMore: "Learn more",
      notMultitenant: "Oriro is not a hostile multi-tenant boundary by default.",
      personalAgent: "By default, Oriro is a personal agent: one trusted operator boundary.",
    ...
    skills: {
      ...
      docsLine: "Docs: https://docs.oriro.ai/skills",
      enterEnv: "Enter {env}",
    ...
    nextcloudTalk: {
      ...
      helpInstallCommand:
        '2) Run: ./occ talk:bot:install "Oriro" "<shared-secret>" "<webhook-url>" --feature webhook --feature response --feature reaction',
    ...
    whatsapp: {
      ...
      ownerNumberNote: "We need the sender/owner number so Oriro can allowlist you.",
      ...
      separatePhoneLabel: "Separate phone just for Oriro",
    ...
    irc: {
      ...
      nextStatusCommand: "Command: oriro channels status --probe",
    ...
    synologyChat: {
      ...
      incomingWebhookHelpReplies: "This is the URL Oriro uses to send replies back to Chat.",
    ...
    signal: {
      ...
      multipleEntries: "Multiple entries: comma-separated.",
      nextLinkDevice: 'Link device with: signal-cli link -n "Oriro"',
    ...
    twitch: {
      ...
      envPrompt: "Twitch env var ORIRO_TWITCH_ACCESS_TOKEN detected. Use env token?",
      ...
      helpEnvVars: "Env vars supported: ORIRO_TWITCH_ACCESS_TOKEN",
    ...
    channelsPrimer: {
      ...
      blurbs: {
        ...
        synologyChat: "Connect your Synology NAS Chat to Oriro with full agent capabilities.",
    ...
    search: {
      ...
      configured: "configured",
      configureLaterHint: "Configure later with oriro configure --section web",
      docsLine: "Docs: {url}",
    ...
    finalize: {
      ...
      controlUiDocs: "Docs: https://docs.oriro.ai/web/control-ui",
      dashboardCopyPaste: "Copy/paste this URL in a browser on this machine to control Oriro.",
      dashboardLinkWithToken: "Dashboard link (with token): {url}",
      dashboardOpened: "Opened in your browser. Keep that tab to control Oriro.",
      ...
      gatewayTokenStored:
        "Stored in: $ORIRO_CONFIG_PATH (default: ~/.oriro-ai/cli.json) under gateway.auth.token, or in ORIRO_GATEWAY_TOKEN.",
      ...
      outroDashboardLink: "Onboarding complete. Use the dashboard link above to control Oriro.",
      outroDashboardOpened:
        "Onboarding complete. Dashboard opened; keep that tab to control Oriro.",
      outroSeeded:
      ...
      restart: "Restart",
      securityReminder:
        "Running agents on your computer is risky — harden your setup: https://docs.oriro.ai/security",
      ...
      webDocs: "Docs: https://docs.oriro.ai/tools/web",
      ...
      whatNow: 'What now: https://oriro.ai/showcase ("What People Are Building").',
      whatNowTitle: "What now",
      workspaceBackupTitle: "Workspace backup",
      workspaceDocs: "Docs: https://docs.oriro.ai/concepts/agent-workspace",
