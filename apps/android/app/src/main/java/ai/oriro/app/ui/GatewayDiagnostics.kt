...
internal fun buildGatewayDiagnosticsReport(
  ...
  return """
    Help diagnose this Oriro Android gateway connection failure.
    ...
    - tell me whether `oriro devices list` should show a pending pairing request
    - if more signal is needed, ask for `oriro qr --json`, `oriro devices list`, and `oriro nodes status`
...
internal fun copyGatewayDiagnosticsReport(
  ...
  clipboard.setPrimaryClip(ClipData.newPlainText("Oriro gateway diagnostics", report))
