/** Resolves ACP request metadata into Oriro Gateway session keys and reset behavior. */
import { readBool, readString } from "@oriro/acp-core/meta";
import type { AcpServerOptions } from "@oriro/acp-core/types";
...
/** Parses ACP request metadata into Oriro session routing hints. */
