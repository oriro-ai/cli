...
Official Google Meet participant plugin for Oriro.
...
```bash
oriro plugins install @oriro/google-meet
```
...
- https://docs.oriro.ai/plugins/google-meet

## Package

- Plugin id: `google-meet`
- Tool: `google_meet`
- Package: `@oriro/google-meet`
- Minimum Oriro host: `2026.4.20`
