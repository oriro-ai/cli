      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["oriro gateway run", "Run the gateway in the foreground."],
            ["oriro gateway status", "Show service status plus connectivity/capability."],
            ["oriro gateway discover", "Find local and wide-area gateway beacons."],
            ["oriro gateway stability", "Show recent stability diagnostics."],
            ["oriro gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.oriro.ai/cli/gateway")}\n`,
      ),
  );
