...
/** Provider API families with first-class request/stream adapters in Oriro. */
...
/** Image-generation API families with first-class adapters in Oriro. */
...
/** Image provider ids with first-class adapters in Oriro. */
...
export interface Model<TApi extends Api = Api> {
  ...
  reasoning: boolean;
  /**
   * Maps Oriro thinking levels to provider/model-specific values.
