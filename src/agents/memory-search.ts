...
import type { OriroConfig, MemorySearchConfig } from "../config/config.js";
...
import { resolveOriroAgentSqlitePath } from "../state/oriro-agent-db.paths.js";
...
function mergeConfig(
  ...
  const store = {
    ...
    databasePath: resolveOriroAgentSqlitePath({ agentId, env: process.env }),
    fts,
    vector,
  };
  const chunking = {
