...
read_when:
  - Planning a broad Oriro application modernization pass
...
modernization task. If adopting this guidance as a repo-local Oriro skill,
create `.agents/skills/oriro-frontend/SKILL.md` first, keep the frontmatter
