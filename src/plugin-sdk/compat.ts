 ...
 * older broad plugin-sdk imports. Use focused oriro/plugin-sdk subpaths
 * instead.
 */
...
const shouldWarnCompatImport =
  ...
  process.env.ORIRO_SUPPRESS_PLUGIN_SDK_COMPAT_WARNING !== "1";

if (shouldWarnCompatImport) {
  process.emitWarning(
    "oriro/plugin-sdk/compat is deprecated for new plugins. Migrate to focused oriro/plugin-sdk/<subpath> imports. See https://docs.oriro.ai/plugins/sdk-migration",
    {
      code: "ORIRO_PLUGIN_SDK_COMPAT_DEPRECATED",
      detail:
        "Bundled plugins must use scoped plugin-sdk subpaths. External plugins may keep compat temporarily while migrating. Migration guide: https://docs.oriro.ai/plugins/sdk-migration",
    },
  );
}
...
export { resolvePreferredOriroTmpDir } from "./temp-path.js";
...
/** @deprecated Use `oriro/plugin-sdk/channel-outbound`. */
