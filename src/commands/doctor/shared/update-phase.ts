...
export const UPDATE_IN_PROGRESS_ENV = "ORIRO_UPDATE_IN_PROGRESS";
export const UPDATE_POST_CORE_CONVERGENCE_ENV = "ORIRO_UPDATE_POST_CORE_CONVERGENCE";
 ...
 * `ORIRO_UPDATE_IN_PROGRESS` directly (`commands/doctor-update.ts`,
 ...
 * `ORIRO_UPDATE_IN_PROGRESS`, so configured plugin repair must happen now.
 */
