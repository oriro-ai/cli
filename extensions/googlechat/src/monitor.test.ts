...
import { recordChannelBotPairLoopAndCheckSuppression } from "oriro/plugin-sdk/channel-inbound";
  ...
  it("creates typing messages by default", async () => {
    ...
    const core = {
      ...
      channel: {
        ...
        session: {
          resolveStorePath: () => "/tmp/oriro-googlechat-test",
