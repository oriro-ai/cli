...
function loadPluginHostHookSessionEntry(params: { cfg: OriroConfig; sessionKey: string }): {
  storePath: string;
  entry?: SessionEntry;
  canonicalKey: string;
  storeKey: string;
...
function isPluginPromptInjectionEnabled(cfg: OriroConfig, pluginId: string): boolean {
