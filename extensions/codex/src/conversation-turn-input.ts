...
import type { PluginHookInboundClaimEvent } from "oriro/plugin-sdk/plugin-entry";
import { normalizeSingleOrTrimmedStringList } from "oriro/plugin-sdk/string-coerce-runtime";
...
function extractInboundMedia(event: PluginHookInboundClaimEvent): InboundMedia[] {
  ...
  // Oriro channels expose either local staged files or remote URLs. Keep
