...
type AcpSessionsTable = OriroStateKyselyDatabase["acp_sessions"];
type AcpSessionMetaDatabase = Pick<OriroStateKyselyDatabase, "acp_sessions">;
...
}): { cfg: OriroConfig; storePath: string } {
...
function selectAcpSessionRows(options: OriroStateDatabaseOptions = {}): AcpSessionRow[] {
