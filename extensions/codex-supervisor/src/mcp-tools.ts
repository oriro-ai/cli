...
export const RAW_TRANSCRIPTS_ENV = "ORIRO_CODEX_SUPERVISOR_ALLOW_RAW_TRANSCRIPTS";
/** Env gate for mutating/steering Codex sessions through standalone MCP. */
export const WRITE_CONTROLS_ENV = "ORIRO_CODEX_SUPERVISOR_ALLOW_WRITE_CONTROLS";
