...
import type { OriroConfig, ReplyToMode } from "oriro/plugin-sdk/config-contracts";
import { createConnectedChannelStatusPatch } from "oriro/plugin-sdk/gateway-runtime";
import {
...
import { isVerbose, logVerbose, shouldLogVerbose, warn } from "oriro/plugin-sdk/runtime-env";
import { createSubsystemLogger } from "oriro/plugin-sdk/runtime-env";
import { createNonExitingRuntime, type RuntimeEnv } from "oriro/plugin-sdk/runtime-env";
import {
...
export async function monitorDiscordProvider(opts: MonitorDiscordOpts = {}) {
  ...
  try {
    ...
    const guildHistories = new Map<
      string,
      import("oriro/plugin-sdk/reply-history").HistoryEntry[]
    >();
