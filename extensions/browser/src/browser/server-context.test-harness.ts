...
/** Mocks a launched Oriro Chrome process with the supplied pid. */
export function mockLaunchedChrome(
  launchOriroChrome: { mockResolvedValue: (value: RunningChrome) => unknown },
  pid: number,
) {
  const proc = new EventEmitter() as unknown as ChildProcessWithoutNullStreams;
  launchOriroChrome.mockResolvedValue({
    pid,
