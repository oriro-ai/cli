...
const (
	...
	envDocsI18nProvider      = "ORIRO_DOCS_I18N_PROVIDER"
	envDocsI18nModel         = "ORIRO_DOCS_I18N_MODEL"
...
func validateNoTranslationTranscriptArtifacts(source, translated string) error {
	...
	for _, token := range []string{"<oriro_docs_i18n_input>", "</oriro_docs_i18n_input>"} {
