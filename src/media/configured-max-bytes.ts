...
export function resolveConfiguredMediaMaxBytes(cfg?: OriroConfig): number | undefined {
...
export function resolveGeneratedMediaMaxBytes(cfg: OriroConfig | undefined, kind: MediaKind) {
