...
def generate_cta_slide(data):
    ...
    <section class="slide slide--gradient flex flex-col items-center justify-center text-center">
        ...
        <div class="slide-footer" style="border-color: rgba(255,255,255,0.2); color: rgba(255,255,255,0.6);">
            <span>{data.get('contact', '<email>')}</span>
...
def main():
    ...
    if args.demo:
        ...
        demo_slides = [
            ...
            {
                'type': 'testimonial',
                'quote': 'ORIRO.ai replaced 3 tools and 2 contractors. Our content output tripled while costs dropped 60%.',
                'author': 'Sarah Chen',
        ...
        html = generate_deck(demo_slides, "ORIRO.ai - Pitch Deck")
