...
import type { AcpSessionUpdateTag } from "@oriro/acp-core/runtime/types";
...
function resolveAcpStreamCoalesceIdleMs(cfg: OriroConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: OriroConfig): number {
...
export function resolveAcpProjectionSettings(cfg: OriroConfig): AcpProjectionSettings {
