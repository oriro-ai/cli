...
enum OriroConfigFile {
    private static let logger = Logger(subsystem: "ai.oriro", category: "config")
    ...
    static func url() -> URL {
        OriroPaths.configURL
    }

    static func stateDirURL() -> URL {
        OriroPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        OriroPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-oriro-config-file",
            "event": "config.write",
