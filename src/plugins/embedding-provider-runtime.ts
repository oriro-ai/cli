...
export function listEmbeddingProviders(cfg?: OriroConfig): EmbeddingProviderAdapter[] {
...
function resolveEmbeddingProviderLookupIds(id: string, cfg?: OriroConfig): string[] {
