...
Oriro treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.oriro/settings/voicewake.json`

Shape:

```json
{ "triggers": ["oriro", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
