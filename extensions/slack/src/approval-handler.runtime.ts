...
import { buildApprovalPresentationFromActionDescriptors } from "oriro/plugin-sdk/approval-reply-runtime";
import type { OriroConfig } from "oriro/plugin-sdk/config-contracts";
import { logError } from "oriro/plugin-sdk/logging-core";
...
type SlackExecApprovalConfig = NonNullable<
  NonNullable<NonNullable<OriroConfig["channels"]>["slack"]>["execApprovals"]
>;
