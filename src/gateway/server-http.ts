        ...
        wss.handleUpgrade(req, socket, head, (ws) => {
          (
            ws as unknown as import("ws").WebSocket & {
              __oriroPreauthBudgetClaimed?: boolean;
              __oriroPreauthBudgetKey?: string;
            }
          )["__oriroPreauthBudgetKey"] = preauthBudgetKey;
