...
const PHONE_CONTROL_STATE_PREFIX = "oriro-phone-control-test-";
...
function createApi(params: {
  ...
  openKeyedStore?: OriroPluginApi["runtime"]["state"]["openKeyedStore"];
}): OriroPluginApi {
...
}): OriroPluginApi["runtime"]["state"]["openKeyedStore"] {
  return <T>() => {
...
describe("phone-control plugin", () => {
  ...
  it("does not block service startup on the initial expiry check", async () => {
    ...
    try {
      ...
      let service: OriroPluginService | undefined;
