...
function resolveFetchConfig(config: OriroConfig): Record<string, unknown> | undefined {
...
function resolveSearchConfig(config: OriroConfig): Record<string, unknown> | undefined {
...
function getCapabilityWebSearchAutoDetectTargets(config: OriroConfig): CommandSecretTargetScope {
...
function getCapabilityWebFetchAutoDetectTargets(config: OriroConfig): CommandSecretTargetScope {
  return getCapabilityWebProviderAutoDetectTargets({
    config,
...
function isScopedChannelSecretTargetEntry(params: {
  ...
  return (
    ...
    params.entry.configFile === "oriro.json" &&
...
type CapabilityWebCommandSecretTargetParams = {
  ...
  autoDetectTargets: (config: OriroConfig) => CommandSecretTargetScope;
  selectedProviderTargetIds: (
    config: OriroConfig,
    providerId?: string | null,
  ) => SelectedProviderTargetIds;
