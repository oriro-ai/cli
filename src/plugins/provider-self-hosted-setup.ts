...
export function applyProviderDefaultModel(cfg: OriroConfig, modelRef: string): OriroConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  contextWindow?: number;
  maxTokens?: number;
}): { config: OriroConfig; modelId: string; modelRef: string; profileId: string } {
