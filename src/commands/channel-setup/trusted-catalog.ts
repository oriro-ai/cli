...
function resolveEffectiveTrustConfig(cfg: OriroConfig, env?: NodeJS.ProcessEnv): OriroConfig {
...
function resolveTrustedCatalogExtraPaths(cfg: OriroConfig): string[] | undefined {
