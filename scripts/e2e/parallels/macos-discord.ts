// Macos Discord script supports Oriro repository automation.
...
${this.input.guestNode} ${this.input.guestOriroEntry} config set channels.discord.token ${shellQuote(this.input.config.token)}
${this.input.guestNode} ${this.input.guestOriroEntry} config set channels.discord.enabled true
${this.input.guestNode} ${this.input.guestOriroEntry} config set channels.discord.groupPolicy allowlist
${this.input.guestNode} ${this.input.guestOriroEntry} config set channels.discord.guilds ${shellQuote(guilds)} --strict-json
${this.input.guestNode} ${this.input.guestOriroEntry} doctor --fix --yes --non-interactive
...
JS
${this.input.guestNode} ${this.input.guestOriroEntry} plugins enable discord
${this.input.guestNode} ${this.input.guestOriroEntry} gateway restart
${this.input.guestNode} ${this.input.guestOriroEntry} channels status --probe --json`);
  }
