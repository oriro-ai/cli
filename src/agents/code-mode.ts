...
function readCodeModeRawConfig(config?: OriroConfig, agentId?: string): Record<string, unknown> {
...
export function resolveCodeModeConfig(config?: OriroConfig, agentId?: string): CodeModeConfig {
