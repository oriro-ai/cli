...
function createCfg(): OriroConfig {
  return {
    channels: {
      discord: {
        enabled: true,
...
function resolveAccount(cfg: OriroConfig, accountId = "default"): ResolvedDiscordAccount {
  return discordPlugin.config.resolveAccount(cfg, accountId);
}

function startDiscordAccount(cfg: OriroConfig, accountId = "default") {
