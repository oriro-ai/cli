...
import type { DiscordAccountConfig } from "oriro/plugin-sdk/config-contracts";
import { createNodeProxyAgent } from "oriro/plugin-sdk/fetch-runtime";
import {
  captureWsEvent,
  resolveEffectiveDebugProxyUrl,
  resolveDebugProxySettings,
} from "oriro/plugin-sdk/proxy-capture";
import { danger, warn } from "oriro/plugin-sdk/runtime-env";
...
type ResolveDiscordGatewayIntentsParams = {
  intentsConfig?: import("oriro/plugin-sdk/config-contracts").DiscordIntentsConfig;
...
function createGatewayPlugin(params: {
  ...
  class OriroGatewayPlugin extends discordGateway.GatewayPlugin {
...
export function createDiscordGatewayPlugin(params: {
  ...
  return createGatewayPlugin({
    options: {
      ...
      intents,
      // Oriro registers its own async interaction listener.
