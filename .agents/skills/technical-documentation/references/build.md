...
- For Oriro docs work, choose a page type from `references/oriro.md` before drafting.
- Keep task-critical Oriro configuration inline; link exhaustive defaults, enums, schemas, generated references, and rare debugging workflows.
...
- For Oriro docs work, apply the validation checklist in `references/oriro.md`.
