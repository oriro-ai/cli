...
function resolveDiagnosticSessionStorePaths(config?: OriroConfig): string[] | undefined {
  if (!config) {
    return undefined;
  }
  try {
...
function shouldWriteCriticalMemoryPressureBundle(config?: OriroConfig): boolean {
...
export function isStuckSessionRecoveryEnabled(config?: OriroConfig): boolean {
...
export function resolveStuckSessionWarnMs(config?: OriroConfig): number {
