...
import {
  ...
  sessionPathForFile,
} from "oriro/plugin-sdk/memory-core-host-engine-qmd";
import type { MemorySearchResult } from "oriro/plugin-sdk/memory-core-host-runtime-files";
import {
...
type Logger = Pick<OriroPluginApi["logger"], "info" | "warn" | "error">;
...
const LIGHT_SLEEP_EVENT_TEXT = "__oriro_memory_core_light_sleep__";
const REM_SLEEP_EVENT_TEXT = "__oriro_memory_core_rem_sleep__";
...
const MANAGED_DAILY_DREAMING_BLOCKS = [
  {
    heading: "## Light Sleep",
    startMarker: "<!-- oriro:dreaming:light:start -->",
    endMarker: "<!-- oriro:dreaming:light:end -->",
  },
  {
    heading: "## REM Sleep",
    startMarker: "<!-- oriro:dreaming:rem:start -->",
    endMarker: "<!-- oriro:dreaming:rem:end -->",
  },
] as const;
