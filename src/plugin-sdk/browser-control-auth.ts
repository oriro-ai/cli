// Browser control auth helpers resolve plugin browser credentials from Oriro config.
...
type BrowserControlAuthSurface = {
  resolveBrowserControlAuth: (cfg?: OriroConfig, env?: NodeJS.ProcessEnv) => BrowserControlAuth;
