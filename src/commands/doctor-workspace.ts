...
function buildMergedLegacyRootMemorySection(params: {
  ...
  return [
    ...
    "",
    `<!-- oriro-root-memory-merge source=${LEGACY_ROOT_MEMORY_FILENAME} archived=${params.archivedLegacyPath} -->`,
...
export async function noteWorkspaceMemoryHealth(cfg: OriroConfig): Promise<void> {
  try {
