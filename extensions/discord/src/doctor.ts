...
import { collectProviderDangerousNameMatchingScopes } from "oriro/plugin-sdk/runtime-doctor";
...
export function scanDiscordNumericIdEntries(cfg: OriroConfig): DiscordNumericIdHit[] {
...
export function maybeRepairDiscordNumericIds(
  cfg: OriroConfig,
  doctorFixCommand: string,
): { config: OriroConfig; changes: string[]; warnings?: string[] } {
...
function collectDiscordMutableAllowlistWarnings(cfg: OriroConfig): string[] {
