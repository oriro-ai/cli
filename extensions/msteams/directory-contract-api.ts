...
import type { ChannelDirectoryAdapter } from "oriro/plugin-sdk/channel-contract";
import { listDirectoryEntriesFromSources } from "oriro/plugin-sdk/directory-runtime";
