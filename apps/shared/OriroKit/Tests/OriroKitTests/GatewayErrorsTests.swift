...
@Suite struct GatewayErrorsTests {
    ...
    @Test func connectAuthErrorPreservesStructuredMetadata() {
        let error = GatewayConnectAuthError(
            ...
            actionCommand: "oriro devices approve req-123",
            docsURLString: "https://docs.oriro.ai/gateway/pairing",
        ...
        #expect(error.actionCommand == "oriro devices approve req-123")
        #expect(error.docsURLString == "https://docs.oriro.ai/gateway/pairing")
    ...
    @Test func pairingProblemUsesStructuredRequestMetadata() {
        ...
        #expect(problem?.actionCommand == "oriro devices approve req-123")
    }
