...
Nostr DM channel plugin for Oriro using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Oriro. It enables your bot to:
...
# Configure oriro to use local relay
