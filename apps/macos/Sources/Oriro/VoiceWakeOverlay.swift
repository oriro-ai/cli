...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.oriro", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Oriro windows, but below the system’s pop-up menus.
