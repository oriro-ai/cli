...
import { normalizeOptionalString as readString } from "@oriro/normalization-core/string-coerce";
...
const HEARTBEAT_RESPONSE_CHANNEL_DATA_KEY = "oriroHeartbeatResponse";
