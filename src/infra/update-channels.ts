// Resolves Oriro update channels from config, tags, and versions.
...
/**
 * Env var carrying the *effective* update channel into `oriro update finalize`
 ...
 * channel split (`ORIRO_UPDATE_POST_CORE_CHANNEL` vs `…_REQUESTED_CHANNEL`).
 */
export const UPDATE_EFFECTIVE_CHANNEL_ENV = "ORIRO_UPDATE_EFFECTIVE_CHANNEL";
...
/** Maps an Oriro update channel to the npm dist-tag used for package lookups. */
