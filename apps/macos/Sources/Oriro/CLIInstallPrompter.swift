...
final class CLIInstallPrompter {
    ...
    private let logger = Logger(subsystem: "ai.oriro", category: "cli.prompt")
    ...
    func checkAndPromptIfNeeded(reason: String) {
        ...
        let alert = NSAlert()
        alert.messageText = "Install Oriro CLI?"
    ...
    private func openSettings(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .oriroSelectSettingsTab, object: tab)
        }
    }
