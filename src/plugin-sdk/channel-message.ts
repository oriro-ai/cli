/**
 * @deprecated Use `oriro/plugin-sdk/channel-outbound` for outbound/message
 * lifecycle helpers and `oriro/plugin-sdk/channel-inbound` for inbound
...
/** @deprecated Use `hasFinalInboundReplyDispatch(...)` from `oriro/plugin-sdk/channel-inbound`. */
export { hasFinalChannelTurnDispatch } from "../channels/turn/dispatch-result.js";
/** @deprecated Use `hasVisibleInboundReplyDispatch(...)` from `oriro/plugin-sdk/channel-inbound`. */
export { hasVisibleChannelTurnDispatch } from "../channels/turn/dispatch-result.js";
/** @deprecated Use `resolveInboundReplyDispatchCounts(...)` from `oriro/plugin-sdk/channel-inbound`. */
export { resolveChannelTurnDispatchCounts } from "../channels/turn/dispatch-result.js";

/** @deprecated Use `createChannelMessageReplyPipeline(...)` from `oriro/plugin-sdk/channel-outbound`. */
...
/** @deprecated Use `buildInboundReplyDispatchBase(...)` from `oriro/plugin-sdk/channel-inbound`. */
export { buildChannelMessageReplyDispatchBase } from "./inbound-reply-dispatch.js";
/** @deprecated Use `dispatchChannelInboundReply(...)` or `runPreparedInboundReply(...)` from `oriro/plugin-sdk/channel-inbound`. */
...
/** @deprecated Use `deliverInboundReplyWithMessageSendContext(...)` from `oriro/plugin-sdk/channel-outbound`. */
