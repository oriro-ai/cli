...
function authFingerprint(agentDir: string): object {
  return {
    authProfilesSqlite: fileFingerprint(path.join(agentDir, "oriro-agent.sqlite")),
    authProfilesSqliteWal: fileFingerprint(path.join(agentDir, "oriro-agent.sqlite-wal")),
  };
}
