...
import { classifyMemoryMultimodalPath } from "oriro/plugin-sdk/memory-core-host-engine-embeddings";
import {
...
const TEST_MEMORY_WATCH_FACTORY_KEY = Symbol.for("oriro.test.memoryWatchFactory");
const TEST_MEMORY_NATIVE_WATCH_FACTORY_KEY = Symbol.for("oriro.test.memoryNativeWatchFactory");
...
export abstract class MemoryManagerSyncOps {
  protected abstract readonly cfg: OriroConfig;
