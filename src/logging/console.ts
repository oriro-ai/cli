...
type ConsoleConfigLoader = () => OriroConfig["logging"] | undefined;
...
function normalizeConsoleLevel(level?: string): LogLevel {
  ...
  if (!level && process.env.VITEST === "true" && process.env.ORIRO_TEST_CONSOLE !== "1") {
    return "silent";
  }
...
function resolveConsoleSettings(): ConsoleSettings {
  ...
  if (
    ...
    process.env.ORIRO_TEST_CONSOLE !== "1" &&
    !isVerbose() &&
    !envLevel &&
  ...
  let cfg: OriroConfig["logging"] | undefined =
