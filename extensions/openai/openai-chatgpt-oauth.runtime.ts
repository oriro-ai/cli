...
import type { ProviderAuthContext } from "oriro/plugin-sdk/plugin-entry";
import { ensureGlobalUndiciEnvProxyDispatcher } from "oriro/plugin-sdk/runtime-env";
import { formatCliCommand } from "oriro/plugin-sdk/setup-tools";
...
const openAICodexOAuthOriginator = "oriro";
const localManualFallbackDelayMs = 15_000;
const localManualFallbackGraceMs = 1_000;
const openAIAuthProbeUrl =
  "https://auth.openai.com/oauth/authorize?response_type=code&client_id=oriro-preflight&redirect_uri=http%3A%2F%2Flocalhost%3A1455%2Fauth%2Fcallback&scope=openid+profile+email";
...
export async function loginOpenAICodexOAuth(params: {
  ...
  try {
    ...
    await prompter.note("Trouble with OAuth? See https://docs.oriro.ai/start/faq", "OAuth help");
