...
- Keep product names in English: Oriro, Raspberry Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the Oriro Gateway, use “Gateway 网关”.
