...
function makeTargetsCfg(targets: Array<{ channel: string; to: string }>): OriroConfig {
  return {
    approvals: {
      exec: {
        enabled: true,
...
function makeSessionCfg(options: { discordExecApprovalsEnabled?: boolean } = {}): OriroConfig {
  return {
