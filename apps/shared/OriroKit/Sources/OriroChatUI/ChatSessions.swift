...
public struct OriroChatThinkingLevelOption: Codable, Identifiable, Sendable, Hashable {
...
public struct OriroChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct OriroChatSessionsDefaults: Codable, Sendable {
    public let modelProvider: String?
    public let model: String?
    public let contextTokens: Int?
    public let thinkingLevels: [OriroChatThinkingLevelOption]?
    ...
    public init(
        ...
        model: String?,
        contextTokens: Int?,
        thinkingLevels: [OriroChatThinkingLevelOption]? = nil,
...
public struct OriroChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
    public var id: String {
        self.key
    }
...
public struct OriroChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: OriroChatSessionsDefaults?
    public let sessions: [OriroChatSessionEntry]
    ...
    public init(
        ...
        sessions: [OriroChatSessionEntry])
    {
        self.ts = ts
        self.path = path
        self.count = count
