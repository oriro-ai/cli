...
import { type FileLockOptions, withFileLock } from "oriro/plugin-sdk/file-lock";
import {
...
/** Durable sidecar binding connecting an Oriro session file to a Codex thread. */
