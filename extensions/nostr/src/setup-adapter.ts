...
import type { ChannelSetupAdapter } from "oriro/plugin-sdk/channel-setup";
import type { OriroConfig } from "oriro/plugin-sdk/config-contracts";
import { DEFAULT_ACCOUNT_ID } from "oriro/plugin-sdk/routing";
import { patchTopLevelChannelConfigSection, splitSetupEntries } from "oriro/plugin-sdk/setup";
...
export function createNostrSetupAdapter(params: {
  resolveAccountId: (cfg: OriroConfig, accountId?: string | null) => string;
