// Matrix plugin entrypoint registers its Oriro integration.
...
import { waitUntilAbort } from "oriro/plugin-sdk/channel-outbound";
import { registerChannelRuntimeContext } from "oriro/plugin-sdk/channel-runtime-context";
import { resolveOptionalIntegerOption } from "oriro/plugin-sdk/number-runtime";
import {
...
export type MonitorMatrixOpts = {
  ...
  setStatus?: (next: import("oriro/plugin-sdk/channel-contract").ChannelAccountSnapshot) => void;
};
