---
name: oriro-refactor-docs
description: Refactor an existing Oriro docs page with source-audited preservation, restructuring, and verification.
---
...
Use this skill when the user gives a target Oriro docs page and asks to
rewrite, refactor, reorganize, split, shorten, or improve it.

This skill builds on `oriro-docs`: use that skill for style, page types,
...
Read `../oriro-docs/SKILL.md` first. Apply its page-type, style,
...
Before editing, decide the intended page type from `oriro-docs`.
