...
import { isTruthyEnvValue, isWSL2Sync } from "oriro/plugin-sdk/runtime-env";
import { normalizeOptionalLowercaseString } from "oriro/plugin-sdk/string-coerce-runtime";

export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "ORIRO_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "ORIRO_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "ORIRO_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable ORIRO_TELEGRAM_DNS_RESULT_ORDER
