...
vi.mock("oriro/plugin-sdk/memory-core-host-engine-embeddings", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("oriro/plugin-sdk/memory-core-host-engine-embeddings")>();
  return {
    ...actual,
