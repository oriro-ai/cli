...
import { hasConfiguredSecretInput } from "oriro/plugin-sdk/secret-input-runtime";
...
export function resolveMatrixChannelConfig(cfg: OriroConfig): Record<string, unknown> | null {
