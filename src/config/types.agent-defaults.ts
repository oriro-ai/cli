...
export type AgentDefaultsConfig = {
  ...
  /** Embedded Oriro runner hardening and compatibility controls. */
  embeddedAgent?: {
    /**
     * How embedded Oriro should trust workspace-local `.oriro/settings.json`.
    ...
    /**
     * Embedded Oriro execution contract:
...
export type AgentCompactionConfig = {
  ...
  /** Embedded Oriro reserve tokens target before floor enforcement. */
  reserveTokens?: number;
  /** Embedded Oriro keepRecentTokens budget used for cut-point selection. */
  keepRecentTokens?: number;
  /** Minimum reserve tokens enforced for embedded Oriro compaction (0 disables the floor). */
