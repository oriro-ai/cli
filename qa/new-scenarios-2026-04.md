...
- Code: `.agents/skills/oriro-qa-testing/SKILL.md`, `docs/gateway/protocol.md`
...
- Flow:
  - Install a OriroHub or gateway-managed skill.
...
- Code: `src/agents/oriro-tools.image-generation.test.ts`, `src/image-generation/runtime.ts`
