...
vi.mock("oriro/plugin-sdk/channel-inbound", () => ({
  buildMentionRegexes: () => [],
  matchesMentionPatterns: () => false,
}));
vi.mock("oriro/plugin-sdk/channel-pairing", () => ({
...
vi.mock("oriro/plugin-sdk/command-auth-native", () => ({
...
vi.mock("oriro/plugin-sdk/runtime-group-policy", () => ({
...
vi.mock("oriro/plugin-sdk/reply-history", () => ({
...
vi.mock("oriro/plugin-sdk/routing", () => ({
...
describe("handleLineWebhookEvents", () => {
  ...
  afterAll(() => {
    vi.doUnmock("oriro/plugin-sdk/channel-inbound");
    vi.doUnmock("oriro/plugin-sdk/channel-pairing");
    vi.doUnmock("oriro/plugin-sdk/command-auth-native");
    vi.doUnmock("oriro/plugin-sdk/runtime-group-policy");
    vi.doUnmock("oriro/plugin-sdk/runtime-env");
    vi.doUnmock("oriro/plugin-sdk/reply-history");
    vi.doUnmock("oriro/plugin-sdk/routing");
    vi.doUnmock("oriro/plugin-sdk/conversation-runtime");
