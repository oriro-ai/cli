...
import { resolveAgentIdentity } from "oriro/plugin-sdk/agent-runtime";
...
type WhatsAppAckReactionConfig = NonNullable<
  NonNullable<NonNullable<OriroConfig["channels"]>["whatsapp"]>["ackReaction"]
>;
...
function resolveAgentIdentityEmoji(cfg: OriroConfig, agentId: string): string | undefined {
