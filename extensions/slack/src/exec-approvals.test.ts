...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<OriroConfig["channels"]>["slack"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<OriroConfig["channels"]>["slack"]>>,
): OriroConfig {
  return {
    channels: {
      slack: {
