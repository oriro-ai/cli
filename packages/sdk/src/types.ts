...
/** Minimal transport interface consumed by the Oriro SDK client. */
export type OriroTransport = {
  request<T = unknown>(
    method: string,
    params?: unknown,
...
export type ConnectableOriroTransport = OriroTransport & {
...
export type RuntimeSelection =
  | "auto"
  | { type: "embedded"; id: "oriro" | "codex" | (string & {}) }
...
export type OriroEvent<TData = unknown> = {
  version: 1;
  id: string;
  ts: number;
  type: OriroEventType;
