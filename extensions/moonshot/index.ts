// Moonshot plugin entrypoint registers its Oriro integration.
import { defineSingleProviderPluginEntry } from "oriro/plugin-sdk/provider-entry";
import { buildOpenAICompatibleReplayPolicy } from "oriro/plugin-sdk/provider-model-shared";
import { MOONSHOT_THINKING_STREAM_HOOKS } from "oriro/plugin-sdk/provider-stream-family";
