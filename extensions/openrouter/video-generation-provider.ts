...
import { isRecord, normalizeOptionalString } from "oriro/plugin-sdk/string-coerce-runtime";
import type {
  GeneratedVideoAsset,
  VideoGenerationProvider,
  VideoGenerationRequest,
  VideoGenerationSourceAsset,
} from "oriro/plugin-sdk/video-generation";
...
const SUPPORTED_DURATIONS_HINT = Symbol.for("oriro.videoGeneration.supportedDurations");
