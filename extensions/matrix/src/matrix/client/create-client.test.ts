...
describe("createMatrixClient", () => {
  const storagePaths = {
    rootDir: "/tmp/oriro-matrix-create-client-test",
    storagePath: "/tmp/oriro-matrix-create-client-test/storage.json",
    recoveryKeyPath: "/tmp/oriro-matrix-create-client-test/recovery.key",
    idbSnapshotPath: "/tmp/oriro-matrix-create-client-test/idb.snapshot",
    accountKey: "default",
  ...
  it("persists storage metadata by default", async () => {
    ...
    expect(MatrixClientMock).toHaveBeenCalledWith("https://matrix.example.org", "tok", {
      ...
      cryptoDatabasePrefix: "oriro-matrix-default-token-hash",
