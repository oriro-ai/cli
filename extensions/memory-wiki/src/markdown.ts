...
export const WIKI_RELATED_START_MARKER = "<!-- oriro:wiki:related:start -->";
export const WIKI_RELATED_END_MARKER = "<!-- oriro:wiki:related:end -->";
export const WIKI_RAW_SOURCE_MARKER = "<!-- oriro:wiki:raw-source -->";
...
const HUMAN_START_MARKER = "<!-- oriro:human:start -->";
const HUMAN_END_MARKER = "<!-- oriro:human:end -->";
