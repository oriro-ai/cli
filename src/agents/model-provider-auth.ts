...
const configFingerprintCache = new WeakMap<OriroConfig, string>();
...
function resolveProviderAuthConfigFingerprint(cfg: OriroConfig | undefined): string | null {
  if (!cfg) {
    return null;
  }
...
function collectProviderAuthWarmRuntimeAuthLookups(cfg: OriroConfig): {
