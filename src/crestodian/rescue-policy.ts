...
function resolveAgentEntry(cfg: OriroConfig, agentId?: string) {
  if (!agentId) {
    return undefined;
  }
...
function resolveScopedExecConfig(cfg: OriroConfig, agentId?: string) {
...
function isYoloHostPosture(cfg: OriroConfig, agentId?: string): boolean {
