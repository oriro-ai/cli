...
import { updateAuthProfileStoreWithLock } from "oriro/plugin-sdk/provider-auth";
import {
...
async function buildOpenCodeSecretCandidates(
  ...
  // Oriro's Copilot token profile cannot preserve OpenCode enterprise routing yet.
