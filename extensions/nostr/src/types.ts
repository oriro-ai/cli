...
import { normalizeSecretInputString, type SecretInput } from "oriro/plugin-sdk/secret-input";
...
function resolveConfiguredDefaultNostrAccountId(cfg: OriroConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: OriroConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: OriroConfig): string {
