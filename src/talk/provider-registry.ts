...
function resolveRealtimeVoiceProviderEntries(cfg?: OriroConfig): RealtimeVoiceProviderPlugin[] {
 ...
 */
export function listRealtimeVoiceProviders(cfg?: OriroConfig): RealtimeVoiceProviderPlugin[] {
