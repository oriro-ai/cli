...
import type { ChannelSetupAdapter, OriroConfig } from "oriro/plugin-sdk/setup";
import { createSetupInputPresenceValidator } from "oriro/plugin-sdk/setup";
...
export function isLineConfigured(cfg: OriroConfig, accountId: string): boolean {
