...
function hasExplicitDefaultPrimaryModel(cfg?: OriroConfig): boolean {
...
function pickMaxBytes(cfg?: OriroConfig, maxBytesMb?: number): number | undefined {
...
async function runImagePrompt(params: {
  ...
  const providerCfg: OriroConfig = effectiveCfg ?? {};
