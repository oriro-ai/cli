---
summary: "Oriro Anthropic Vertex provider plugin for Claude models on Google Vertex AI."
read_when:
...
Oriro Anthropic Vertex provider plugin for Claude models on Google Vertex AI.

## Distribution

- Package: `@oriro/anthropic-vertex-provider`
