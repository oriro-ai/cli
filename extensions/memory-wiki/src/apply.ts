...
import { readFiniteNumberParam } from "oriro/plugin-sdk/param-readers";
...
const GENERATED_START = "<!-- oriro:wiki:generated:start -->";
const GENERATED_END = "<!-- oriro:wiki:generated:end -->";
const HUMAN_START = "<!-- oriro:human:start -->";
const HUMAN_END = "<!-- oriro:human:end -->";
