...
import { optionalFiniteNumberSchema, stringEnum } from "oriro/plugin-sdk/channel-actions";
...
import type { AnyAgentTool, OriroPluginApi, OriroPluginToolContext } from "../api.js";
...
function buildArtifactContext(
  context: OriroPluginToolContext | undefined,
