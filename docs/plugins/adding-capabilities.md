---
summary: "Contributor guide for adding a new shared capability to the Oriro plugin system"
read_when:
...
<Info>
  This is a **contributor guide** for Oriro core developers. If you are
...
Use this when Oriro needs a new shared domain such as embeddings, image
