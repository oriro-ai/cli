...
function collectExecSafeBinScopes(cfg: OriroConfig): ExecSafeBinScopeRef[] {
...
export function scanExecSafeBinCoverage(cfg: OriroConfig): ExecSafeBinCoverageHit[] {
...
export function maybeRepairExecSafeBinProfiles(cfg: OriroConfig): {
  config: OriroConfig;
  changes: string[];
  warnings: string[];
} {
