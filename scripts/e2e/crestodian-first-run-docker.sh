...
IMAGE_NAME="$(docker_e2e_resolve_image "oriro-crestodian-first-run-e2e" ORIRO_CRESTODIAN_FIRST_RUN_E2E_IMAGE)"
CONTAINER_NAME="oriro-crestodian-first-run-e2e-$$"
RUN_LOG="$(mktemp -t oriro-crestodian-first-run-log.XXXXXX)"
...
ORIRO_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 crestodian-first-run empty)"
