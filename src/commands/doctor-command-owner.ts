...
function resolveConfiguredCommandOwners(cfg: OriroConfig): string[] {
...
export function hasConfiguredCommandOwners(cfg: OriroConfig): boolean {
...
export function noteCommandOwnerHealth(cfg: OriroConfig): void {
  ...
  note(
    [
      ...
      `Fix: set commands.ownerAllowFrom to your channel user id, for example ${formatCliCommand("oriro config set commands.ownerAllowFrom '[\"telegram:123456789\"]'")}`,
