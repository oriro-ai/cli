...
import { buildPluginConfigSchema } from "oriro/plugin-sdk/plugin-entry";
import { z } from "zod";
import type { OriroPluginConfigSchema } from "../api.js";
import {
...
export const diffsPluginConfigSchema: OriroPluginConfigSchema = {
