...
const EXPORT_TRAJECTORY_DOCS_URL = "https://docs.oriro.ai/tools/trajectory";
...
function buildTrajectoryExportExecRequest(
  ...
  return {
    argv: buildCurrentOriroCliArgv(args),
    command: buildCurrentOriroCliCommand(args),
    displayCommand: ["oriro", ...args].join(" "),
    encodedRequest,
    request,
  };
}
