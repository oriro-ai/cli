...
describe("status-all format", () => {
  ...
  it("formats dashboard values consistently", () => {
    expect(formatStatusDashboardValue("https://oriro.local")).toBe("https://oriro.local");
  ...
  it("builds overview rows with shared ordering", () => {
    expect(
      buildStatusOverviewRows({
        ...
        dashboardValue: "https://oriro.local",
        ...
        middleRows: [{ Item: "Security", Value: "Run: oriro security audit --deep" }],
      ...
      { Item: "Dashboard", Value: "https://oriro.local" },
      ...
      { Item: "Security", Value: "Run: oriro security audit --deep" },
