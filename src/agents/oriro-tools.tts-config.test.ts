// Verifies createOriroTools wires shared config and context into the TTS tool.
import { beforeEach, describe, expect, it, vi } from "vitest";
import type { OriroConfig } from "../config/types.oriro.js";
import { testing, createOriroTools } from "./oriro-tools.js";
...
const mocks = vi.hoisted(() => {
  ...
  return {
    ...
    textToSpeech: vi.fn(async () => ({
      success: true,
      audioPath: "/tmp/oriro/tts-config-test.opus",
      provider: "microsoft",
...
vi.mock("./oriro-plugin-tools.js", () => ({
  resolveOriroPluginToolsForOptions: () => [],
}));

vi.mock("./oriro-tools.nodes-workspace-guard.js", () => ({
...
describe("createOriroTools TTS config wiring", () => {
  beforeEach(() => {
...
describe("createOriroTools media generation session wiring", () => {
  beforeEach(() => {
    mocks.createImageGenerateToolOptions.mockClear();
    mocks.createMusicGenerateToolOptions.mockClear();
    mocks.createVideoGenerateToolOptions.mockClear();
...
describe("createOriroTools session status route context wiring", () => {
  beforeEach(() => {
...
describe("createOriroTools cron context wiring", () => {
  beforeEach(() => {
    mocks.createCronToolOptions.mockClear();
  });
