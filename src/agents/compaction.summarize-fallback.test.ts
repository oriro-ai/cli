...
import type { UserMessage } from "oriro/plugin-sdk/llm";
...
vi.mock("oriro/plugin-sdk/agent-sessions", async () => {
  const actual = await vi.importActual<typeof import("oriro/plugin-sdk/agent-sessions")>(
    "oriro/plugin-sdk/agent-sessions",
  );
  return {
    ...actual,
