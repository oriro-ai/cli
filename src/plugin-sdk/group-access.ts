...
/** @deprecated Use `resolveChannelMessageIngress` from `oriro/plugin-sdk/channel-ingress-runtime`. */
...
/** @deprecated Use route descriptors with `resolveChannelMessageIngress` from `oriro/plugin-sdk/channel-ingress-runtime`. */
...
/** @deprecated Use `resolveOpenProviderRuntimeGroupPolicy` plus `resolveChannelMessageIngress` from `oriro/plugin-sdk/channel-ingress-runtime`. */
