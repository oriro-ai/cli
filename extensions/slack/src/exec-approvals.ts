...
import { doesApprovalRequestMatchChannelAccount } from "oriro/plugin-sdk/approval-native-runtime";
import type { OriroConfig } from "oriro/plugin-sdk/config-contracts";
import { normalizeStringifiedOptionalString } from "oriro/plugin-sdk/string-coerce-runtime";
...
function resolveSlackOwnerApprovers(cfg: OriroConfig): string[] {
