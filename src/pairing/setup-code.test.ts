...
describe("pairing setup code", () => {
  ...
  beforeEach(() => {
    ...
    process.env.ORIRO_GATEWAY_PORT = "";
  });
  ...
  it.each([
    ...
    {
      name: "uses ORIRO_GATEWAY_PASSWORD without resolving configured password SecretRef",
      auth: {
        mode: "password",
