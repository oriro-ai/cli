 ...
 */
export function applyChutesProviderConfig(cfg: OriroConfig): OriroConfig {
 ...
 */
export function applyChutesConfig(cfg: OriroConfig): OriroConfig {
...
export function applyChutesApiKeyConfig(cfg: OriroConfig): OriroConfig {
