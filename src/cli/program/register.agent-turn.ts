...
/** Register `oriro agent` for one Gateway-backed agent turn. */
...
${formatHelpExamples([
  ['oriro agent --to +15555550123 --message "status update"', "Start a new session."],
  ['oriro agent --agent ops --message "Summarize logs"', "Use a specific agent."],
  [
  ...
  ['oriro agent --to +15555550123 --message "Summon reply" --deliver', "Deliver reply."],
  [
...
${theme.muted("Docs:")} ${formatDocsLink("/cli/agent", "docs.oriro.ai/cli/agent")}`,
    )
