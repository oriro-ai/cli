...
import { normalizeOptionalAccountId } from "oriro/plugin-sdk/account-id";
import {
  DEFAULT_ACCOUNT_ID,
  ...
  type OriroConfig,
} from "oriro/plugin-sdk/account-resolution";
...
function getChannelConfig(cfg: OriroConfig): SmsChannelConfig | undefined {
...
export function listSmsAccountIds(cfg: OriroConfig): string[] {
...
export function resolveDefaultSmsAccountId(cfg: OriroConfig): string {
  const channelCfg = getChannelConfig(cfg);
...
export function inspectSmsAccount(cfg: OriroConfig, accountId?: string | null) {
