...
import { normalizeOptionalString as resolveOptionalStringParam } from "@oriro/normalization-core/string-coerce";
import {
  ErrorCodes,
  errorShape,
...
function resolveAgentIdOrError(agentIdRaw: string, cfg: OriroConfig) {
