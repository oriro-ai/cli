...
function hasExplicitMemorySearchConfig(cfg: OriroConfig, agentId: string): boolean {
...
export function resolveMemoryPluginStatus(cfg: OriroConfig): MemoryPluginStatus {
