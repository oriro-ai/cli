...
describe("defineChannelMessageAdapter", () => {
  const loadPluginSdkSubpaths = async () =>
    await Promise.all([
      import("oriro/plugin-sdk/channel-outbound"),
      import("oriro/plugin-sdk/channel-message"),
      import("oriro/plugin-sdk/channel-message-runtime"),
      import("oriro/plugin-sdk/channel-reply-pipeline"),
      import("oriro/plugin-sdk/compat"),
    ] as const);
