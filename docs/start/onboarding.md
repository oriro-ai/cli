---
summary: "First-run setup flow for Oriro (macOS app)"
read_when:
...
- By default, Oriro is a personal agent: one trusted operator boundary.
...
<Frame caption="Choose what permissions do you want to give Oriro">
...
<Step title="CLI">
  ...
  The app can install the global `oriro` CLI via npm, pnpm, or bun.
