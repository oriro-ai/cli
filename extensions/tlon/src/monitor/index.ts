// Tlon plugin entrypoint registers its Oriro integration.
import type { ReplyPayload } from "oriro/plugin-sdk/reply-runtime";
import type { RuntimeEnv } from "oriro/plugin-sdk/runtime";
import { asFiniteNumber } from "oriro/plugin-sdk/string-coerce-runtime";
...
export async function monitorTlonProvider(opts: MonitorTlonOpts = {}): Promise<void> {
  ...
  const cfg = core.config.current() as OriroConfig;
