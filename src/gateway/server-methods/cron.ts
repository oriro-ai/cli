...
function listConfiguredAnnounceChannelIds(cfg: OriroConfig): string[] {
...
function assertValidCronAnnounceDelivery(params: { cfg: OriroConfig; delivery?: CronDelivery }) {
...
function assertValidCronCreateDelivery(cfg: OriroConfig, jobCreate: CronJobCreate) {
