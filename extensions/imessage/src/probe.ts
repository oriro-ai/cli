...
import type { BaseProbeResult } from "oriro/plugin-sdk/channel-contract";
import {
  asDateTimestampMs,
  resolveExpiresAtMsFromDurationMs,
} from "oriro/plugin-sdk/number-runtime";
import { runCommandWithTimeout } from "oriro/plugin-sdk/process-runtime";
...
import { detectBinary } from "oriro/plugin-sdk/setup";
import {
...
// subcommand (added by oriro/imsg#114, which lets a single bridge call
...
export async function probeIMessagePrivateApi(
  ...
  try {
    ...
    // oriro/imsg#114. We do this even when the bridge is unavailable
