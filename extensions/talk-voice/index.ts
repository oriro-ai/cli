// Talk Voice plugin entrypoint registers its Oriro integration.
...
import type { SpeechVoiceOption } from "oriro/plugin-sdk/speech";
import {
  normalizeLowercaseStringOrEmpty,
  normalizeOptionalLowercaseString,
} from "oriro/plugin-sdk/string-coerce-runtime";
import { resolveActiveTalkProviderConfig } from "oriro/plugin-sdk/talk-config-runtime";
  ...
  register(api: OriroPluginApi) {
    api.registerCommand({
      ...
      handler: async (ctx) => {
        ...
        const cfg = api.runtime.config.current() as OriroConfig;
