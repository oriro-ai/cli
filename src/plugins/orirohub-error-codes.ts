/** Stable OriroHub install error codes used by plugin install policy and diagnostics. */
export const ORIROHUB_INSTALL_ERROR_CODE = {
...
/** Union of stable OriroHub install error code values. */
export type OriroHubInstallErrorCode =
  (typeof ORIROHUB_INSTALL_ERROR_CODE)[keyof typeof ORIROHUB_INSTALL_ERROR_CODE];
