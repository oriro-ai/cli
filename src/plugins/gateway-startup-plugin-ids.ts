...
import { buildModelCatalogMergeKey } from "@oriro/model-catalog-core/model-catalog-refs";
import {
...
function normalizePluginsConfigForInstalledIndex(
  config: OriroConfig["plugins"] | undefined,
...
function listPotentialEnabledChannelIds(config: OriroConfig, env: NodeJS.ProcessEnv): string[] {
...
function resolveGatewayStartupDreamingEngineId(config: OriroConfig): string | undefined {
...
function resolveGatewayStartupDreamingSelectedPluginId(config: OriroConfig): string | undefined {
...
function collectConfiguredWebSearchProviderIds(config: OriroConfig): ReadonlySet<string> {
...
function collectConfiguredVoiceProviderIds(config: OriroConfig): ConfiguredVoiceProviderIds {
...
function isMemorySlotExplicitlyDisabled(config: OriroConfig): boolean {
...
function collectValidationHeartbeatTargetChannelIds(config: OriroConfig): string[] {
...
function collectValidationChannelConfigIds(config: OriroConfig): string[] {
...
function collectConfiguredProviderIds(config: OriroConfig): string[] {
...
function collectValidationConfiguredProviderIds(config: OriroConfig): string[] {
...
function collectValidationConfiguredShorthandModelIds(config: OriroConfig): string[] {
  return sortUniquePluginIds(
