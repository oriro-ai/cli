...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.oriro", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".oriro/disable-launchagent"
...
extension GatewayLaunchAgentManager {
        ...
        quiet: Bool) async -> CommandResult
    {
        ...
        #endif
        let command = CommandResolver.oriroCommand(
            subcommand: "gateway",
