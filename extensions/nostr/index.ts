// Nostr plugin entrypoint registers its Oriro integration.
import {
  defineBundledChannelEntry,
  loadBundledEntryExportSync,
} from "oriro/plugin-sdk/channel-entry-contract";
import type { OriroConfig, PluginRuntime, ResolvedNostrAccount } from "./api.js";
  ...
  registerFull(api) {
    const httpHandler = createNostrProfileHttpHandler()({
      getConfigProfile: (accountId: string) => {
        ...
        const cfg = runtime.config.current() as OriroConfig;
