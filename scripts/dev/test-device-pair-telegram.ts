// Test Device Pair Telegram script supports Oriro repository automation.
...
import { loadOriroPlugins } from "../../src/plugins/loader.js";
...
type DevicePairTelegramDeps = {
  ...
  loadOriroPlugins: typeof loadOriroPlugins;
...
async function runDevicePairTelegram(
  ...
  deps.loadOriroPlugins({ config: cfg });
