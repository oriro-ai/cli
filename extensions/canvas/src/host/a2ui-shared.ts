 ...
 */
import { lowercasePreservingWhitespace } from "oriro/plugin-sdk/string-coerce-runtime";

/** Hosted path prefix for bundled A2UI assets. */
export const A2UI_PATH = "/__oriro__/a2ui";

/** Hosted path prefix for Canvas document/static assets. */
export const CANVAS_HOST_PATH = "/__oriro__/canvas";

/** Hosted WebSocket path for Canvas live reload. */
export const CANVAS_WS_PATH = "/__oriro__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.oriroCanvasA2UIAction.postMessage(...)
  // - Android: window.oriroCanvasA2UIAction.postMessage(...)
  const handlerNames = ["oriroCanvasA2UIAction"];
  ...
  globalThis.Oriro = globalThis.Oriro ?? {};
  globalThis.Oriro.postMessage = postToNode;
  globalThis.Oriro.sendUserAction = sendUserAction;
  globalThis.oriroPostMessage = postToNode;
  globalThis.oriroSendUserAction = sendUserAction;
