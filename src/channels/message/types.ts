...
export type ChannelMessageSendTextContext<TConfig = OriroConfig> = {
  cfg: TConfig;
  to: string;
  text: string;
...
export type ChannelMessageSendMediaContext<TConfig = OriroConfig> =
...
export type ChannelMessageSendPayloadContext<TConfig = OriroConfig> =
  ChannelMessageSendTextContext<TConfig> & {
...
export type ChannelMessageSendPollContext<TConfig = OriroConfig> = Omit<
  ChannelMessageSendTextContext<TConfig>,
  "text" | "threadId"
> & {
  poll: PollInput;
...
export type ChannelMessageSendAttemptContext<TConfig = OriroConfig> =
...
export type ChannelMessageSendFailureContext<TConfig = OriroConfig> =
  ChannelMessageSendAttemptContext<TConfig> & {
    error: unknown;
    attemptToken?: unknown;
  };
...
export type ChannelMessageUnknownSendContext<TConfig = OriroConfig> = {
  cfg: TConfig;
  queueId: string;
  channel: string;
  to: string;
