// Workshop config helpers resolve skill workshop settings from Oriro config.
...
export function resolveSkillWorkshopConfig(config?: OriroConfig): SkillWorkshopConfig {
