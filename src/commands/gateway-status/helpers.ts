...
import type { OriroConfig, ConfigFileSnapshot } from "../../config/types.js";
...
export function resolveTargets(cfg: OriroConfig, explicitUrl?: string): GatewayStatusTarget[] {
...
/** Extracts the config fields displayed by `oriro gateway status --deep`. */
...
export function buildNetworkHints(cfg: OriroConfig) {
