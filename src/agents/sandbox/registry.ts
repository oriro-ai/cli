...
type SandboxRegistryTable = OriroStateKyselyDatabase["sandbox_registry_entries"];
type SandboxRegistryDatabase = Pick<OriroStateKyselyDatabase, "sandbox_registry_entries">;
