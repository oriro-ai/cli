/** Tests bundle manifest parsing for Codex, Claude, Cursor, and Oriro formats. */
...
function makeTempDir() {
  return makeTrackedTempDir("oriro-bundle-manifest", tempDirs);
}
...
describe("bundle manifest parsing", () => {
  it("does not treat oriro.bundle.json as a bundle manifest", () => {
    const rootDir = makeTempDir();
    writeBundleManifest(rootDir, "oriro.bundle.json", {
      name: "Not Real",
      skills: ["skills"],
    });
