...
```bash
/Users/oriro/Projects/agent-scripts/skills/autoreview/scripts/autoreview --mode commit --commit HEAD
```
...
```bash
/Users/oriro/Projects/agent-scripts/skills/autoreview/scripts/autoreview --help
```
