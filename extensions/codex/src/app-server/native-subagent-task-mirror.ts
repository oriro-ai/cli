/**
 * Mirrors Codex native subagent thread lifecycle events into Oriro task
 * runtime rows so parent sessions can observe child progress.
 */
import type { AgentHarnessTaskRuntime } from "oriro/plugin-sdk/agent-harness-task-runtime";
...
/** Converts a Codex child thread id into the Oriro task-runtime run id. */
