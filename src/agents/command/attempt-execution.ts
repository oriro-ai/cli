 ...
 */
import type { AcpRuntimeEvent } from "@oriro/acp-core/runtime/types";
...
export function runAgentAttempt(params: {
  ...
  const requestedAgentHarnessId = isRawModelRun ? "oriro" : undefined;
  ...
  const agentHarnessPolicy = isRawModelRun
    ? ({ runtime: "oriro", runtimeSource: "model" } as const)
  ...
  const embeddedAgentHarnessOverride =
    ...
    (agentHarnessPolicy.runtime === "oriro" && agentHarnessPolicy.runtimeSource !== "implicit"
      ? "oriro"
      : undefined);
