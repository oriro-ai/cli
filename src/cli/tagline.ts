...
const DEFAULT_TAGLINE = "All your chats, one Oriro.";
...
const HOLIDAY_TAGLINES = {
  ...
  christmas:
    "Christmas: Ho ho ho—Santa's little oriro-sistant is here to ship joy, roll back chaos, and stash the keys safely.",
...
const TAGLINES: string[] = [
  "Your terminal just grew oriros—type something and let the bot pinch the busywork.",
  ...
  "Automation with oriros: minimal fuss, maximal pinch.",
  ...
  "Oriros out, commit in—let's ship something mildly responsible.",
  "I'll butter your workflow like a oriro roll: messy, delicious, effective.",
  "Shell yeah—I'm here to pinch the toil and leave you the glory.",
  "If it's repetitive, I'll automate it; if it's hard, I'll bring jokes and a rollback plan.",
  "The only crab in your contacts you actually want to hear from. ORIRO",
  ...
  "Built by oriros, for humans. Don't question the hierarchy.",
  ...
  "You had me at 'oriro gateway start.'",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.ORIRO_TAGLINE_INDEX;
