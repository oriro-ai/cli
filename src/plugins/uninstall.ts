...
import { relinkOriroPeerDependenciesInManagedNpmRoot } from "./plugin-peer-link.js";
...
export function removePluginFromConfig(
  ...
  pluginId: string,
  opts?: { channelIds?: string[] },
): { config: OriroConfig; actions: Omit<UninstallActions, "directory"> } {
  ...
  const config: OriroConfig = {
    ...
    channels: channels as OriroConfig["channels"],
  };
