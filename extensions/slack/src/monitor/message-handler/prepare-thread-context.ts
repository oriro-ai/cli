...
import { formatInboundEnvelope } from "oriro/plugin-sdk/channel-inbound";
import { runTasksWithConcurrency } from "oriro/plugin-sdk/concurrency-runtime";
import type { ContextVisibilityMode } from "oriro/plugin-sdk/config-contracts";
import { logVerbose } from "oriro/plugin-sdk/runtime-env";
import {
  filterSupplementalContextItems,
  shouldIncludeSupplementalContext,
} from "oriro/plugin-sdk/security-runtime";
...
export async function resolveSlackThreadContextData(params: {
  ...
  envelopeOptions: ReturnType<
    typeof import("oriro/plugin-sdk/channel-inbound").resolveEnvelopeFormatOptions
  >;
