...
import { normalizeText } from "@oriro/acp-core/normalize-text";
...
export { normalizeText } from "@oriro/acp-core/normalize-text";
...
export type ConfiguredAcpBindingSpec = {
  ...
  /** Owning Oriro agent id (used for session identity/storage). */
  agentId: string;
