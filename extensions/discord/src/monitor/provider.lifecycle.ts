...
} from "oriro/plugin-sdk/gateway-runtime";
import { asDateTimestampMs, parseStrictPositiveInteger } from "oriro/plugin-sdk/number-runtime";
...
const DISCORD_GATEWAY_READY_TIMEOUT_ENV = "ORIRO_DISCORD_READY_TIMEOUT_MS";
const DISCORD_GATEWAY_RUNTIME_READY_TIMEOUT_ENV = "ORIRO_DISCORD_RUNTIME_READY_TIMEOUT_MS";
