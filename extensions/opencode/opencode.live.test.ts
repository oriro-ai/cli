...
import { extractNonEmptyAssistantText, isLiveTestEnabled } from "oriro/plugin-sdk/test-env";
...
const LIVE_MODEL_ID =
  process.env.ORIRO_LIVE_OPENCODE_DEEPSEEK_MODEL?.trim() || "deepseek-v4-flash-free";
