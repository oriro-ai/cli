...
IMAGE_NAME="$(docker_e2e_resolve_image "oriro-session-runtime-context-e2e" ORIRO_SESSION_RUNTIME_CONTEXT_E2E_IMAGE)"
CONTAINER_NAME="oriro-session-runtime-context-e2e-$$"
RUN_LOG="$(mktemp -t oriro-session-runtime-context-log.XXXXXX)"
