...
`precise.yml` is Oriro's shipped precise OpenGrep rulepack. Each rule is tied
...
Some Oriro paths are excluded by `.gitignore` for build reasons even though
