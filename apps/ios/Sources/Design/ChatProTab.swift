...
struct ChatProTab: View {
                ...
                VStack(spacing: 0) {
                    ...
                    if let viewModel {
                        OriroChatView(
                            ...
                            assistantAvatarTint: OriroBrand.accent,
                    ...
                    Circle()
                        .fill(
                            LinearGradient(
                                colors: [
                                    OriroBrand.accent,
                                    OriroBrand.accentHot,
                                ],
                                startPoint: .topLeading,
                                endPoint: .bottomTrailing)))
                .overlay(Circle().strokeBorder(.white.opacity(0.18), lineWidth: 1))
                .shadow(color: OriroBrand.accent.opacity(0.18), radius: 10, y: 5)
        } else {
            ProIconBadge(systemName: "bubble.left", color: OriroBrand.accent)
        }
    }
    ...
    private func syncChatViewModel() {
        ...
        guard let viewModel else {
            ...
            self.viewModel = OriroChatViewModel(
    ...
    private var talkControl: OriroChatTalkControl {
        OriroChatTalkControl(
    ...
    private var chatUserAccent: Color {
        self.colorScheme == .light ? Color(red: 0 / 255.0, green: 122 / 255.0, blue: 255 / 255.0) : OriroBrand.accent
    }
