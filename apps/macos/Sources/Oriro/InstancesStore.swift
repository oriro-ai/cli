...
final class InstancesStore {
    ...
    private let logger = Logger(subsystem: "ai.oriro", category: "instances")
    ...
    func handlePresenceEventPayload(_ payload: OriroProtocol.AnyCodable) {
        do {
...
extension InstancesStore {
    static func preview(instances: [InstanceInfo] = [
        InstanceInfo(
            ...
            mode: "local",
            reason: "preview",
            text: "Local node: oriro-mac (10.0.0.12) · app 1.2.3",
