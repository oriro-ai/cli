...
@Suite struct RootTabsPresentationTests {
    ...
    @Test func chatSidebarDestinationCanUseRouteHeaderInsteadOfAgentBranding() {
        ...
        #expect(ChatProTab.defaultHeaderTitle(showsAgentBadge: true, agentDisplayName: "Oriro") == "Oriro")
        #expect(ChatProTab.defaultHeaderTitle(showsAgentBadge: false, agentDisplayName: "Oriro") == "Chat")
    }
