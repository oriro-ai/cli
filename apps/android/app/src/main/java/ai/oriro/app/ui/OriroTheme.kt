...
private val LocalOriroDarkTheme = staticCompositionLocalOf { true }
...
fun OriroTheme(
  ...
  OriroSystemBarAppearance(lightAppearance = !isDark)

  CompositionLocalProvider(
    LocalMobileColors provides mobileColors,
    LocalOriroDarkTheme provides isDark,
  ) {
...
@Composable
internal fun OriroSystemBarAppearance(lightAppearance: Boolean) {
...
fun overlayContainerColor(): Color {
  ...
  val isDark = LocalOriroDarkTheme.current
