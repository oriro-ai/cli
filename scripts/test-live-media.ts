// Test Live Media script supports Oriro repository automation.
...
export const MEDIA_SUITES: Record<MediaSuiteId, MediaSuiteConfig> = {
  image: {
    ...
    providerEnvVar: "ORIRO_LIVE_IMAGE_GENERATION_PROVIDERS",
  ...
  music: {
    ...
    providerEnvVar: "ORIRO_LIVE_MUSIC_GENERATION_PROVIDERS",
    providers: ["fal", "google", "minimax", "openrouter"],
  },
  video: {
    id: "video",
    testFile: "extensions/video-generation-providers.live.test.ts",
    providerEnvVar: "ORIRO_LIVE_VIDEO_GENERATION_PROVIDERS",
    providers: [
      "alibaba",
      "byteplus",
      "deepinfra",
