...
IMAGE_NAME="$(docker_e2e_resolve_image "oriro-crestodian-planner-e2e" ORIRO_CRESTODIAN_PLANNER_E2E_IMAGE)"
CONTAINER_NAME="oriro-crestodian-planner-e2e-$$"
RUN_LOG="$(mktemp -t oriro-crestodian-planner-log.XXXXXX)"
...
ORIRO_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 crestodian-planner empty)"
