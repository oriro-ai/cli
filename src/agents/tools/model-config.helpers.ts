...
/** Resolves the configured default model ref, falling back to Oriro defaults. */
export function resolveDefaultModelRef(cfg?: OriroConfig): { provider: string; model: string } {
  if (cfg) {
