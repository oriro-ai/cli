...
vi.mock("oriro/plugin-sdk/hook-runtime", async () => {
  const actual = await vi.importActual<typeof import("oriro/plugin-sdk/hook-runtime")>(
    "oriro/plugin-sdk/hook-runtime",
  );
  return {
    ...actual,
