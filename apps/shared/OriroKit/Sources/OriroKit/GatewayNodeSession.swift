...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.oriro", category: "node.gateway")
    ...
    {
        let timeoutLogger = Logger(subsystem: "ai.oriro", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: OriroProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
