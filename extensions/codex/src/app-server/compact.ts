/**
 * Native Codex app-server compaction bridge for bound Oriro sessions.
 */
import {
  embeddedAgentLog,
...
export async function maybeCompactCodexAppServerSession(
  ...
  warnIfIgnoringOriroCompactionOverrides(params);
...
function warnIfIgnoringOriroCompactionOverrides(
  params: CompactEmbeddedAgentSessionParams,
): void {
