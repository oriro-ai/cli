...
import type { OriroConfig } from "oriro/plugin-sdk/memory-core-host-runtime-core";
import type { MemorySearchResult } from "oriro/plugin-sdk/memory-core-host-runtime-files";
import { resolveSessionAgentId } from "oriro/plugin-sdk/memory-host-core";
import {
...
function isGlobalSessionKeyForSharedScope(cfg: OriroConfig, key: string): boolean {
