...
struct OriroApp: App {
    ...
    private static let logger = Logger(subsystem: "ai.oriro", category: "app")
    ...
    var body: some Scene {
        ...
        Window("Oriro Settings", id: SettingsWindowOpener.windowID) {
    ...
    private func applyStatusItemAppearance(paused _: Bool, sleeping _: Bool) {
        ...
        self.statusItem?.button?.toolTip = self.state.voiceWakeMeterActive
            ? "Oriro - Voice Wake live meter active"
            : "Oriro"
    }
...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private let webChatAutoLogger = Logger(subsystem: "ai.oriro", category: "Chat")
