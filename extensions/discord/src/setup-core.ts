...
import type { DiscordGuildEntry, OriroConfig } from "oriro/plugin-sdk/config-contracts";
import type { ChannelSetupDmPolicy, ChannelSetupWizard } from "oriro/plugin-sdk/setup-runtime";
import {
