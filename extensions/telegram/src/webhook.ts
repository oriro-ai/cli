...
import { isDiagnosticsEnabled } from "oriro/plugin-sdk/diagnostic-runtime";
import {
  logWebhookError,
  logWebhookProcessed,
  logWebhookReceived,
...
} from "oriro/plugin-sdk/logging-core";
import { parseStrictNonNegativeInteger } from "oriro/plugin-sdk/number-runtime";
import type { BackoffPolicy, RuntimeEnv } from "oriro/plugin-sdk/runtime-env";
import {
  computeBackoff,
  defaultRuntime,
...
import { safeEqualSecret } from "oriro/plugin-sdk/security-runtime";
...
import { readJsonBodyWithLimit } from "oriro/plugin-sdk/webhook-request-guards";
...
function resolveTelegramWebhookClientIp(req: IncomingMessage, config?: OriroConfig): string {
