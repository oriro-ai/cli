...
const pollMs = clampTimerTimeoutMs(
  readPositiveIntEnv("ORIRO_PLUGIN_LIFECYCLE_METRIC_POLL_MS", 100),
);
const timeoutMs = clampTimerTimeoutMs(
  readPositiveIntEnv("ORIRO_PLUGIN_LIFECYCLE_PHASE_TIMEOUT_MS", 300000),
);
const timeoutKillGraceMs = clampTimerTimeoutMs(
  readPositiveIntEnv("ORIRO_PLUGIN_LIFECYCLE_TIMEOUT_KILL_GRACE_MS", 2000),
);
