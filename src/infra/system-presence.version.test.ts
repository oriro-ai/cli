  ...
  return withEnvAsync(
    {
      ...
      ORIRO_SERVICE_VERSION: undefined,
...
describe("system-presence version fallback", () => {
  ...
  it("uses runtime VERSION when ORIRO_VERSION is not set", async () => {
  ...
  it("prefers ORIRO_VERSION over runtime VERSION", async () => {
    await expectSelfVersion(
      {
  ...
  it("still prefers runtime VERSION over ORIRO_SERVICE_VERSION when ORIRO_VERSION is blank", async () => {
    await expectSelfVersion(
      {
        ORIRO_VERSION: " ",
        ORIRO_SERVICE_VERSION: "2.4.6-service",
  ...
  it("uses runtime VERSION when ORIRO_VERSION and ORIRO_SERVICE_VERSION are blank", async () => {
    await expectSelfVersion(
      {
        ORIRO_VERSION: " ",
        ORIRO_SERVICE_VERSION: "\t",
