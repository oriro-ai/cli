...
name: healthcheck
description: "Audit/harden ORIRO hosts: SSH, firewall, updates, exposure, backups, disk encryption, gateway security."
---

# Oriro host healthcheck
...
- Never claim Oriro manages OS firewall, SSH, or updates.
...
- Oriro gateway status, bind, auth.
- Backup status.
- Disk encryption.
...
- Add scheduled `oriro security audit --deep`.
