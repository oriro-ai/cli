...
import { sleep } from "oriro/plugin-sdk/text-utility-runtime";
...
vi.mock("oriro/plugin-sdk/text-utility-runtime", async () => {
  const actual = await vi.importActual<typeof import("oriro/plugin-sdk/text-utility-runtime")>(
    "oriro/plugin-sdk/text-utility-runtime",
  );
  return {
    ...actual,
    sleep: vi.fn(async () => {}),
