/** Reads Codex/Claude/Cursor bundle manifests into Oriro plugin manifest metadata. */
...
export type BundlePluginManifest = {
  ...
  // Only include hook roots that Oriro can execute via HOOK.md + handler files.
  hooks: string[];
