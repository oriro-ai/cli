...
import type { ChatCommandDefinition, CommandArgs } from "oriro/plugin-sdk/command-auth-native";
...
import { patchSessionEntry, resolveStorePath } from "oriro/plugin-sdk/session-store-runtime";
import { withTimeout } from "oriro/plugin-sdk/text-utility-runtime";
