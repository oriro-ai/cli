...
export const SKILL_WORKSHOP_SCHEMA = "oriro.skill-workshop.proposal.v1" as const;
export const SKILL_WORKSHOP_MANIFEST_SCHEMA =
  "oriro.skill-workshop.proposals-manifest.v1" as const;
export const SKILL_WORKSHOP_ROLLBACK_SCHEMA = "oriro.skill-workshop.rollback.v1" as const;
