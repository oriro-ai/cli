...
Zalo ships as a bundled plugin in current Oriro releases, so normal packaged
...
- Install via CLI: `oriro plugins install @oriro/zalo`
- Pinned version: `oriro plugins install @oriro/zalo@2026.5.2`
- Or from a source checkout: `oriro plugins install ./path/to/local/zalo-plugin`
...
This page reflects current Oriro behavior for **Zalo Bot Creator / Marketplace bots**.
...
- Approve via:
  - `oriro pairing list zalo`
  - `oriro pairing approve zalo <CODE>`
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in Oriro.
...
- Example: `oriro message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `oriro channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `oriro logs --follow`
