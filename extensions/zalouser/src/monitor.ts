...
import { mergeAllowlist, summarizeMapping } from "oriro/plugin-sdk/allow-from";
import {
...
import { KeyedAsyncQueue } from "oriro/plugin-sdk/core";
import { isDangerousNameMatchingEnabled } from "oriro/plugin-sdk/dangerous-name-runtime";
import { createDeferred } from "oriro/plugin-sdk/extension-shared";
import {
...
function resolveZalouserDmSessionScope(config: OriroConfig) {
