...
import { normalizeAccountId, resolveAgentIdFromSessionKey } from "oriro/plugin-sdk/routing";
...
const FEISHU_THREAD_BINDINGS_STATE_KEY = Symbol.for("oriro.feishuThreadBindingsState");
