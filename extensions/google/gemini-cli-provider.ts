...
import { buildOauthProviderAuthResult } from "oriro/plugin-sdk/provider-auth-result";
import type { ProviderPlugin } from "oriro/plugin-sdk/provider-model-shared";
import { fetchGeminiUsage } from "oriro/plugin-sdk/provider-usage";
...
export function registerGoogleGeminiCliProvider(api: OriroPluginApi) {
