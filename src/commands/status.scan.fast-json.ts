// Fast `oriro status --json` scan policy.
...
type StatusJsonScanPolicy = {
  ...
  gatewayProbeTimeoutMs?: number | ((cfg: OriroConfig) => number | undefined);
...
function hasExplicitStatusJsonChannelConfig(cfg: OriroConfig): boolean {
...
function hasPotentialConfiguredChannelsForStatusJson(cfg: OriroConfig): boolean {
