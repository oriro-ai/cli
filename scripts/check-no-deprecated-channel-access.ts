// Check No Deprecated Channel Access script supports Oriro repository automation.
...
const RULES: Rule[] = [
  ...
  },
  {
    ...
    pattern: /from\s+["']oriro\/plugin-sdk\/group-access["']/u,
  },
  {
  ...
  },
  {
    ...
    pattern: /from\s+["']oriro\/plugin-sdk\/command-auth["']/u,
  },
  {
