...
import { createSubsystemLogger, redactSensitiveText } from "./oriro-runtime-io.js";
import {
  HEARTBEAT_PROMPT,
  HEARTBEAT_TOKEN,
...
function isDreamingNarrativeBootstrapRecord(record: unknown): boolean {
  ...
  if (
    ...
    candidate.customType !== "oriro:bootstrap-context:full" ||
    !candidate.data ||
...
/**
 * Strip Oriro-injected inbound metadata envelopes from a raw text block.
 *
