...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.orirofoundation.app.gateway"
    private static let nodeService = "ai.orirofoundation.app.node"
    private static let talkService = "ai.orirofoundation.app.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.orirofoundation.app", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.orirofoundation.app.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("oriro-gateway.log")
    }
