...
import {
  resolveOriroPluginToolInputs,
  type OriroPluginToolOptions,
} from "./oriro-tools.plugin-context.js";
import { applyPluginToolDeliveryDefaults } from "./plugin-tool-delivery-defaults.js";
import type { AnyAgentTool } from "./tools/common.js";

type ResolveOriroPluginToolsOptions = OriroPluginToolOptions & {
...
export function resolveOriroPluginToolsForOptions(params: {
  options?: ResolveOriroPluginToolsOptions;
  ...
  const resolveApiKeyForProvider = authProfileStore
    ...
    : undefined;
  const pluginToolInputs = resolveOriroPluginToolInputs({
