...
export const ar: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "على الهاتف؟ انسخ عنوان URL الكامل (بما في ذلك #token=...) من oriro dashboard --no-open على سطح المكتب.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — أعد المصادقة باستخدام oriro models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste: "الصق الرمز المميز من oriro dashboard --no-open أو أدخل كلمة المرور المكونة.",
        stepGenerate:
          "إذا لم يتم تكوين رمز مميز، فشغل oriro doctor --generate-gateway-token على مضيف Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "شغل oriro dashboard --no-open وافتح عنوان URL الجديد أو الصق رمزه المميز.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "شغل oriro devices list على مضيف Gateway.",
        stepApproveId: "وافق على هذا الطلب: oriro devices approve {requestId}.",
      ...
      network: {
        ...
        stepGateway: "تأكد من أن Gateway يعمل باستخدام oriro status أو oriro gateway run.",
        stepUrl:
          "تحقق من عنوان WebSocket واستخدم wss:// عندما يكون Gateway خلف HTTPS/Tailscale Serve.",
        stepDashboard:
          "أعد فتح لوحة المعلومات باستخدام oriro dashboard --no-open لنسخ عنوان URL وتفاصيل المصادقة الحالية.",
      },
    },
  },
  chat: {
