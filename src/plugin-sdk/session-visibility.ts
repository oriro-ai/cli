...
export function resolveSessionToolsVisibility(cfg: OriroConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: OriroConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: OriroConfig): AgentToAgentPolicy {
