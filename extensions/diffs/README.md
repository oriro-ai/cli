...
Read-only diff viewer plugin for **Oriro** agents.

## Install

```bash
oriro plugins install @oriro/diffs
```
...
- Artifacts are ephemeral and stored in the plugin temp subfolder (`$TMPDIR/oriro-diffs`).
