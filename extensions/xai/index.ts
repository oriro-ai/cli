// Xai plugin entrypoint registers its Oriro integration.
import { defineSingleProviderPluginEntry } from "oriro/plugin-sdk/provider-entry";
import { OPENAI_COMPATIBLE_REPLAY_HOOKS } from "oriro/plugin-sdk/provider-model-shared";
import { defaultToolStreamExtraParams } from "oriro/plugin-sdk/provider-stream-shared";
import { jsonResult } from "oriro/plugin-sdk/provider-web-search";
import {
