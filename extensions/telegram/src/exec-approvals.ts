...
import { resolveApprovalApprovers } from "oriro/plugin-sdk/approval-auth-runtime";
import {
...
import { resolveApprovalRequestChannelAccountId } from "oriro/plugin-sdk/approval-native-runtime";
import type {
  ExecApprovalRequest,
  PluginApprovalRequest,
} from "oriro/plugin-sdk/approval-runtime";
import type { OriroConfig } from "oriro/plugin-sdk/config-contracts";
import type { TelegramExecApprovalConfig } from "oriro/plugin-sdk/config-contracts";
import type { ReplyPayload } from "oriro/plugin-sdk/reply-runtime";
import { normalizeAccountId } from "oriro/plugin-sdk/routing";
import {
...
function resolveTelegramOwnerApprovers(cfg: OriroConfig): Array<string | number> {
