...
`oriro/plugin-sdk/channel-message` and
`oriro/plugin-sdk/channel-message-runtime` remain deprecated compatibility
subpaths for older plugins. New channel plugins should use
`oriro/plugin-sdk/channel-outbound` for message lifecycle, receipt, durable
