...
const contextTestState = vi.hoisted(() => {
  const state = {
    ...
    runtimeConfigSnapshot: null as OriroConfig | null,
    runtimeConfigSourceSnapshot: null as OriroConfig | null,
...
vi.mock("../config/runtime-source-projection.js", () => ({
  projectConfigOntoRuntimeSourceSnapshot: (config: OriroConfig) =>
