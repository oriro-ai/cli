 ...
 */
import { collectErrorGraphCandidates } from "oriro/plugin-sdk/error-runtime";
...
// Restricted sandboxes (NemoOriro, Docker-in-Docker, k3s with locked-down policy)
...
/** Known ciao process-level errors that Oriro handles specially. */
