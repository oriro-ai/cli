---
summary: "Oriro threat model mapped to the MITRE ATLAS framework"
...
This is a living document maintained by the Oriro community. See [CONTRIBUTING-THREAT-MODEL.md](/security/CONTRIBUTING-THREAT-MODEL) for guidelines on contributing:
...
This threat model documents adversarial threats to the Oriro AI agent platform and OriroHub skill marketplace, using the MITRE ATLAS framework designed specifically for AI/ML systems.

### 1.2 Scope

| Component              | Included | Notes                                            |
| ---------------------- | -------- | ------------------------------------------------ |
| Oriro Agent Runtime | Yes      | Core agent execution, tool calls, sessions       |
| Gateway                | Yes      | Authentication, routing, channel integration     |
| Channel Integrations   | Yes      | WhatsApp, Telegram, Discord, Signal, Slack, etc. |
| OriroHub Marketplace    | Yes      | Skill publishing, moderation, distribution       |
...
| F5   | OriroHub | Agent       | Skill code         | Moderation, scanning |
...
| **Description**         | Attacker scans for exposed Oriro gateway endpoints                |
...
| **Affected Components** | ~/.oriro/credentials/, config storage                    |
...
| **Description**         | Attacker publishes malicious skill to OriroHub                            |
| **Attack Vector**       | Create account, publish skill with hidden malicious code                 |
| **Affected Components** | OriroHub, skill loading, agent execution                                  |
...
| **Affected Components** | OriroHub versioning, auto-update flows                          |
...
| **Affected Components** | OriroHub moderation.ts                                                  |
...
## 4. OriroHub Supply Chain Analysis
...
/(keepcold131\/OrirodAuthenticatorTool|OrirodAuthenticatorTool)/i
...
| ATLAS ID      | Technique Name                 | Oriro Threats                                                 |
| ------------- | ------------------------------ | ---------------------------------------------------------------- |
...
| **OriroHub**          | Oriro's skill marketplace                              |
| **Gateway**          | Oriro's message routing and authentication layer       |
| **MCP**              | Model Context Protocol - tool provider interface          |
| **Prompt Injection** | Attack where malicious instructions are embedded in input |
| **Skill**            | Downloadable extension for Oriro agents                |
| **SSRF**             | Server-Side Request Forgery                               |

---

_This threat model is a living document. Report security issues to security@oriro.ai_
