 ...
 * or whether Oriro must keep exec/process on a configured node host.
 */
...
import { getSessionEntry, type SessionEntry } from "oriro/plugin-sdk/session-store-runtime";
...
function listAgentEntries(config: OriroConfig): AgentEntry[] {
