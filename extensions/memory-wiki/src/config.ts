...
import { mapPluginConfigIssues } from "oriro/plugin-sdk/extension-shared";
import { buildPluginConfigSchema, z, type OriroPluginConfigSchema } from "../api.js";
...
export const memoryWikiConfigSchema: OriroPluginConfigSchema = memoryWikiConfigSchemaBase;
...
export function resolveDefaultMemoryWikiVaultPath(homedir = os.homedir()): string {
  return path.join(homedir, ".oriro", "wiki", "main");
}
