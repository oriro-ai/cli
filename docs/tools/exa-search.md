...
Oriro supports [Exa AI](https://exa.ai/) as a `web_search` provider. Exa
...
```bash
oriro plugins install @oriro/exa-plugin
      ...
      exa: {
        config: {
          webSearch: {
            ...
            baseUrl: "https://api.exa.ai", // optional; Oriro appends /search
          },
        },
      },
    },
...
should go through a compatible proxy or alternate Exa endpoint. Oriro
