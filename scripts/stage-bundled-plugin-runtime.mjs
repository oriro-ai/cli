...
function ensureOriroExtensionAlias(params) {
  ...
  const aliasDir = path.join(params.distExtensionsRoot, "node_modules", "oriro");
...
function shouldCopyRuntimeFile(relativePath) {
  return (
    ...
    isPathOrNestedPath(relativePath, "oriro.plugin.json") ||
...
export function stageBundledPluginRuntime(params = {}) {
  ...
  ensureOriroExtensionAlias({ repoRoot, distExtensionsRoot });
