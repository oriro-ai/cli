...
export class OriroModalDialog extends LitElement {
  @property() label = "";
  ...
  override render() {
    const labelId = this.label ? "oriro-modal-dialog-label" : "";
    const descriptionId = this.description ? "oriro-modal-dialog-description" : "";
    return html`
      <dialog
        role="dialog"
        aria-modal="true"
...
if (!customElements.get("oriro-modal-dialog")) {
  customElements.define("oriro-modal-dialog", OriroModalDialog);
}

declare global {
  interface HTMLElementTagNameMap {
    "oriro-modal-dialog": OriroModalDialog;
  }
}
