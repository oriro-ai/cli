...
import { resolveConfiguredAcpBindingRecord } from "oriro/plugin-sdk/acp-binding-resolve-runtime";
...
import { getSessionBindingService } from "oriro/plugin-sdk/session-binding-runtime";
