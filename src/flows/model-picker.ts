...
type PromptDefaultModelResult = { model?: string; config?: OriroConfig };
...
function resolveConfiguredModelRaw(cfg: OriroConfig): string {
  return resolveAgentModelPrimaryValue(cfg.agents?.defaults?.model) ?? "";
}

function resolveConfiguredModelKeys(cfg: OriroConfig): string[] {
