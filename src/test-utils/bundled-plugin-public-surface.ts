...
function findBundledPluginMetadataFast(
  ...
  const rawRoots = [
    ...
    path.resolve(ORIRO_PACKAGE_ROOT, "extensions"),
    path.resolve(ORIRO_PACKAGE_ROOT, "dist-runtime", "extensions"),
    path.resolve(ORIRO_PACKAGE_ROOT, "dist", "extensions"),
