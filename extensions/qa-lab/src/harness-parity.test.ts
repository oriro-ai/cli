...
const LEFT: HarnessVariant = { id: "left", label: "Left", runtime: "oriro" };
const RIGHT: HarnessVariant = { id: "right", label: "Right", runtime: "oriro" };
...
describe("harness parity", () => {
  ...
  it("labels mock token estimates separately from live usage", () => {
    const sourceCell = makeCell("oriro", {
