...
export function listBindings(cfg: OriroConfig): AgentRouteBinding[] {
  return listRouteBindings(cfg);
}

export function listBoundAccountIds(cfg: OriroConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: OriroConfig) {
