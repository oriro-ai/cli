/**
 * Oriro agent-tool definitions for Codex Supervisor endpoint and session
 * controls.
 */
import { jsonResult, readStringParam, type AnyAgentTool } from "oriro/plugin-sdk/core";
...
/** Dependencies needed to build Oriro agent tools. */
...
/**
 * Creates the Oriro tools that expose Codex endpoint health and session
 * controls.
 */
