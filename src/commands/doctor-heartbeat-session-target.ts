...
function resolveHeartbeatConfig(cfg: OriroConfig, agentId: string): HeartbeatConfig | undefined {
...
function listHeartbeatDoctorAgents(cfg: OriroConfig) {
 ...
 */
export function describeHeartbeatSessionTargetIssues(cfg: OriroConfig): string[] {
