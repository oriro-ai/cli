...
const DEFAULT_MISSING_TOOL_RESULT_TEXT =
  "[oriro] missing tool result in session history; inserted synthetic error result for transcript repair.";
const SYNTHETIC_MISSING_TOOL_RESULT_DETAIL_KEY = "oriroSyntheticMissingToolResult";
...
function makeMissingToolResult(params: {
  ...
  // explicit Oriro diagnostic text unless the caller opts in.
  text?: string;
