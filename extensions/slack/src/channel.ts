...
} from "oriro/plugin-sdk/allowlist-config-edit";
import { adaptScopedAccountAccessor } from "oriro/plugin-sdk/channel-config-helpers";
import {
  buildThreadAwareOutboundSessionRoute,
  createChatChannelPlugin,
} from "oriro/plugin-sdk/channel-core";
import { createChannelMessageAdapterFromOutbound } from "oriro/plugin-sdk/channel-outbound";
...
} from "oriro/plugin-sdk/channel-send-result";
import {
  createChannelDirectoryAdapter,
  createRuntimeDirectoryLiveAdapter,
} from "oriro/plugin-sdk/directory-runtime";
import { createLazyRuntimeModule } from "oriro/plugin-sdk/lazy-runtime";
import { buildOutboundBaseSessionKey, type RoutePeer } from "oriro/plugin-sdk/routing";
import {
...
//
// `oriro/plugin-sdk/channel-policy` is intentionally NOT lazy here —
...
const EXTENSION_SHARED_MODULE_ID = "oriro/plugin-sdk/extension-shared";
const TARGET_RESOLVER_RUNTIME_MODULE_ID = "oriro/plugin-sdk/target-resolver-runtime";
  ...
  base: {
    ...
    actions: createSlackActions(SLACK_CHANNEL, {
      invoke: async (action, cfg, toolContext) =>
        ...
        )(action, cfg as OriroConfig, toolContext as SlackActionContext | undefined),
    }),
