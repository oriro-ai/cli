...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: OriroProtocol.AnyCodable]?
    {
        ...
        return [
            "id": OriroProtocol.AnyCodable(identity.deviceId),
            "publicKey": OriroProtocol.AnyCodable(publicKey),
            "signature": OriroProtocol.AnyCodable(signature),
            "signedAt": OriroProtocol.AnyCodable(signedAtMs),
            "nonce": OriroProtocol.AnyCodable(nonce),
        ]
    }
}
