# Oriro Documentation Overlay

Use this reference only for Oriro docs work. It layers Oriro-specific page
...
- Topic page: explain a major Oriro entity or surface end to end.
...
- Governance file: keep agent/contributor policy concrete, scoped, and aligned
  with current Oriro repo behavior.
