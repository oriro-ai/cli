...
// Deduplicates external history messages against local Oriro transcripts.
...
function resolveImportedExternalIdentity(message: unknown): ImportedExternalIdentity | undefined {
  ...
  const meta =
    "__oriro" in message &&
    (message as { __oriro?: unknown })["__oriro"] &&
    typeof (message as { __oriro?: unknown })["__oriro"] === "object"
      ? ((message as { __oriro?: Record<string, unknown> })["__oriro"] ?? {})
      : undefined;
