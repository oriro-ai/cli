/** Interactive stdio ACP client used to connect a terminal session to an Oriro ACP server. */
...
async function createAcpClient(opts: AcpClientOptions = {}): Promise<AcpClientHandle> {
  ...
  const defaultServerCommand = entryPath ? process.execPath : "oriro";
  ...
  await client.initialize({
    ...
    clientInfo: { name: "oriro-acp-client", version: "1.0.0" },
  });
