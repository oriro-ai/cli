...
public enum OriroTalkCommand: String, Codable, Sendable {
...
public struct OriroTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct OriroTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
