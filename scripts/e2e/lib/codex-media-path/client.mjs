...
const appServerLog =
  process.env.ORIRO_CODEX_MEDIA_PATH_APP_SERVER_LOG ??
  "/tmp/oriro-codex-media-path-app-server.jsonl";
const timeoutSeconds = readPositiveIntEnv("ORIRO_CODEX_MEDIA_PATH_TIMEOUT_SECONDS", 180);
const logTailMaxBytes = readPositiveIntEnv(
  "ORIRO_CODEX_MEDIA_PATH_LOG_TAIL_MAX_BYTES",
  2 * 1024 * 1024,
);
