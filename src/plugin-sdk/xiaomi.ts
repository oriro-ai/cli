...
type FacadeModule = {
  applyXiaomiConfig: (cfg: OriroConfig) => OriroConfig;
  applyXiaomiProviderConfig: (cfg: OriroConfig) => OriroConfig;
...
/** Apply Xiaomi provider defaults to the full Oriro config. */
