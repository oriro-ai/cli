// Oriro NPM Publish tests cover publish wrapper argument safety.
...
const scriptPath = "scripts/oriro-npm-publish.sh";
...
describe("oriro npm publish wrapper", () => {
  ...
  it("rejects extra publish arguments before npm publish", () => {
    const tempRoot = makeTempDir("oriro-npm-publish-");
    const tarball = path.join(tempRoot, "oriro.tgz");
