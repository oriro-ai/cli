// Xiaomi plugin entrypoint registers its Oriro integration.
...
import {
  ...
  validateApiKeyInput,
} from "oriro/plugin-sdk/provider-auth-api-key";
import {
  applyModelCompatPatch,
  buildProviderReplayFamilyHooks,
} from "oriro/plugin-sdk/provider-model-shared";
import { PROVIDER_LABELS } from "oriro/plugin-sdk/provider-usage";
import {
  applyXiaomiConfig,
...
async function runXiaomiApiKeyAuth(
  ...
  params: {
    ...
    expectedKind: "payg" | "token-plan";
    defaultModel: string;
    applyConfig: (cfg: OriroConfig) => OriroConfig;
  },
