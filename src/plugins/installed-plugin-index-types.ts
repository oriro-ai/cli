...
export const INSTALLED_PLUGIN_INDEX_WARNING =
  "DO NOT EDIT. This file is generated by Oriro from plugin manifests, install records, and config policy. Use `oriro plugins registry --refresh`, `oriro plugins install/update/uninstall`, or `oriro plugins enable/disable` instead.";
...
export type InstalledPluginIndexRecord = {
  ...
  /**
   * Package-authored oriro.install metadata. This describes catalog/package
