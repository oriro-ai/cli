...
- Are the important plugin variants present for this category, such as channel,
  provider, tool, bundled, local, npm, or OriroHub flows?
...
- Publishing plugins: Install sources, OriroHub publishing, npm publishing, Compatibility signaling, Update and rollback expectations, Third-party publication rules
