...
} from "oriro/plugin-sdk/account-core";
import {
  DEFAULT_ACCOUNT_ID,
  normalizeAccountId,
...
function listConfiguredAccountIds(cfg: OriroConfig): string[] {
...
function listBoundAccountIds(cfg: OriroConfig, channelId: string): string[] {
  const ids = new Set<string>();
...
function resolveDefaultAgentBoundAccountId(cfg: OriroConfig, channelId: string): string | null {
...
function hasImplicitDefaultTelegramAccount(cfg: OriroConfig): boolean {
...
export function listTelegramAccountIds(cfg: OriroConfig): string[] {
...
export function resolveDefaultTelegramAccountSelection(cfg: OriroConfig): {
  accountId: string;
  accountIds: string[];
...
export function resolveDefaultTelegramAccountId(cfg: OriroConfig): string {
