...
// Deprecated compatibility surface for existing @oriro/discord/api.js consumers.
...
export { resolveOpenProviderRuntimeGroupPolicy as resolveDiscordRuntimeGroupPolicy } from "oriro/plugin-sdk/runtime-group-policy";
