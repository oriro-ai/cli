/**
 * Amazon Bedrock Converse streaming runtime. It maps Oriro messages/tools,
...
/** Stream a Bedrock Converse request from the generic Oriro stream options. */
 ...
 * Defaults to "short" and uses ORIRO_CACHE_RETENTION for backward compatibility.
 */
