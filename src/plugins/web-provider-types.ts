...
export type WebSearchProviderPlugin = {
  ...
  getConfiguredCredentialValue?: (config?: OriroConfig) => unknown;
  setConfiguredCredentialValue?: (configTarget: OriroConfig, value: unknown) => void;
  getConfiguredCredentialFallback?: (
    config?: OriroConfig,
  ) => WebSearchProviderConfiguredCredentialFallback | undefined;
  applySelectionConfig?: (config: OriroConfig) => OriroConfig;
  runSetup?: (ctx: WebSearchProviderSetupContext) => OriroConfig | Promise<OriroConfig>;
