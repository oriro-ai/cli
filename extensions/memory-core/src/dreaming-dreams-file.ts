...
import { createAsyncLock } from "oriro/plugin-sdk/async-lock-runtime";
import { extractErrorCode } from "oriro/plugin-sdk/error-runtime";
import { resolveGlobalMap } from "oriro/plugin-sdk/global-singleton";
import { replaceManagedMarkdownBlock } from "oriro/plugin-sdk/memory-host-markdown";
import { readRegularFile, replaceFileAtomic } from "oriro/plugin-sdk/security-runtime";

const DREAMS_FILENAMES = ["DREAMS.md", "dreams.md"] as const;
const DEEP_START_MARKER = "<!-- oriro:dreaming:deep:start -->";
const DEEP_END_MARKER = "<!-- oriro:dreaming:deep:end -->";
