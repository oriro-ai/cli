// Oriro plugin entrypoint registers its Oriro integration.
...
import { createOriroTool } from "./src/oriro-tool.js";
      ...
      ((ctx) => {
        ...
        const taskFlow =
          api.runtime?.tasks.managedFlows && ctx.sessionKey
            ...
            : undefined;
        return createOriroTool(api, { taskFlow }) as AnyAgentTool;
