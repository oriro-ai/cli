...
function mergeZalouserAccountConfig(cfg: OriroConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: OriroConfig; accountId?: string | null }) {
