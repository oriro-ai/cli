...
import { buildPluginConfigSchema, type OriroPluginConfigSchema } from "oriro/plugin-sdk/core";
import {
  formatPluginConfigIssue,
  mapPluginConfigIssues,
} from "oriro/plugin-sdk/extension-shared";
import { MAX_TIMER_TIMEOUT_SECONDS } from "oriro/plugin-sdk/number-runtime";
import { z } from "zod";
...
export function createOpenShellPluginConfigSchema(): OriroPluginConfigSchema {
