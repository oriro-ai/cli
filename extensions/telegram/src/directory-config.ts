...
import { normalizeAccountId } from "oriro/plugin-sdk/account-core";
import { mapAllowFromEntries } from "oriro/plugin-sdk/channel-config-helpers";
import type { OriroConfig, TelegramAccountConfig } from "oriro/plugin-sdk/config-contracts";
import { createResolvedDirectoryEntriesLister } from "oriro/plugin-sdk/directory-config-runtime";
