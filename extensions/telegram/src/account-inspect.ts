...
import { resolveAccountWithDefaultFallback } from "oriro/plugin-sdk/account-core";
import { tryReadSecretFileSync } from "oriro/plugin-sdk/channel-core";
import type { OriroConfig } from "oriro/plugin-sdk/config-contracts";
import type { TelegramAccountConfig } from "oriro/plugin-sdk/config-contracts";
import { resolveDefaultSecretProviderAlias } from "oriro/plugin-sdk/provider-auth";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "oriro/plugin-sdk/routing";
import {
  hasConfiguredSecretInput,
  normalizeSecretInputString,
} from "oriro/plugin-sdk/secret-input";
import { coerceSecretRef } from "oriro/plugin-sdk/secret-input-runtime";
import { FsSafeError } from "oriro/plugin-sdk/security-runtime";
...
function inspectTokenValue(params: { cfg: OriroConfig; value: unknown }): {
  token: string;
...
function hasConfiguredTelegramAccounts(cfg: OriroConfig): boolean {
