...
enum UIStrings {
    static let welcomeTitle = "Welcome to Oriro"
}
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: OriroChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g oriro@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: OriroChatViewModel(
