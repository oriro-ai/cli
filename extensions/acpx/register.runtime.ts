...
import type { OriroPluginService, OriroPluginServiceContext } from "oriro/plugin-sdk/core";
...
type DeferredServiceState = {
  ctx: OriroPluginServiceContext | null;
  params: CreateAcpxRuntimeServiceParams;
  realRuntime: AcpRuntime | null;
  realService: OriroPluginService | null;
...
async function startRealService(state: DeferredServiceState): Promise<AcpRuntime> {
  ...
  state.startPromise ??= (async () => {
    ...
    await service.start(state.ctx as OriroPluginServiceContext);
