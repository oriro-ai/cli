...
import { resolveEnvApiKey } from "oriro/plugin-sdk/provider-auth-runtime";
import {
...
function resolveConfiguredOllamaWebSearchApiKey(config?: OriroConfig): string | undefined {
...
function resolveOllamaWebSearchApiKey(config?: OriroConfig): string | undefined {
  return resolveConfiguredOllamaWebSearchApiKey(config) ?? resolveEnvOllamaWebSearchApiKey();
}

function resolveOllamaWebSearchBaseUrl(config?: OriroConfig): string {
