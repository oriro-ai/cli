...
/** Normalized model metadata used by Oriro provider catalogs. */
...
export const LMSTUDIO_DEFAULT_MODEL_ID: FacadeModule["LMSTUDIO_DEFAULT_MODEL_ID"] =
  "qwen/qwen3.5-9b";
/** Stable provider id used in Oriro config and provider catalogs. */
...
/** Map one raw LM Studio model entry into Oriro model metadata. */
...
/** Discover Oriro model definitions from an LM Studio server. */
