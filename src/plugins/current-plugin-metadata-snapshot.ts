...
import { setCurrentManifestModelIdNormalizationRecords } from "@oriro/model-catalog-core/provider-model-id-normalization";
...
let currentPluginMetadataConfigIdentityCache = new WeakSet<OriroConfig>();
...
export function setCurrentPluginMetadataSnapshot(
  ...
  options: {
    config?: OriroConfig;
    compatibleConfigs?: readonly OriroConfig[];
