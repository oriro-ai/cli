...
import { resolveDefaultAgentId } from "oriro/plugin-sdk/memory-host-core";
import { readPositiveIntegerParam } from "oriro/plugin-sdk/param-readers";
import type { OriroConfig, OriroPluginApi } from "../api.js";
...
type GatewayMethodContext = Parameters<
  Parameters<OriroPluginApi["registerGatewayMethod"]>[1]
>[0];
...
function resolveGatewayAgentId(
  ...
  appConfig: OriroConfig | undefined,
): string | undefined {
  return (
