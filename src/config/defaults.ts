...
} from "@oriro/model-catalog-core/provider-model-id-normalization";
...
export function applyMessageDefaults(cfg: OriroConfig): OriroConfig {
...
export function applyTalkConfigNormalization(config: OriroConfig): OriroConfig {
...
export function applyAgentDefaults(cfg: OriroConfig): OriroConfig {
...
export function applyCronDefaults(cfg: OriroConfig): OriroConfig {
...
export function applyLoggingDefaults(cfg: OriroConfig): OriroConfig {
...
function hasAnthropicDefaultSignal(cfg: OriroConfig, env: NodeJS.ProcessEnv): boolean {
...
export function applyCompactionDefaults(cfg: OriroConfig): OriroConfig {
