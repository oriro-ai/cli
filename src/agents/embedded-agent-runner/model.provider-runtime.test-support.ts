...
import { lowercasePreservingWhitespace } from "@oriro/normalization-core/string-coerce";
      ...
      switch (params.provider) {
        ...
        case "vllm":
          return (
            ...
            'Set VLLM_API_KEY (any value works) or run "oriro configure". ' +
            "See: https://docs.oriro.ai/providers/vllm"
          );
        default:
          return undefined;
      }
