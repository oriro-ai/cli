...
function mergeZaloAccountConfig(cfg: OriroConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: OriroConfig): ResolvedZaloAccount[] {
