...
import type { OriroAgentDatabase } from "../../state/oriro-agent-db.js";
...
): { allowKeychainPrompt?: boolean; database?: OriroAgentDatabase } {
  return {
...
function loadAuthProfileStoreForAgent(
  ...
  const forceReadOnly = process.env.ORIRO_AUTH_STORE_READONLY === "1";
