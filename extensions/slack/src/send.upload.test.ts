...
vi.mock("oriro/plugin-sdk/fetch-runtime", async () => {
  const actual = await vi.importActual<typeof import("oriro/plugin-sdk/fetch-runtime")>(
    "oriro/plugin-sdk/fetch-runtime",
  );
  return {
    ...actual,
