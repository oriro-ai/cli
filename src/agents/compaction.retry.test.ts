...
import * as agentSessions from "oriro/plugin-sdk/agent-sessions";
import type { AssistantMessage, UserMessage } from "oriro/plugin-sdk/llm";
import { afterEach, beforeEach, describe, expect, it, vi } from "vitest";
import { retryAsync } from "../infra/retry.js";

vi.mock("oriro/plugin-sdk/agent-sessions", async () => {
  const actual = await vi.importActual<typeof agentSessions>("oriro/plugin-sdk/agent-sessions");
  return {
    ...actual,
