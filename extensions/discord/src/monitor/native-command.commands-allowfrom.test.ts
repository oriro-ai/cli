...
import * as pluginCommandsModule from "oriro/plugin-sdk/plugin-runtime";
import * as dispatcherModule from "oriro/plugin-sdk/reply-dispatch-runtime";
...
function createCommand(cfg: OriroConfig, discordConfig?: DiscordAccountConfig) {
...
async function runGuildSlashCommand(params?: {
  userId?: string;
  mutateConfig?: (cfg: OriroConfig) => void;
