...
import {
  ...
  type OriroConfig,
} from "oriro/plugin-sdk/memory-core-host-runtime-core";
import { resolveMemoryBackendConfig } from "oriro/plugin-sdk/memory-core-host-runtime-files";
import {
  definePluginEntry,
  type AnyAgentTool,
...
type MemoryToolOptions = {
  config?: OriroConfig;
  getConfig?: () => OriroConfig | undefined;
  agentId?: string;
...
function getToolConfig(options: MemoryToolOptions): OriroConfig | undefined {
...
function resolveMemoryToolOptions(ctx: OriroPluginToolContext): MemoryToolOptions {
