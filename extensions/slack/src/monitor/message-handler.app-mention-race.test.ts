...
vi.mock("oriro/plugin-sdk/channel-inbound", async () => {
  const actual = await vi.importActual<typeof import("oriro/plugin-sdk/channel-inbound")>(
    "oriro/plugin-sdk/channel-inbound",
  );
  return {
    ...actual,
