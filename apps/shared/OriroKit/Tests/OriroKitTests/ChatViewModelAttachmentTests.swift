...
private struct AttachmentProcessingTransport: OriroChatTransport {
    func requestHistory(sessionKey _: String) async throws -> OriroChatHistoryPayload {
...
final class ChatViewModelAttachmentTests: XCTestCase {
    func testImageAttachmentsAreProcessedBeforeStaging() async throws {
        ...
        let viewModel = await MainActor.run {
            OriroChatViewModel(sessionKey: "main", transport: AttachmentProcessingTransport())
        }
