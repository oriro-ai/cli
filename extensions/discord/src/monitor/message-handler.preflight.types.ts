...
import type { InboundEventKind } from "oriro/plugin-sdk/channel-inbound";
...
import type { SessionBindingRecord } from "oriro/plugin-sdk/conversation-runtime";
import type { HistoryEntry } from "oriro/plugin-sdk/reply-history";
import type { resolveAgentRoute } from "oriro/plugin-sdk/routing";
...
type LoadedConfig = OriroConfig;
export type RuntimeEnv = import("oriro/plugin-sdk/runtime-env").RuntimeEnv;
...
type DiscordMessagePreflightSharedFields = {
  ...
  discordConfig: NonNullable<
    import("oriro/plugin-sdk/config-contracts").OriroConfig["channels"]
  >["discord"];
  accountId: string;
  token: string;
  runtime: RuntimeEnv;
