...
import { resolveAgentMaxConcurrent } from "oriro/plugin-sdk/model-session-runtime";
...
export function createTelegramRunnerOptions(cfg: OriroConfig): RunOptions<unknown> {
  return {
    sink: {
