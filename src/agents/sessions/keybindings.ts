 ...
 *
 * Wraps pi-tui keybindings with Oriro-specific actions and per-agent overrides.
 */
...
/** Oriro-specific key ids added to the shared pi-tui keybinding registry. */
...
/** Union of Oriro-specific app key ids. */
...
export const KEYBINDINGS = {
  ...
  "app.permission.cycle": {
    ...
    description: "Cycle permission posture (Manual / Accept-Edits / Auto / Plan)",
  },
...
/** Keybinding manager that loads Oriro defaults plus optional user overrides. */
