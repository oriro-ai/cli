...
/** @deprecated Use `channelRouteTargetsMatchExact` from `oriro/plugin-sdk/channel-route`. */
...
/** @deprecated Use `channelRouteTargetsShareConversation` from `oriro/plugin-sdk/channel-route`. */
