...
export const legacyConfigRules: LegacyConfigRule[] = [
  {
    ...
    message:
      'plugins.entries.google-meet.config.realtime.provider="google" is legacy for Gemini Live bidi mode; use realtime.voiceProvider="google" and realtime.transcriptionProvider="openai". Run "oriro doctor --fix".',
    match: hasLegacyGoogleRealtimeProvider,
  },
];

export function migrateGoogleMeetLegacyRealtimeProvider(config: OriroConfig): {
  config: OriroConfig;
  changes: string[];
} | null {
