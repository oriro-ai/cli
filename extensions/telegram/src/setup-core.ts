...
import type { ChannelSetupAdapter } from "oriro/plugin-sdk/setup-runtime";
import {
...
export function getTelegramTokenHelpLines(): string[] {
  return [
    ...
    t("wizard.telegram.website", { url: "https://oriro.ai" }),
  ];
}
...
export function getTelegramUserIdHelpLines(): string[] {
  return [
    t("wizard.telegram.userIdHelpLogs", {
      command: formatCliCommand("oriro logs --follow"),
    }),
