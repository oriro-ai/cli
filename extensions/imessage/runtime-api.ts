...
import type { OriroConfig as RuntimeApiOriroConfig } from "oriro/plugin-sdk/config-contracts";
...
export type IMessageAccountConfig = Omit<
  NonNullable<NonNullable<RuntimeApiOriroConfig["channels"]>["imessage"]>,
