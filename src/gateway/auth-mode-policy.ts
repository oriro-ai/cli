...
export function hasAmbiguousGatewayAuthModeConfig(cfg: OriroConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: OriroConfig): void {
